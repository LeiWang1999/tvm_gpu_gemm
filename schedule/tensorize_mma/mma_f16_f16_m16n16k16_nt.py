...
# def C_permutation(i, j, kernel_i, kernel_j):
#     return (i, j, *shared_16x16_to_ldmatrix_32x8_permutation(kernel_i, kernel_j))
# sch.transform_layout(block_local_C, "read")
# decompose reduction
init_block_b = sch.decompose_reduction(block_b, k)
