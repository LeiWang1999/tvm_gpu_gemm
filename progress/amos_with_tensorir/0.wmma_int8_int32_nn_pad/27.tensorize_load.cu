                    ...
                    for (ax1_0_1: int32, 0, 2) {
                      for (ax0_1_1: int32, 0, 16) {
                        for (ax1_1_1: int32, 0, 16) {
                          block([640, 128], "BPad_global_shared_wmma.matrix_b") as [v0_4, v1_4] {
                            bind(v0_4, ((((k_0_0*32) + (k_0_1*16)) + (ax0_0_1*16)) + ax0_1_1))
                            bind(v1_4, (((j_0_1*32) + (ax1_0_1*16)) + ax1_1_1))
                            tir.reads([BPad_global_shared[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]])
                            tir.writes([BPad_global_shared_wmma.matrix_b[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]])
                            BPad_global_shared_wmma.matrix_b[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)] = BPad_global_shared[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]
                        }
                      }
                    }
                  }
                  for (i_0_2: int32, 0, 8) {
                    for (j_0_2: int32, 0, 2) {
                      for (i_1: int32, 0, 16) {
                        for (j_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([3200, 128, tir.reduce_axis(0, 640)], "B_update") as [vi, vj, vk] {
                              bind(vi, ((((i_0_0*128) + (i_0_1*128)) + (i_0_2*16)) + i_1))
                              bind(vj, ((((j_0_0*128) + (j_0_1*32)) + (j_0_2*16)) + j_1))
                              bind(vk, (((k_0_0*32) + (k_0_1*16)) + k_1))
                              tir.reads([CPad_shared_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)], APad_global_shared_wmma.matrix_a[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)], BPad_global_shared_wmma.matrix_b[floordiv(vk, 16), floordiv(vj, 16), floormod(vk, 16), floormod(vj, 16)]])
                ...
                for (ax1_0_2: int32, 0, 2) {
                  for (ax0_1_2: int32, 0, 16) {
                    for (ax1_1_2: int32, 0, 16) {
                      block([3200, 128], "CPad_shared_wmma.accumulator") as [v0_5, v1_5] {
                        bind(v0_5, (((i_0_0*128) + (ax0_0_2*16)) + ax0_1_2))
                        bind(v1_5, (((j_0_1*32) + (ax1_0_2*16)) + ax1_1_2))
                        tir.reads([CPad_shared_wmma.accumulator[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]])
                        tir.writes([CPad_shared[v0_5, v1_5]])
                        CPad_shared[v0_5, v1_5] = CPad_shared_wmma.accumulator[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]
                    }
                  }
                }
                  ...
                  for (ax0_ax1_fused_1: int32, 0, 4) "thread_binding" {
                    for (ax0_ax1_fused_2: int32, 0, 1) "thread_binding" {
                      for (ax0_ax1_fused_3: int32, 0, 32) "thread_binding" {
                        block([3200, 128], "CPad_shared") as [v0_6, v1_6] {
                          bind(v0_6, (((i_0_0*128) + (ax0_0_2*16)) + floordiv(((((ax0_ax1_fused_0*128) + (ax0_ax1_fused_1*32)) + (ax0_ax1_fused_2*32)) + ax0_ax1_fused_3), 32)))
                          bind(v1_6, ((j_0_1*32) + floormod(((((ax0_ax1_fused_0*128) + (ax0_ax1_fused_1*32)) + (ax0_ax1_fused_2*32)) + ax0_ax1_fused_3), 32)))
                          tir.reads([CPad_shared[v0_6, v1_6]])
                          tir.writes([C[v0_6, v1_6]])
                          C[v0_6, v1_6] = CPad_shared[v0_6, v1_6]
                      }
                    }
                  }
                }
