                ...
                for j_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                    for i_0_2_init, j_0_2_init in T.grid(8, 2):
                        with T.block("B_init_o"):
                            vi_o = T.axis.spatial(200, i_0_0 * 8 + i_0_1 * 8 + i_0_2_init)
                            vj_o = T.axis.spatial(8, j_0_0 * 8 + j_0_1 * 2 + j_0_2_init)
                            T.reads()
                            T.writes(CPad_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                            C_1 = T.match_buffer(CPad_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0, C_s1], scope="wmma.accumulator", offset_factor=16)
                    ...
                    for k_0_0 in T.serial(20, annotations={"thread_rasterization":1}):
                        ...
                        for k_0_1 in T.serial(2):
                            for ax0_0, ax1_0 in T.grid(8, 1):
                                with T.block("APad_global_shared_wmma.matrix_a_o"):
                                    v0_o = T.axis.spatial(200, i_0_0 * 8 + ax0_0)
                                    v1_o = T.axis.spatial(40, k_0_0 * 2 + k_0_1 + ax1_0)
                                    T.reads(APad_global_shared[v0_o, v1_o, 0 : 16, 0 : 16])
                                    T.writes(APad_global_shared_wmma_matrix_a[v0_o, v1_o, 0 : 16, 0 : 16])
                                    A_1 = T.match_buffer(APad_global_shared[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0, A_s1], scope="shared", offset_factor=16)
                                    C_2 = T.match_buffer(APad_global_shared_wmma_matrix_a[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[C_s0_1, C_s1_1], scope="wmma.matrix_a", offset_factor=16)
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.block("BPad_global_shared_wmma.matrix_b_o"):
                                    v0_o = T.axis.spatial(40, k_0_0 * 2 + k_0_1 + ax0_0)
                                    v1_o = T.axis.spatial(8, j_0_1 * 2 + ax1_0)
                                    T.reads(BPad_global_shared[v0_o, v1_o, 0 : 16, 0 : 16])
                                    T.writes(BPad_global_shared_wmma_matrix_b[v0_o, v1_o, 0 : 16, 0 : 16])
                                    A_2 = T.match_buffer(BPad_global_shared[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0_1, A_s1_1], scope="shared", offset_factor=16)
                                    C_3 = T.match_buffer(BPad_global_shared_wmma_matrix_b[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[C_s0_2, C_s1_2], scope="wmma.matrix_b", offset_factor=16)
                            ...
                            for i_0_2, j_0_2 in T.grid(8, 2):
                                with T.block("B_update_o"):
                                    vi_o = T.axis.spatial(200, i_0_0 * 8 + i_0_1 * 8 + i_0_2)
                                    vj_o = T.axis.spatial(8, j_0_0 * 8 + j_0_1 * 2 + j_0_2)
                                    vk_o = T.axis.reduce(40, k_0_0 * 2 + k_0_1)
                                    T.reads(CPad_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], APad_global_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], BPad_global_shared_wmma_matrix_b[vk_o, vj_o, 0 : 16, 0 : 16])
                                    T.writes(CPad_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                                    A_3 = T.match_buffer(APad_global_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0_2, A_s1_2], scope="wmma.matrix_a", offset_factor=16)
                                    B_1 = T.match_buffer(BPad_global_shared_wmma_matrix_b[vk_o, vj_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[B_s0, B_s1], scope="wmma.matrix_b", offset_factor=16)
                                    C_4 = T.match_buffer(CPad_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0_3, C_s1_3], scope="wmma.accumulator", offset_factor=16)
                    ...
                    for ax0_0 in T.serial(8):
                        for ax1_0 in T.serial(2):
                            with T.block("CPad_shared_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(200, i_0_0 * 8 + ax0_0)
                                v1_o = T.axis.spatial(8, j_0_1 * 2 + ax1_0)
                                T.reads(CPad_shared_wmma_accumulator[v0_o, v1_o, 0 : 16, 0 : 16])
                                T.writes(CPad_shared[v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16])
                                A_4 = T.match_buffer(CPad_shared_wmma_accumulator[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[A_s0_3, A_s1_3], scope="wmma.accumulator", offset_factor=16)
                                C_5 = T.match_buffer(CPad_shared[v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16], [16, 16], dtype="int32", strides=[C_s0_4, C_s1_4], scope="shared", offset_factor=16)
