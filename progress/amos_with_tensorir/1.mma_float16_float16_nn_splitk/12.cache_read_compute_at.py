                    ...
                    for j_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                        for k_0_0 in T.serial(512):
                            for ax0, ax1 in T.grid(128, 32):
                                with T.block("A_global_shared"):
                                    v0 = T.axis.spatial(1024, i_0_0 * 128 + ax0)
                            ...
                            for ax0, ax1 in T.grid(32, 256):
                                with T.block("B_global_shared"):
                                    ...
                                    v1 = T.axis.spatial(1024, j_0_0 * 256 + ax1)
                            ...
                            for k_0_1 in T.serial(2):
                                ...
                                for ax0, ax1 in T.grid(16, 64):
                                    with T.block("B_global_shared_warp"):
                                        ...
                                        v1 = T.axis.spatial(1024, j_0_0 * 256 + j_0_1 * 64 + ax1)
                        ...
                        for ax0, ax1 in T.grid(128, 64):
                            with T.block("TC_warp"):
                                ...
                                v1 = T.axis.spatial(1024, i_0_0 * 128 + ax0)
                                v2 = T.axis.spatial(1024, j_0_0 * 256 + j_0_1 * 64 + ax1)
                        ...
                        for ax0, ax1 in T.grid(128, 64):
                            with T.block("C"):
                                ...
                                vi = T.axis.spatial(1024, i_0_0 * 128 + ax0)
