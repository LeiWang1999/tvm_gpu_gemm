...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    TC_warp = alloc_buffer(float16[1, 64, 64, 32, 8])
     {
                  ...
                  for (j_0_2_init: int32, 0, 4) {
                    for (i_1_init: int32, 0, 16) {
                      for (j_1_init: int32, 0, 16) {
                        block([1, 1024, 1024], "B_init") as [vsk, vi, vj] {
                          bind(vsk, sk)
                          bind(vi, ((((i_0_0*128) + (i_0_1*128)) + (i_0_2_init*16)) + i_1_init))
                          bind(vj, ((((j_0_0*256) + (j_0_1*64)) + (j_0_2_init*16)) + j_1_init))
                          tir.reads([])
                          tir.writes([TC_warp[vsk, floordiv(vi, 16), floordiv(vj, 16), ((floormod(vi, 8)*4) + floordiv(floormod(vj, 8), 2)), (((floordiv(floormod(vj, 16), 8)*4) + (floordiv(floormod(vi, 16), 8)*2)) + floormod(vj, 2))]])
                          TC_warp[vsk, floordiv(vi, 16), floordiv(vj, 16), ((floormod(vi, 8)*4) + floordiv(floormod(vj, 8), 2)), (((floordiv(floormod(vj, 16), 8)*4) + (floordiv(floormod(vi, 16), 8)*2)) + floormod(vj, 2))] = 0f16
                      }
                    }
                  }
                }
                        ...
                        for (ax0_1_1: int32, 0, 16) {
                          for (ax1_1_1: int32, 0, 16) {
                            block([1024, 16384], "A_global_shared_warp") as [v0_4, v1_4] {
                              ...
                              tir.writes([A_global_shared_warp[floordiv(v0_4, 16), floordiv(v1_4, 16), ((floormod(v0_4, 16)*2) + floordiv(floormod(v1_4, 16), 8)), floormod(v1_4, 8)]])
                              A_global_shared_warp[floordiv(v0_4, 16), floordiv(v1_4, 16), ((floormod(v0_4, 16)*2) + floordiv(floormod(v1_4, 16), 8)), floormod(v1_4, 8)] = A_global_shared[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]
                          }
                        }
                      }
                    }
                        ...
                        for (ax0_1_2: int32, 0, 16) {
                          for (ax1_1_2: int32, 0, 16) {
                            block([16384, 1024], "B_global_shared_warp") as [v0_5, v1_5] {
                              ...
                              bind(v1_5, ((((j_0_0*256) + (j_0_1*64)) + (ax1_0_1*16)) + ax1_1_2))
                              tir.reads([B_global_shared[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]])
                              tir.writes([B_global_shared_warp[floordiv(v0_5, 16), floordiv(v1_5, 16), ((floormod(v0_5, 16)*2) + floordiv(floormod(v1_5, 16), 8)), floormod(v1_5, 8)]])
                              B_global_shared_warp[floordiv(v0_5, 16), floordiv(v1_5, 16), ((floormod(v0_5, 16)*2) + floordiv(floormod(v1_5, 16), 8)), floormod(v1_5, 8)] = B_global_shared[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]
                          }
                        }
                      }
                    }
                    for (i_0_2: int32, 0, 8) {
                      for (j_0_2: int32, 0, 4) {
                        for (i_1: int32, 0, 16) {
                          for (j_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([1, 1024, 1024, tir.reduce_axis(0, 16384)], "B_update") as [vsk_1, vi_1, vj_1, vk] {
                                bind(vsk_1, sk)
                                bind(vi_1, ((((i_0_0*128) + (i_0_1*128)) + (i_0_2*16)) + i_1))
                                bind(vj_1, ((((j_0_0*256) + (j_0_1*64)) + (j_0_2*16)) + j_1))
                                bind(vk, (((k_0_0*32) + (k_0_1*16)) + k_1))
                                tir.reads([TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(floormod(vj_1, 16), 8)*4) + (floordiv(floormod(vi_1, 16), 8)*2)) + floormod(vj_1, 2))], A_global_shared_warp[floordiv(vi_1, 16), floordiv(vk, 16), ((floormod(vi_1, 16)*2) + floordiv(floormod(vk, 16), 8)), floormod(vk, 8)], B_global_shared_warp[floordiv(vk, 16), floordiv(vj_1, 16), ((floormod(vk, 16)*2) + floordiv(floormod(vj_1, 16), 8)), floormod(vj_1, 8)]])
                                tir.writes([TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(floormod(vj_1, 16), 8)*4) + (floordiv(floormod(vi_1, 16), 8)*2)) + floormod(vj_1, 2))]])
                                TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(floormod(vj_1, 16), 8)*4) + (floordiv(floormod(vi_1, 16), 8)*2)) + floormod(vj_1, 2))] = (TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(floormod(vj_1, 16), 8)*4) + (floordiv(floormod(vi_1, 16), 8)*2)) + floormod(vj_1, 2))] + (A_global_shared_warp[floordiv(vi_1, 16), floordiv(vk, 16), ((floormod(vi_1, 16)*2) + floordiv(floormod(vk, 16), 8)), floormod(vk, 8)]*B_global_shared_warp[floordiv(vk, 16), floordiv(vj_1, 16), ((floormod(vk, 16)*2) + floordiv(floormod(vj_1, 16), 8)), floormod(vj_1, 8)]))
                            }
                          }
                        }
                      }
                    ...
                    for (ax0_1_3: int32, 0, 16) {
                      for (ax1_1_3: int32, 0, 16) {
                        block([1, 1024, 1024], "TC_warp") as [v0_6, v1_6, v2] {
                          bind(v0_6, 0)
                          bind(v1_6, (((i_0_0*128) + (ax0_0_2*16)) + ax0_1_3))
                          bind(v2, ((((j_0_0*256) + (j_0_1*64)) + (ax1_0_2*16)) + ax1_1_3))
                          tir.reads([TC_warp[v0_6, floordiv(v1_6, 16), floordiv(v2, 16), ((floormod(v1_6, 8)*4) + floordiv(floormod(v2, 8), 2)), (((floordiv(floormod(v2, 16), 8)*4) + (floordiv(floormod(v1_6, 16), 8)*2)) + floormod(v2, 2))]])
                          tir.writes([TC[v0_6, v1_6, v2]])
                          TC[v0_6, v1_6, v2] = TC_warp[v0_6, floordiv(v1_6, 16), floordiv(v2, 16), ((floormod(v1_6, 8)*4) + floordiv(floormod(v2, 8), 2)), (((floordiv(floormod(v2, 16), 8)*4) + (floordiv(floormod(v1_6, 16), 8)*2)) + floormod(v2, 2))]
                      }
                    }
                  }
                  for (ax0_2: int32, 0, 16) {
                    for (ax1_2: int32, 0, 64) {
                      block([1, 1024, 1024], "C") as [vsk_2, vi_2, vj_2] {
                        bind(vsk_2, 0)
                        bind(vi_2, (((i_0_0*128) + (ax0_0_2*16)) + ax0_2))
                        bind(vj_2, (((j_0_0*256) + (j_0_1*64)) + ax1_2))
                        tir.reads([C[vi_2, vj_2], TC[vsk_2, vi_2, vj_2]])
                        tir.writes([])
                        @tir.atomic_add(@tir.address_of(C[vi_2, vj_2], dtype=handle), TC[vsk_2, vi_2, vj_2], dtype=float16)
                    }
                  }
                }
              }
