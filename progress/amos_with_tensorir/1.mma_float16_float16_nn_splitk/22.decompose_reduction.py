                    ...
                    for j_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init, i_1_init, j_1_init in T.grid(8, 4, 16, 16):
                            with T.block("B_init"):
                                ...
                                vi = T.axis.spatial(1024, i_0_0 * 128 + i_0_1 * 128 + i_0_2_init * 16 + i_1_init)
                                vj = T.axis.spatial(1024, j_0_0 * 256 + j_0_1 * 64 + j_0_2_init * 16 + j_1_init)
                                T.reads()
                            ...
                            for k_0_1 in T.serial(2):
                                ...
                                for i_0_2, j_0_2, i_1, j_1, k_1 in T.grid(8, 4, 16, 16, 16):
                                    with T.block("B_update"):
                                        ...
                                        T.reads(TC_warp[vsk, vi // 16, vj // 16, vi % 16, vj % 16], A_global_shared_warp[vi // 16, vk // 16, vi % 16, vk % 16], B_global_shared_warp[vk // 16, vj // 16, vk % 16, vj % 16])
                                        T.writes(TC_warp[vsk, vi // 16, vj // 16, vi % 16, vj % 16])
