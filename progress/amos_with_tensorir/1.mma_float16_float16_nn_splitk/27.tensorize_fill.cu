              ...
              for (j_0_1: int32, 0, 4) "thread_binding" {
                for (i_0_2_init: int32, 0, 8) {
                  for (j_0_2_init: int32, 0, 4) {
                    block([1, 64, 64], "B_init_o") as [vsk, vi_o, vj_o] {
                      bind(vsk, sk)
                      bind(vi_o, (((i_0_0*8) + (i_0_1*8)) + i_0_2_init))
                      bind(vj_o, (((j_0_0*16) + (j_0_1*4)) + j_0_2_init))
                      tir.reads([])
                      tir.writes([TC_warp[vsk, vi_o, vj_o, 0:32, 0:8]])
                      C_warp = match_buffer(TC_warp[vsk, vi_o, vj_o, 0:32, 0:8])
                ...
                for (ax0_0_2: int32, 0, 8) {
                  ...
                  for (ax0_2: int32, 0, 16) {
                    for (ax1_2: int32, 0, 64) {
                      block([1, 1024, 1024], "C") as [vsk_2, vi_1, vj_1] {
                        bind(vsk_2, 0)
                        bind(vi_1, (((i_0_0*128) + (ax0_0_2*16)) + ax0_2))
                        bind(vj_1, (((j_0_0*256) + (j_0_1*64)) + ax1_2))
                        tir.reads([C[vi_1, vj_1], TC[vsk_2, vi_1, vj_1]])
                        tir.writes([])
                        @tir.atomic_add(@tir.address_of(C[vi_1, vj_1], dtype=handle), TC[vsk_2, vi_1, vj_1], dtype=float16)
                    }
                  }
                }
              }
