            ...
            for (i_0_1: int32, 0, 1) "thread_binding" {
              for (j_0_1: int32, 0, 4) "thread_binding" {
                    ...
                    for (ax0_5: int32, 0, 16) {
                      for (ax1_5: int32, 0, 64) {
                        block([16384, 1024], "B_global_shared_warp") as [v0_5, v1_5] {
                          ...
                          bind(v1_5, (((j_0_0*256) + (j_0_1*64)) + ax1_5))
                ...
                for (ax0_6: int32, 0, 128) {
                  for (ax1_6: int32, 0, 64) {
                    block([1, 1024, 1024], "TC_warp") as [v0_6, v1_6, v2] {
                      bind(v0_6, 0)
                      bind(v1_6, ((i_0_0*128) + ax0_6))
                      bind(v2, (((j_0_0*256) + (j_0_1*64)) + ax1_6))
                ...
                for (ax0_7: int32, 0, 128) {
                  for (ax1_7: int32, 0, 64) {
                    block([1, 1024, 1024], "C") as [vsk_1, vi_1, vj_1] {
                      bind(vsk_1, 0)
                      bind(vi_1, ((i_0_0*128) + ax0_7))
                      bind(vj_1, (((j_0_0*256) + (j_0_1*64)) + ax1_7))
