              ...
              for (j_0_1: int32, 0, 4) "thread_binding" {
                ...
                for (k_0_0: int32, 0, 512) {
                  ...
                  for (k_0_1: int32, 0, 2) {
                    ...
                    for (i_0_2: int32, 0, 8) {
                      for (j_0_2: int32, 0, 4) {
                        block([1, 64, 64, tir.reduce_axis(0, 1024)], "B_update_o") as [vsk_1, vi_o_1, vj_o_1, vk_o] {
                          bind(vsk_1, sk)
                          bind(vi_o_1, (((i_0_0*8) + (i_0_1*8)) + i_0_2))
                          bind(vj_o_1, (((j_0_0*16) + (j_0_1*4)) + j_0_2))
                          bind(vk_o, ((k_0_0*2) + k_0_1))
                          tir.reads([TC_warp[vsk_1, vi_o_1, vj_o_1, 0:32, 0:8], A_global_shared_warp[vi_o_1, vk_o, 0:32, 0:8], B_global_shared_warp[vk_o, vj_o_1, 0:32, 0:8]])
                          tir.writes([TC_warp[vsk_1, vi_o_1, vj_o_1, 0:32, 0:8]])
                          A_2 = match_buffer(A_global_shared_warp[vi_o_1, vk_o, 0:32, 0:8])
                          B_2 = match_buffer(B_global_shared_warp[vk_o, vj_o_1, 0:32, 0:8])
                          C_2 = match_buffer(TC_warp[vsk_1, vi_o_1, vj_o_1, 0:32, 0:8])
                ...
                for (ax0_0_2: int32, 0, 8) {
                  for (ax1_0_2: int32, 0, 4) {
                    block([1, 64, 64], "TC_warp_o") as [v0_4, v1_o_2, v2_o] {
                      bind(v0_4, 0)
                      bind(v1_o_2, ((i_0_0*8) + ax0_0_2))
                      bind(v2_o, (((j_0_0*16) + (j_0_1*4)) + ax1_0_2))
                      tir.reads([TC_warp[v0_4, v1_o_2, v2_o, 0:32, 0:8]])
                      tir.writes([TC[v0_4, (v1_o_2*16):((v1_o_2*16) + 16), (v2_o*16):((v2_o*16) + 16)]])
                      C_warp_2 = match_buffer(TC_warp[v0_4, v1_o_2, v2_o, 0:32, 0:8])
                      C_4 = match_buffer(TC[v0_4, (v1_o_2*16):((v1_o_2*16) + 16), (v2_o*16):((v2_o*16) + 16)])
                      attr [IterVar(tx_4: int32, [0:32], "ThreadIndex", "threadIdx.x")] "thread_extent" = 32;
                      @tir.mma_store(16, 16, @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), C_5: Pointer(shared float16), elem_offset_8: int32, (C_s0: int32*16), 2, dtype=handle), C_warp_3: Pointer(warp float16), elem_offset_9: int32, C_s0, dtype=float16)
                  }
                  for (ax0_ax1_fused_0_2: int32, 0, 1) "thread_binding" {
                    for (ax0_ax1_fused_1_2: int32, 0, 32) {
                      for (ax0_ax1_fused_2_2: int32, 0, 32) "thread_binding" {
                        block([1, 1024, 1024], "C") as [vsk_2, vi, vj] {
                          bind(vsk_2, 0)
                          bind(vi, (((i_0_0*128) + (ax0_0_2*16)) + floordiv((((ax0_ax1_fused_0_2*1024) + (ax0_ax1_fused_1_2*32)) + ax0_ax1_fused_2_2), 64)))
                          bind(vj, (((j_0_0*256) + (j_0_1*64)) + floormod((((ax0_ax1_fused_0_2*1024) + (ax0_ax1_fused_1_2*32)) + ax0_ax1_fused_2_2), 64)))
                          tir.reads([C[vi, vj], TC[vsk_2, vi, vj]])
                          tir.writes([])
                          @tir.atomic_add(@tir.address_of(C[vi, vj], dtype=handle), TC[vsk_2, vi, vj], dtype=float16)
                      }
                    }
                  }
                }
