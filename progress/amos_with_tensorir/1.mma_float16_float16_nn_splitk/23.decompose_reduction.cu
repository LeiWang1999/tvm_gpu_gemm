                          ...
                          for (j_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([1, 1024, 1024, tir.reduce_axis(0, 16384)], "B_update") as [vsk_1, vi_1, vj_1, vk] {
                                ...
                                tir.reads([TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)], A_global_shared_warp[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)], B_global_shared_warp[floordiv(vk, 16), floordiv(vj_1, 16), floormod(vk, 16), floormod(vj_1, 16)]])
                                tir.writes([TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)]])
                                TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] = (TC_warp[vsk_1, floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] + (A_global_shared_warp[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)]*B_global_shared_warp[floordiv(vk, 16), floordiv(vj_1, 16), floormod(vk, 16), floormod(vj_1, 16)]))
                            }
                          }
                        }
                      }
