                        ...
                        for ax0_ax1_fused_5 in T.serial(1):
                            for ax0_ax1_fused_6 in T.vectorized(8):
                                with T.block("B_global"):
                                    v0 = T.axis.spatial(16384, (ax0_ax1_fused_0 * 2048 + ax0_ax1_fused_1 * 64 + ax0_ax1_fused_2 * 64 + ax0_ax1_fused_3 * 64 + ax0_ax1_fused_4 * 8 + ax0_ax1_fused_5 * 8 + ax0_ax1_fused_6) // 1024)
                                    v1 = T.axis.spatial(1024, (ax0_ax1_fused_0 * 2048 + ax0_ax1_fused_1 * 64 + ax0_ax1_fused_2 * 64 + ax0_ax1_fused_3 * 64 + ax0_ax1_fused_4 * 8 + ax0_ax1_fused_5 * 8 + ax0_ax1_fused_6) % 1024)
                                    T.reads(B[v0, v1])
                        ...
                        for ax0_ax1_fused_5 in T.serial(1):
                            for ax0_ax1_fused_6 in T.vectorized(8):
                                with T.block("A_global"):
                                    v0 = T.axis.spatial(1024, (ax0_ax1_fused_0 * 2048 + ax0_ax1_fused_1 * 64 + ax0_ax1_fused_2 * 64 + ax0_ax1_fused_3 * 64 + ax0_ax1_fused_4 * 8 + ax0_ax1_fused_5 * 8 + ax0_ax1_fused_6) // 16384)
                                    v1 = T.axis.spatial(16384, (ax0_ax1_fused_0 * 2048 + ax0_ax1_fused_1 * 64 + ax0_ax1_fused_2 * 64 + ax0_ax1_fused_3 * 64 + ax0_ax1_fused_4 * 8 + ax0_ax1_fused_5 * 8 + ax0_ax1_fused_6) % 16384)
                                    T.reads(A[v0, v1])
            ...
            for j_0_0 in T.thread_binding(4, thread="blockIdx.x"):
                for i_0_1 in T.thread_binding(1, thread="threadIdx.y"):
                    for j_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                        for i_0_2_init in T.serial(8, annotations={"thread_rasterization":16}):
                            for j_0_2_init in T.serial(4):
                            ...
                            for k_0_1 in T.serial(2):
                                ...
                                for ax0_0, ax1_0 in T.grid(1, 4):
                                    with T.block("B_global_shared_warp_o"):
                                        ...
                                        v1_o = T.axis.spatial(64, j_0_0 * 16 + j_0_1 * 4 + ax1_0)
                                ...
                                for i_0_2, j_0_2 in T.grid(8, 4):
                                    with T.block("B_update_o"):
                                        vsk = T.axis.spatial(1, sk)
                                        vi_o = T.axis.spatial(64, i_0_0 * 8 + i_0_1 * 8 + i_0_2)
                                        vj_o = T.axis.spatial(64, j_0_0 * 16 + j_0_1 * 4 + j_0_2)
                                        vk_o = T.axis.reduce(1024, k_0_0 * 2 + k_0_1)
                                        T.reads(TC_warp[vsk, vi_o, vj_o, 0 : 32, 0 : 8], A_global_shared_warp[vi_o, vk_o, 0 : 32, 0 : 8], B_global_shared_warp[vk_o, vj_o, 0 : 32, 0 : 8])
                                        T.writes(TC_warp[vsk, vi_o, vj_o, 0 : 32, 0 : 8])
                                        ...
                                        C_1 = T.match_buffer(TC_warp[vsk, vi_o, vj_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=16)
                        ...
                        for ax0_0 in T.serial(8):
                            for ax1_0 in T.serial(4):
                                with T.block("TC_warp_o"):
                                    v0 = T.axis.spatial(1, 0)
                                    v1_o = T.axis.spatial(64, i_0_0 * 8 + ax0_0)
                                    v2_o = T.axis.spatial(64, j_0_0 * 16 + j_0_1 * 4 + ax1_0)
                                    T.reads(TC_warp[v0, v1_o, v2_o, 0 : 32, 0 : 8])
                                    T.writes(TC[v0, v1_o * 16 : v1_o * 16 + 16, v2_o * 16 : v2_o * 16 + 16])
                                    C_warp_1 = T.match_buffer(TC_warp[v0, v1_o, v2_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=1)
                                    C_2 = T.match_buffer(TC[v0, v1_o * 16 : v1_o * 16 + 16, v2_o * 16 : v2_o * 16 + 16], [16, 16], dtype="float16", strides=[C_s0, C_s1], scope="shared", offset_factor=1)
                                    T.launch_thread(tx_4, 32)
                                    T.mma_store(16, 16, T.tvm_access_ptr(T.type_annotation(dtype="float16"), C_2.data, C_2.elem_offset, C_s0 * 16, 2, dtype="handle"), C_warp_1.data, C_warp_1.elem_offset, C_s0, dtype="float16")
                            for ax0_ax1_fused_0 in T.thread_binding(1, thread="threadIdx.y"):
                                for ax0_ax1_fused_1 in T.serial(32):
                                    for ax0_ax1_fused_2 in T.thread_binding(32, thread="threadIdx.x"):
                                        with T.block("C"):
                                            vsk = T.axis.spatial(1, 0)
                                            vi = T.axis.spatial(1024, i_0_0 * 128 + ax0_0 * 16 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 32 + ax0_ax1_fused_2) // 64)
                                            vj = T.axis.spatial(1024, j_0_0 * 256 + j_0_1 * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 32 + ax0_ax1_fused_2) % 64)
