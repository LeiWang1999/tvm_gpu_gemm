                  ...
                  for (ax1_0_2: int32, 0, 4) {
                    for (ax0_1_2: int32, 0, 16) {
                      for (ax1_1_2: int32, 0, 16) {
                        block([1, 1024, 1024], "TC_warp") as [v0_5, v1_5, v2] {
                          bind(v0_5, 0)
                          bind(v1_5, (((i_0_0*128) + (ax0_0_2*16)) + ax0_1_2))
                          bind(v2, ((((j_0_0*256) + (j_0_1*64)) + (ax1_0_2*16)) + ax1_1_2))
                          tir.reads([TC_warp[v0_5, floordiv(v1_5, 16), floordiv(v2, 16), ((floormod(v1_5, 8)*4) + floordiv(floormod(v2, 8), 2)), (((floordiv(floormod(v2, 16), 8)*4) + (floordiv(floormod(v1_5, 16), 8)*2)) + floormod(v2, 2))]])
                          tir.writes([TC[v0_5, v1_5, v2]])
                          TC[v0_5, v1_5, v2] = TC_warp[v0_5, floordiv(v1_5, 16), floordiv(v2, 16), ((floormod(v1_5, 8)*4) + floordiv(floormod(v2, 8), 2)), (((floordiv(floormod(v2, 16), 8)*4) + (floordiv(floormod(v1_5, 16), 8)*2)) + floormod(v2, 2))]
                      }
                    }
                  }
