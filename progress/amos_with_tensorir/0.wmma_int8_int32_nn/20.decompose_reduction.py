                        ...
                        for k_0_1 in T.serial(2):
                            ...
                            for i_0_2, j_0_2, i_1, j_1, k_1 in T.grid(8, 2, 16, 16, 16):
                                with T.block("B_update"):
                                    ...
                                    T.reads(C_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16], A_global_shared_wmma_matrix_a[vi // 16, vk // 16, vi % 16, vk % 16], B_global_shared_wmma_matrix_b[vk // 16, vj // 16, vk % 16, vj % 16])
                                    T.writes(C_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16])
                                    C_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16] = C_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16] + T.Cast("int32", A_global_shared_wmma_matrix_a[vi // 16, vk // 16, vi % 16, vk % 16]) * T.Cast("int32", B_global_shared_wmma_matrix_b[vk // 16, vj // 16, vk % 16, vj % 16])
