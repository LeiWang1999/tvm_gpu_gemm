...
*((uint *)&(&(C[(((((((int)blockIdx.y) * 131072) + (ax0_0_1 * 16384)) + (((int)blockIdx.x) * 256)) + (((int)threadIdx.z) * 64)) + (ax1_0_1 * 16))]))[((((((local_id % 4) / 2) * 8) + (threadIdx.x / 4)) * 1024) + ((((local_id / 4) * 8) + ((threadIdx.x % 4) * 2)) + (local_id % 2)))]) = *((uint *)&C_warp[((ax0_0_1 * 32) + (ax1_0_1 * 8)) + local_id]);
}
;
    }
  }
