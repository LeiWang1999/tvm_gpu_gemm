                      ...
                      for (ax1_0_1: int32, 0, 1) {
                        for (ax0_1_1: int32, 0, 16) {
                          for (ax1_1_1: int32, 0, 16) {
                            block([16384, 16384], "B_global_shared_warp") as [v0_4, v1_4] {
                              bind(v0_4, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + (ax0_0_1*16)) + ax0_1_1))
                  ...
                  for (ax1_0_2: int32, 0, 8) {
                    for (ax0_1_2: int32, 0, 16) {
                      for (ax1_1_2: int32, 0, 16) {
                        block([16384, 16384], "C_warp") as [v0_5, v1_5] {
                          bind(v0_5, ((((i_0_0*128) + (i_0_1*64)) + (ax0_0_2*16)) + ax0_1_2))
                          bind(v1_5, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + (ax1_0_2*16)) + ax1_1_2))
