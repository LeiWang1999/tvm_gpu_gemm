                    ...
                    for (i_1_init: int32, 0, 16) {
                      for (j_1_init: int32, 0, 16) {
                        block([16384, 16384], "B_init") as [vi, vj] {
                          bind(vi, ((((i_0_0*128) + (i_0_1*64)) + (i_0_2_init*16)) + i_1_init))
                          bind(vj, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + (j_0_2_init*16)) + j_1_init))
                          tir.reads([])
                      ...
                      for (ax1_0: int32, 0, 1) {
                        for (ax0_1_1: int32, 0, 16) {
                          for (ax1_1_1: int32, 0, 16) {
                            block([16384, 16384], "A_global_shared_warp") as [v0_4, v1_4] {
                              bind(v0_4, ((((i_0_0*128) + (i_0_1*64)) + (ax0_0*16)) + ax0_1_1))
                      ...
                      for (ax1_0_1: int32, 0, 1) {
                        for (ax0_1_2: int32, 0, 16) {
                          for (ax1_1_2: int32, 0, 16) {
                            block([16384, 16384], "B_global_shared_warp") as [v0_5, v1_5] {
                              bind(v0_5, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + (ax0_0_1*16)) + ax0_1_2))
                  ...
                  for (ax1_0_2: int32, 0, 8) {
                    for (ax0_1_3: int32, 0, 16) {
                      for (ax1_1_3: int32, 0, 16) {
                        block([16384, 16384], "C_warp") as [v0_6, v1_6] {
                          bind(v0_6, ((((i_0_0*128) + (i_0_1*64)) + (ax0_0_2*16)) + ax0_1_3))
                          bind(v1_6, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + (ax1_0_2*16)) + ax1_1_3))
                          tir.reads([C_warp[floordiv(v0_6, 16), floordiv(v1_6, 16), ((floormod(v0_6, 8)*4) + floordiv(floormod(v1_6, 8), 2)), (((floordiv(floormod(v1_6, 16), 8)*4) + (floordiv(floormod(v0_6, 16), 8)*2)) + floormod(v1_6, 2))]])
                          tir.writes([C[v0_6, v1_6]])
                          C[v0_6, v1_6] = C_warp[floordiv(v0_6, 16), floordiv(v1_6, 16), ((floormod(v0_6, 8)*4) + floordiv(floormod(v1_6, 8), 2)), (((floordiv(floormod(v1_6, 16), 8)*4) + (floordiv(floormod(v0_6, 16), 8)*2)) + floormod(v1_6, 2))]
                      }
                    }
                  }
                }
