            ...
            for j_0_0_1 in T.thread_binding(16, thread="blockIdx.x"):
                for i_0_1 in T.thread_binding(2, thread="threadIdx.y"):
                    for j_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init, i_1_init, j_1_init in T.grid(4, 8, 16, 16):
                            with T.block("B_init"):
                                vi = T.axis.spatial(16384, i_0_0 * 128 + i_0_1 * 64 + i_0_2_init * 16 + i_1_init)
                                vj = T.axis.spatial(16384, j_0_0_0 * 4096 + j_0_0_1 * 256 + j_0_1 * 128 + j_0_2_init * 16 + j_1_init)
                                T.reads()
                            ...
                            for k_0_1 in T.serial(2):
                                ...
                                for i_0_2, j_0_2, i_1, j_1, k_1 in T.grid(4, 8, 16, 16, 16):
                                    with T.block("B_update"):
                                        ...
                                        T.reads(C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2], A_global_shared_warp[vi // 16, vk // 16, vi % 16 * 2 + vk % 16 // 8, vk % 8], B_global_shared_warp[vj // 16, vk // 16, vj % 16 * 2 + vk % 16 // 8, vk % 8])
                                        T.writes(C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2])
                                        C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2] = C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2] + A_global_shared_warp[vi // 16, vk // 16, vi % 16 * 2 + vk % 16 // 8, vk % 8] * B_global_shared_warp[vj // 16, vk // 16, vj % 16 * 2 + vk % 16 // 8, vk % 8]
