...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    A_global_shared_warp = alloc_buffer(float16[1024, 1024, 16, 16])
    B_global = alloc_buffer(float16[1024, 1024, 16, 16])
    B_global_shared = alloc_buffer(float16[1024, 1024, 16, 16])
    B_global_shared_warp = alloc_buffer(float16[1024, 1024, 16, 16])
              ...
              for (j_0_1: int32, 0, 2) "thread_binding" {
                for (k_0_0: int32, 0, 512) {
                  for (ax0_2: int32, 0, 128) {
                    for (ax1_2: int32, 0, 32) {
                      block([16384, 16384], "A_global_shared") as [v0_2, v1_2] {
                        bind(v0_2, ((i_0_0*128) + ax0_2))
                        bind(v1_2, ((k_0_0*32) + ax1_2))
                  ...
                  for (ax0_3: int32, 0, 256) {
                    for (ax1_3: int32, 0, 32) {
                      block([16384, 16384], "B_global_shared") as [v0_3, v1_3] {
                        bind(v0_3, (((j_0_0_0*4096) + (j_0_0_1*256)) + ax0_3))
                        bind(v1_3, ((k_0_0*32) + ax1_3))
                  ...
                  for (k_0_1: int32, 0, 2) {
                    for (ax0_4: int32, 0, 64) {
                      for (ax1_4: int32, 0, 16) {
                        block([16384, 16384], "A_global_shared_warp") as [v0_4, v1_4] {
                          bind(v0_4, (((i_0_0*128) + (i_0_1*64)) + ax0_4))
                          bind(v1_4, (((k_0_0*32) + (k_0_1*16)) + ax1_4))
                    ...
                    for (ax0_5: int32, 0, 128) {
                      for (ax1_5: int32, 0, 16) {
                        block([16384, 16384], "B_global_shared_warp") as [v0_5, v1_5] {
                          bind(v0_5, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + ax0_5))
                          bind(v1_5, (((k_0_0*32) + (k_0_1*16)) + ax1_5))
                          ...
                          for (j_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([16384, 16384, tir.reduce_axis(0, 16384)], "B") as [vi, vj, vk] {
                                ...
                                tir.reads([A_global_shared_warp[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)], B_global_shared_warp[floordiv(vj, 16), floordiv(vk, 16), floormod(vj, 16), floormod(vk, 16)]])
                                ...
                                C_warp[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)] = (C_warp[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)] + (A_global_shared_warp[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)]*B_global_shared_warp[floordiv(vj, 16), floordiv(vk, 16), floormod(vj, 16), floormod(vk, 16)]))
                            }
                          }
                        }
                      }
                ...
                for (ax0_6: int32, 0, 64) {
                  for (ax1_6: int32, 0, 128) {
                    block([16384, 16384], "C_warp") as [v0_6, v1_6] {
                      bind(v0_6, (((i_0_0*128) + (i_0_1*64)) + ax0_6))
                      bind(v1_6, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + ax1_6))
