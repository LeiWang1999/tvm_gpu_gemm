                ...
                for i_0_1 in T.thread_binding(2, thread="threadIdx.y"):
                    for j_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                        for k_0_0 in T.serial(512):
                            ...
                            for ax0, ax1 in T.grid(256, 32):
                                with T.block("B_global_shared"):
                                    v0 = T.axis.spatial(16384, j_0_0_0 * 4096 + j_0_0_1 * 256 + ax0)
                                    v1 = T.axis.spatial(16384, k_0_0 * 32 + ax1)
                            ...
                            for k_0_1 in T.serial(2):
                                for ax0, ax1 in T.grid(64, 16):
                                    with T.block("A_global_shared_warp"):
                                        v0 = T.axis.spatial(16384, i_0_0 * 128 + i_0_1 * 64 + ax0)
                                ...
                                for ax0, ax1 in T.grid(128, 16):
                                    with T.block("B_global_shared_warp"):
                                        v0 = T.axis.spatial(16384, j_0_0_0 * 4096 + j_0_0_1 * 256 + j_0_1 * 128 + ax0)
                                        v1 = T.axis.spatial(16384, k_0_0 * 32 + k_0_1 * 16 + ax1)
                        ...
                        for ax0, ax1 in T.grid(64, 128):
                            with T.block("C_warp"):
                                v0 = T.axis.spatial(16384, i_0_0 * 128 + i_0_1 * 64 + ax0)
                                v1 = T.axis.spatial(16384, j_0_0_0 * 4096 + j_0_0_1 * 256 + j_0_1 * 128 + ax1)
