...
def func(A: T.Buffer[(16384, 16384), "float16"], B: T.Buffer[(16384, 16384), "float16"], C: T.Buffer[(16384, 16384), "float16"]):
    ...
    # body
    # with T.block("root")
    A_global = T.alloc_buffer([16384, 16384], dtype="float16")
    A_global_shared = T.alloc_buffer([16384, 16384], dtype="float16", scope="shared")
    A_global_shared_warp = T.alloc_buffer([16384, 16384], dtype="float16", scope="warp")
    B_global = T.alloc_buffer([16384, 16384], dtype="float16")
    B_global_shared = T.alloc_buffer([16384, 16384], dtype="float16", scope="shared")
    B_global_shared_warp = T.alloc_buffer([16384, 16384], dtype="float16", scope="warp")
    ...
    for i, j, k in T.grid(16384, 16384, 16384):
        with T.block("B"):
            ...
            T.reads(A_global_shared_warp[vi, vk], B_global_shared_warp[vj, vk])
