                  ...
                  for (i_0_2: int32, 0, 8) {
                    for (j_0_2: int32, 0, 2) {
                      block([1024, 1024, tir.reduce_axis(0, 1024)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                        ...
                        tir.reads([C_wmma.accumulator[vi_o_1, vj_o_1, 0:16, 0:16], A_global_shared_wmma.matrix_a[vi_o_1, vk_o, 0:16, 0:16], B_global_shared_wmma.matrix_b[vk_o, vj_o_1, 0:16, 0:16]])
