                    ...
                    for k_0_0 in T.serial(512, annotations={"thread_rasterization":1}):
                        for ax0, ax1 in T.grid(128, 32):
                            with T.block("A_global_shared"):
                                v0 = T.axis.spatial(16384, i_0_0 * 128 + ax0)
                        ...
                        for ax0, ax1 in T.grid(32, 128):
                            with T.block("B_global_shared"):
                                v0 = T.axis.spatial(16384, k_0_0 * 32 + ax0)
                                v1 = T.axis.spatial(16384, j_0_0 * 128 + ax1)
                        ...
                        for k_0_1 in T.serial(2):
                            ...
                            for ax0, ax1 in T.grid(16, 32):
                                with T.block("B_global_shared_wmma.matrix_b"):
                                    v0 = T.axis.spatial(16384, k_0_0 * 32 + k_0_1 * 16 + ax0)
                                    v1 = T.axis.spatial(16384, j_0_0 * 128 + j_0_1 * 32 + ax1)
