                ...
                for j_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                    for i_0_2_init, j_0_2_init in T.grid(8, 2):
                        with T.block("B_init_o"):
                            ...
                            T.reads()
                            T.writes(C_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                            C_1 = T.match_buffer(C_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0, C_s1], scope="wmma.accumulator", offset_factor=16)
                        ...
                        for k_0_1 in T.serial(2):
                            ...
                            for i_0_2, j_0_2 in T.grid(8, 2):
                                with T.block("B_update_o"):
                                    ...
                                    T.reads(C_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], A_global_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], B_global_shared_wmma_matrix_b[vk_o, vj_o, 0 : 16, 0 : 16])
                                    T.writes(C_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                                    ...
                                    C_4 = T.match_buffer(C_shared_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0_3, C_s1_3], scope="wmma.accumulator", offset_factor=16)
                    ...
                    for ax0_0 in T.serial(8):
                        for ax1_0 in T.serial(2):
                            with T.block("C_shared_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(1024, i_0_0 * 8 + ax0_0)
                                v1_o = T.axis.spatial(1024, j_0_0 * 8 + j_0_1 * 2 + ax1_0)
                                T.reads(C_shared_wmma_accumulator[v0_o, v1_o, 0 : 16, 0 : 16])
                                T.writes(C_shared[v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16])
                                A_4 = T.match_buffer(C_shared_wmma_accumulator[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[A_s0_3, A_s1_3], scope="wmma.accumulator", offset_factor=16)
                                C_5 = T.match_buffer(C_shared[v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16], [16, 16], dtype="int32", strides=[C_s0_4, C_s1_4], scope="shared", offset_factor=16)
                                ...
                                for ax0_ax1_fused_2 in T.thread_binding(1, thread="threadIdx.y"):
                                    for ax0_ax1_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                        with T.block("C_shared"):
                                            v0 = T.axis.spatial(16384, i_0_0 * 128 + ax0_0 * 16 + (ax0_ax1_fused_0 * 128 + ax0_ax1_fused_1 * 32 + ax0_ax1_fused_2 * 32 + ax0_ax1_fused_3) // 32)
                                            v1 = T.axis.spatial(16384, j_0_0 * 128 + j_0_1 * 32 + (ax0_ax1_fused_0 * 128 + ax0_ax1_fused_1 * 32 + ax0_ax1_fused_2 * 32 + ax0_ax1_fused_3) % 32)
