        ...
        for (j_0_0: int32, 0, 128) "thread_binding" {
          for (i_0_1: int32, 0, 1) "thread_binding" {
            for (j_0_1: int32, 0, 4) "thread_binding" {
              for (k_0_0: int32, 0, 512) {
                ...
                for (ax0_3: int32, 0, 32) {
                  for (ax1_3: int32, 0, 128) {
                    block([16384, 16384], "B_global_shared") as [v0_3, v1_3] {
                      bind(v0_3, ((k_0_0*32) + ax0_3))
                      bind(v1_3, ((j_0_0*128) + ax1_3))
                ...
                for (k_0_1: int32, 0, 2) {
                  ...
                  for (ax0_5: int32, 0, 16) {
                    for (ax1_5: int32, 0, 32) {
                      block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                        bind(v0_5, (((k_0_0*32) + (k_0_1*16)) + ax0_5))
                        bind(v1_5, (((j_0_0*128) + (j_0_1*32)) + ax1_5))
              ...
              for (ax0_6: int32, 0, 128) {
                for (ax1_6: int32, 0, 32) {
                  block([16384, 16384], "C_shared_wmma.accumulator") as [v0_6, v1_6] {
                    bind(v0_6, ((i_0_0*128) + ax0_6))
                    bind(v1_6, (((j_0_0*128) + (j_0_1*32)) + ax1_6))
              ...
              for (ax0_7: int32, 0, 128) {
                for (ax1_7: int32, 0, 32) {
                  block([16384, 16384], "C_shared") as [v0_7, v1_7] {
                    bind(v0_7, ((i_0_0*128) + ax0_7))
                    bind(v1_7, (((j_0_0*128) + (j_0_1*32)) + ax1_7))
