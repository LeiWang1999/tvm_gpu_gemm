                  ...
                  for (i_1_init: int32, 0, 16) {
                    for (j_1_init: int32, 0, 16) {
                      block([16384, 16384], "B_init") as [vi, vj] {
                        ...
                        C_shared_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)] = 0
                    }
                  }
                }
              }
                      ...
                      for (ax0_1_2: int32, 0, 16) {
                        for (ax1_1_2: int32, 0, 16) {
                          block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                            ...
                            bind(v1_5, ((((j_0_0*128) + (j_0_1*32)) + (ax1_0_1*16)) + ax1_1_2))
                        ...
                        for (j_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                              ...
                              tir.reads([C_shared_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)], A_global_shared_wmma.matrix_a[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)], B_global_shared_wmma.matrix_b[floordiv(vk, 16), floordiv(vj_1, 16), floormod(vk, 16), floormod(vj_1, 16)]])
                              tir.writes([C_shared_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)]])
                              C_shared_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] = (C_shared_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] + (cast(int32, A_global_shared_wmma.matrix_a[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)])*cast(int32, B_global_shared_wmma.matrix_b[floordiv(vk, 16), floordiv(vj_1, 16), floormod(vk, 16), floormod(vj_1, 16)])))
                          }
                        }
                      }
                    }
                ...
                for (ax1_0_2: int32, 0, 2) {
                  for (ax0_1_3: int32, 0, 16) {
                    for (ax1_1_3: int32, 0, 16) {
                      block([16384, 16384], "C_shared_wmma.accumulator") as [v0_6, v1_6] {
                        bind(v0_6, (((i_0_0*128) + (ax0_0_2*16)) + ax0_1_3))
                        bind(v1_6, ((((j_0_0*128) + (j_0_1*32)) + (ax1_0_2*16)) + ax1_1_3))
                        tir.reads([C_shared_wmma.accumulator[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]])
                        tir.writes([C_shared[v0_6, v1_6]])
                        C_shared[v0_6, v1_6] = C_shared_wmma.accumulator[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]
                    }
                  }
                }
                  ...
                  for (ax0_ax1_fused_1: int32, 0, 4) "thread_binding" {
                    for (ax0_ax1_fused_2: int32, 0, 1) "thread_binding" {
                      for (ax0_ax1_fused_3: int32, 0, 32) "thread_binding" {
                        block([16384, 16384], "C_shared") as [v0_7, v1_7] {
                          bind(v0_7, (((i_0_0*128) + (ax0_0_2*16)) + floordiv(((((ax0_ax1_fused_0*128) + (ax0_ax1_fused_1*32)) + (ax0_ax1_fused_2*32)) + ax0_ax1_fused_3), 32)))
                          bind(v1_7, (((j_0_0*128) + (j_0_1*32)) + floormod(((((ax0_ax1_fused_0*128) + (ax0_ax1_fused_1*32)) + (ax0_ax1_fused_2*32)) + ax0_ax1_fused_3), 32)))
                          tir.reads([C_shared[v0_7, v1_7]])
                          tir.writes([C[v0_7, v1_7]])
                          C[v0_7, v1_7] = C_shared[v0_7, v1_7]
                      }
                    }
                  }
                }
