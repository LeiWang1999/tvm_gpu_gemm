                        ...
                        for k_0_1 in T.serial(2):
                            ...
                            for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(1, 2, 16, 16):
                                with T.block("B_global_shared_wmma.matrix_b"):
                                    ...
                                    v1 = T.axis.spatial(16384, j_0_0 * 128 + j_0_1 * 32 + ax1_0 * 16 + ax1_1)
                            ...
                            for i_0_2, j_0_2, i_1, j_1, k_1 in T.grid(8, 2, 16, 16, 16):
                                with T.block("B_update"):
                                    ...
                                    T.reads(C_shared_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16], A_global_shared_wmma_matrix_a[vi // 16, vk // 16, vi % 16, vk % 16], B_global_shared_wmma_matrix_b[vk // 16, vj // 16, vk % 16, vj % 16])
