                    ...
                    for (ax0_1_2: int32, 0, 16) {
                      for (ax1_1_2: int32, 0, 16) {
                        block([16384, 16384], "B_global_shared") as [v0_3, v1_3] {
                          ...
                          bind(v1_3, (((j_0_0*128) + (ax1_0_1*16)) + ax1_1_2))
                      ...
                      for (ax0_1_4: int32, 0, 16) {
                        for (ax1_1_4: int32, 0, 16) {
                          block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                            ...
                            bind(v1_5, ((((j_0_0*128) + (j_0_1*32)) + (ax1_0_3*16)) + ax1_1_4))
                  ...
                  for (ax0_1_5: int32, 0, 16) {
                    for (ax1_1_5: int32, 0, 16) {
                      block([16384, 16384], "C_shared_wmma.accumulator") as [v0_6, v1_6] {
                        ...
                        bind(v1_6, ((((j_0_0*128) + (j_0_1*32)) + (ax1_0_4*16)) + ax1_1_5))
                    ...
                    for (ax0_ax1_fused_2: int32, 0, 1) "thread_binding" {
                      for (ax0_ax1_fused_3: int32, 0, 32) "thread_binding" {
                        block([16384, 16384], "C_shared") as [v0_7, v1_7] {
                          bind(v0_7, (((i_0_0*128) + (ax0_0_4*16)) + floordiv(((((ax0_ax1_fused_0*128) + (ax0_ax1_fused_1*32)) + (ax0_ax1_fused_2*32)) + ax0_ax1_fused_3), 32)))
