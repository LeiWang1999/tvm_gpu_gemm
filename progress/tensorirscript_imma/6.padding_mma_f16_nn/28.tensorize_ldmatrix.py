                    ...
                    for k_0 in T.serial(512):
                        ...
                        for i_1_1_0, j_1_1_0, k_1_0 in T.grid(8, 2, 2):
                            ...
                            with T.block("B_shared_warp_o"):
                                ...
                                T.launch_thread(tx, 32)
                                T.ptx_ldmatrix(True, 4, ".b16", warp_1.data, warp_1.elem_offset + 8 * tx, T.tvm_access_ptr(T.type_annotation(dtype="float16"), shared_1.data, shared_1.elem_offset, shared_s0_1 * 16, 1, dtype="handle"), shared_s0_1 * (tx % 16) + 8 * (tx // 16), dtype="float16")
