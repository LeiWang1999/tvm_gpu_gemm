        ...
        for j_0 in T.thread_binding(128, thread="blockIdx.x"):
            for i_1_0 in T.thread_binding(2, thread="threadIdx.z"):
                for j_1_0 in T.thread_binding(4, thread="threadIdx.y"):
                    for i_1_1_0_init, j_1_1_0_init in T.grid(8, 2):
                        with T.block("B_init_o"):
                            vi_o = T.axis.spatial(1024, i_0 * 16 + i_1_0 * 8 + i_1_1_0_init)
                            vj_o = T.axis.spatial(1024, j_0 * 8 + j_1_0 * 2 + j_1_1_0_init)
                            T.reads()
                    ...
                    for ax0_0, ax1_0 in T.grid(8, 2):
                        with T.block("C_warp_o"):
                            v0_o = T.axis.spatial(1024, i_0 * 16 + i_1_0 * 8 + ax0_0)
                            v1_o = T.axis.spatial(1024, j_0 * 8 + j_1_0 * 2 + ax1_0)
