                      ...
                      for (j: int32, 0, 16) {
                        for (k: int32, 0, 16) {
                          block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                            ...
                            C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1] = (C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1] + (A_shared_wmma.matrix_a[vii_1, vkk, vi_1, vk]*B_shared_wmma.matrix_b[vjj_1, vkk, vj_1, vk]))
                        }
                      }
                    }
                  }
