                        ...
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                              ...
                              bind(vj_1, j)
                              bind(vk, k)
                              tir.reads([C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1], A_shared_wmma.matrix_a[vii_1, vkk, vi_1, vk], B_shared_wmma.matrix_b[vjj_1, vkk, vj_1, vk]])
                              tir.writes([C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1]])
                              C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1] = (C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1] + (cast(int32, A_shared_wmma.matrix_a[vii_1, vkk, vi_1, vk])*cast(int32, B_shared_wmma.matrix_b[vjj_1, vkk, vj_1, vk])))
                          }
                        }
                      }
                    }
                  ...
                  for (ax2_2: int32, 0, 16) {
                    for (ax3: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "C_wmma.accumulator") as [v0_4, v1_4, v2_4, v3_4] {
                        ...
                        bind(v1_4, (((jj_0_0*128) + (jj_0_1*4)) + ax1_2))
                        bind(v2_4, ax2_2)
                        bind(v3_4, ax3)
