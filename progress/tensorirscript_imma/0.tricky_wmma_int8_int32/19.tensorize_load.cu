                        ...
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi, vj, vk] {
                              ...
                              bind(vj, j)
                              bind(vk, k)
                              tir.reads([C_wmma.accumulator[vii_1, vjj_1, vi, vj], A_shared_wmma.matrix_a[vii_1, vkk, vi, vk], B_shared_wmma.matrix_b[vjj_1, vkk, vj, vk]])
                              tir.writes([C_wmma.accumulator[vii_1, vjj_1, vi, vj]])
                              C_wmma.accumulator[vii_1, vjj_1, vi, vj] = (C_wmma.accumulator[vii_1, vjj_1, vi, vj] + (cast(int32, A_shared_wmma.matrix_a[vii_1, vkk, vi, vk])*cast(int32, B_shared_wmma.matrix_b[vjj_1, vkk, vj, vk])))
                          }
                        }
                      }
                    }
                  ...
                  for (ax2_1: int32, 0, 16) {
                    for (ax3: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "C_wmma.accumulator") as [v0_4, v1_4, v2_3, v3_3] {
                        ...
                        bind(v1_4, (((jj_0_0*128) + (jj_0_1*4)) + ax1_1))
                        bind(v2_3, ax2_1)
                        bind(v3_3, ax3)
