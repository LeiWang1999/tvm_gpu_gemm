...
def func(A: T.Buffer[(1024, 1024, 16, 16), "int8"], B: T.Buffer[(1024, 1024, 16, 16), "int8"], C: T.Buffer[(1024, 1024, 16, 16), "int32"]):
    ...
    for ii_0 in T.thread_binding(64, thread="blockIdx.y"):
        for jj_0_0 in T.thread_binding(8, thread="blockIdx.z"):
            for jj_0_1 in T.thread_binding(32, thread="blockIdx.x"):
                    ...
                    for jj_1 in T.thread_binding(1, thread="threadIdx.z"):
                        for ii_2_init, jj_2_init in T.grid(4, 4):
                            with T.block("B_init_o"):
                                ...
                                vjj = T.axis.spatial(1024, jj_0_0 * 128 + jj_0_1 * 4 + jj_1 * 4 + jj_2_init)
                                        ...
                                        for ax0_ax1_ax2_ax3_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                            for ax0_ax1_ax2_ax3_fused_4 in T.vectorized(16):
                                                with T.block("A_shared"):
                                                    ...
                                                    v1 = T.axis.spatial(1024, kk_0 * 4 + (ax0_ax1_ax2_ax3_fused_0 * 4096 + ax0_ax1_ax2_ax3_fused_1 * 4096 + ax0_ax1_ax2_ax3_fused_2 * 512 + ax0_ax1_ax2_ax3_fused_3 * 16 + ax0_ax1_ax2_ax3_fused_4) % 1024 // 256)
                                                    v2 = T.axis.spatial(16, (ax0_ax1_ax2_ax3_fused_0 * 4096 + ax0_ax1_ax2_ax3_fused_1 * 4096 + ax0_ax1_ax2_ax3_fused_2 * 512 + ax0_ax1_ax2_ax3_fused_3 * 16 + ax0_ax1_ax2_ax3_fused_4) % 256 // 16)
                                                    v3 = T.axis.spatial(16, (ax0_ax1_ax2_ax3_fused_0 * 4096 + ax0_ax1_ax2_ax3_fused_1 * 4096 + ax0_ax1_ax2_ax3_fused_2 * 512 + ax0_ax1_ax2_ax3_fused_3 * 16 + ax0_ax1_ax2_ax3_fused_4) % 16)
                                        ...
                                        for ax0_ax1_ax2_ax3_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                            for ax0_ax1_ax2_ax3_fused_4 in T.vectorized(16):
                                                with T.block("B_shared"):
                                                    v0 = T.axis.spatial(1024, jj_0_0 * 128 + jj_0_1 * 4 + (ax0_ax1_ax2_ax3_fused_0 * 1024 + ax0_ax1_ax2_ax3_fused_1 * 1024 + ax0_ax1_ax2_ax3_fused_2 * 512 + ax0_ax1_ax2_ax3_fused_3 * 16 + ax0_ax1_ax2_ax3_fused_4) // 1024)
                                                    v1 = T.axis.spatial(1024, kk_0 * 4 + (ax0_ax1_ax2_ax3_fused_0 * 1024 + ax0_ax1_ax2_ax3_fused_1 * 1024 + ax0_ax1_ax2_ax3_fused_2 * 512 + ax0_ax1_ax2_ax3_fused_3 * 16 + ax0_ax1_ax2_ax3_fused_4) % 1024 // 256)
                                                    v2 = T.axis.spatial(16, (ax0_ax1_ax2_ax3_fused_0 * 1024 + ax0_ax1_ax2_ax3_fused_1 * 1024 + ax0_ax1_ax2_ax3_fused_2 * 512 + ax0_ax1_ax2_ax3_fused_3 * 16 + ax0_ax1_ax2_ax3_fused_4) % 256 // 16)
                                                    v3 = T.axis.spatial(16, (ax0_ax1_ax2_ax3_fused_0 * 1024 + ax0_ax1_ax2_ax3_fused_1 * 1024 + ax0_ax1_ax2_ax3_fused_2 * 512 + ax0_ax1_ax2_ax3_fused_3 * 16 + ax0_ax1_ax2_ax3_fused_4) % 16)
                                                    T.reads(B[v0, v1, v2, v3])
                                                    T.writes(B_shared[v0, v1, v2, v3])
                                                    B_shared[v0, v1, v2, v3] = B[v0, v1, v2, v3]
                            for kk_1 in T.serial(4):
                                for ax0 in T.serial(4):
                                    with T.block("A_shared_wmma.matrix_a_o"):
                                        v0 = T.axis.spatial(1024, ii_0 * 16 + ii_1 * 4 + ax0)
                                        v1 = T.axis.spatial(1024, kk_0 * 4 + kk_1)
                                        ...
                                        A_1 = T.match_buffer(A_shared[v0, v1, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0, A_s1], scope="shared", offset_factor=16)
                                        C_2 = T.match_buffer(A_shared_wmma_matrix_a[v0, v1, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[C_s0_1, C_s1_1], scope="wmma.matrix_a", offset_factor=16)
                                ...
                                for ax0 in T.serial(4):
                                    with T.block("B_shared_wmma.matrix_b_o"):
                                        v0 = T.axis.spatial(1024, jj_0_0 * 128 + jj_0_1 * 4 + ax0)
                                        v1 = T.axis.spatial(1024, kk_0 * 4 + kk_1)
                                        v2_o = T.axis.spatial(1, 0)
                                        v3_o = T.axis.spatial(1, 0)
                                        T.reads(B_shared[v0, v1, 0 : 16, 0 : 16])
                                        T.writes(B_shared_wmma_matrix_b[v0, v1, 0 : 16, 0 : 16])
                                        A_2 = T.match_buffer(B_shared[v0, v1, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0_1, A_s1_1], scope="shared", offset_factor=16)
                                        C_3 = T.match_buffer(B_shared_wmma_matrix_b[v0, v1, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[C_s0_2, C_s1_2], scope="wmma.matrix_b", offset_factor=16)
                                ...
                                for ii_2, jj_2 in T.grid(4, 4):
                                    with T.block("B_update_o"):
                                        ...
                                        vjj = T.axis.spatial(1024, jj_0_0 * 128 + jj_0_1 * 4 + jj_1 * 4 + jj_2)
                                        vkk = T.axis.reduce(1024, kk_0 * 4 + kk_1)
                                        vi_o = T.axis.spatial(1, 0)
                                        vj_o = T.axis.spatial(1, 0)
                                        ...
                                        T.writes(C_wmma_accumulator[vii, vjj, 0 : 16, 0 : 16])
                                        A_3 = T.match_buffer(A_shared_wmma_matrix_a[vii, vkk, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0_2, A_s1_2], scope="wmma.matrix_a", offset_factor=16)
                                        B_1 = T.match_buffer(B_shared_wmma_matrix_b[vjj, vkk, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[B_s0, B_s1], scope="wmma.matrix_b", offset_factor=16)
                                        C_4 = T.match_buffer(C_wmma_accumulator[vii, vjj, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0_3, C_s1_3], scope="wmma.accumulator", offset_factor=16)
                        ...
                        for ax0, ax1 in T.grid(4, 4):
                            with T.block("C_wmma.accumulator_o"):
                                v0 = T.axis.spatial(1024, ii_0 * 16 + ii_1 * 4 + ax0)
                                v1 = T.axis.spatial(1024, jj_0_0 * 128 + jj_0_1 * 4 + ax1)
                                v2_o = T.axis.spatial(1, 0)
                                v3_o = T.axis.spatial(1, 0)
                                T.reads(C_wmma_accumulator[v0, v1, 0 : 16, 0 : 16])
                                T.writes(C[v0, v1, 0 : 16, 0 : 16])
                                A_4 = T.match_buffer(C_wmma_accumulator[v0, v1, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[A_s0_3, A_s1_3], scope="wmma.accumulator", offset_factor=16)
                                C_5 = T.match_buffer(C[v0, v1, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0_4, C_s1_4], offset_factor=16)
