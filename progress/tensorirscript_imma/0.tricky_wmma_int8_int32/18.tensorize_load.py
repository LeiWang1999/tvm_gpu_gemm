                    ...
                    for jj_1 in T.thread_binding(1, thread="threadIdx.z"):
                        ...
                        for kk_0 in T.serial(256):
                            ...
                            for kk_1 in T.serial(4):
                                ...
                                for ii_2, jj_2, i, j, k in T.grid(4, 4, 16, 16, 16):
                                    with T.block("B_update"):
                                        ...
                                        C_wmma_accumulator[vii, vjj, vi, vj] = C_wmma_accumulator[vii, vjj, vi, vj] + T.Cast("int32", A_shared_wmma_matrix_a[vii, vkk, vi, vk]) * T.Cast("int32", B_shared_wmma_matrix_b[vjj, vkk, vj, vk])
