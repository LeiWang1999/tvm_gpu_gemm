            ...
            for i_1_0 in T.thread_binding(2, thread="threadIdx.z"):
                for j_1_0 in T.thread_binding(4, thread="threadIdx.y"):
                    for i_1_1_0_init, j_1_1_0_init, i_1_1_1_init, j_1_1_1_init in T.grid(8, 2, 16, 16):
                        with T.block("B_init"):
                            vi = T.axis.spatial(16384, i_0 * 256 + i_1_0 * 128 + i_1_1_0_init * 16 + i_1_1_1_init)
                            vj = T.axis.spatial(16384, j_0 * 128 + j_1_0 * 32 + j_1_1_0_init * 16 + j_1_1_1_init)
                            T.reads()
                    ...
                    for k_0 in T.serial(512):
                        ...
                        for i_1_1_0, j_1_1_0, k_1_0 in T.grid(8, 2, 2):
                            with T.block("A_shared_warp_o"):
                                v0_o = T.axis.spatial(1024, i_0 * 16 + i_1_0 * 8 + i_1_1_0)
                                ...
                                T.ptx_ldmatrix(False, 4, ".b16", warp.data, warp.elem_offset + 8 * tx, T.tvm_access_ptr(T.type_annotation(dtype="float16"), shared.data, shared.elem_offset, shared_s0 * 16, 1, dtype="handle"), shared_s0 * (tx % 16) + 8 * (tx // 16), dtype="float16")
                            with T.block("B_shared_warp_o"):
                                v0_o = T.axis.spatial(1024, k_0 * 2 + k_1_0)
                                v1_o = T.axis.spatial(1024, j_0 * 8 + j_1_0 * 2 + j_1_1_0)
                                ...
                                T.ptx_ldmatrix(True, 4, ".b16", warp_1.data, warp_1.elem_offset + 8 * tx_1, T.tvm_access_ptr(T.type_annotation(dtype="float16"), shared_1.data, shared_1.elem_offset, shared_s0_1 * 16, 1, dtype="handle"), shared_s0_1 * (tx_1 % 16) + 8 * (tx_1 // 16), dtype="float16")
                            with T.block("B_update_o"):
                                vi_o = T.axis.spatial(1024, i_0 * 16 + i_1_0 * 8 + i_1_1_0)
                                vj_o = T.axis.spatial(1024, j_0 * 8 + j_1_0 * 2 + j_1_1_0)
                                vk_o = T.axis.reduce(1024, k_0 * 2 + k_1_0)
                                T.reads(C_warp[vi_o, vj_o, 0 : 32, 0 : 8], A_shared_warp[vi_o, vk_o, 0 : 32, 0 : 8], B_shared_warp[vk_o, vj_o, 0 : 32, 0 : 8])
                                ...
                                B_1 = T.match_buffer(B_shared_warp[vk_o, vj_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=16)
                                C_1 = T.match_buffer(C_warp[vi_o, vj_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=16)
                                T.launch_thread(tx_2, 32)
                                T.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1.data, A_1.elem_offset + tx_2 * 8, B_1.data, B_1.elem_offset + tx_2 * 8, C_1.data, C_1.elem_offset + tx_2 * 8, False, dtype="float16")
                                T.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1.data, A_1.elem_offset + tx_2 * 8, B_1.data, B_1.elem_offset + tx_2 * 8 + T.FloorDiv(8, 2), C_1.data, C_1.elem_offset + tx_2 * 8 + T.FloorDiv(8, 2), False, dtype="float16")
