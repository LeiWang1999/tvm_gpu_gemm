                        ...
                        for i_1_1_0, j_1_1_0, k_1_0 in T.grid(8, 2, 2):
                            ...
                            for i_1_1_1, j_1_1_1, k_1_1 in T.grid(16, 16, 16):
                                with T.block("B_update"):
                                    ...
                                    T.reads(C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2], A_shared_warp[vi // 16, vk // 16, vi % 8 * 4 + vk % 8 // 2, vk % 16 // 8 * 4 + vi % 16 // 8 * 2 + vk % 2], B_shared_warp[vk // 16, vj // 16, vk % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vk % 16 // 8 * 2 + vj % 2])
                                    T.writes(C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2])
                                    C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2] = C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2] + A_shared_warp[vi // 16, vk // 16, vi % 8 * 4 + vk % 8 // 2, vk % 16 // 8 * 4 + vi % 16 // 8 * 2 + vk % 2] * B_shared_warp[vk // 16, vj // 16, vk % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vk % 16 // 8 * 2 + vj % 2]
