                    ...
                    for jj_1 in T.thread_binding(4, thread="threadIdx.z"):
                        ...
                        for kk_0 in T.serial(512):
                            ...
                            for kk_1 in T.serial(2):
                                ...
                                for ii_2, jj_2 in T.grid(16, 1):
                                    with T.block("B_update_o"):
                                        vii = T.axis.spatial(1024, ii_0 * 16 + ii_1 * 16 + ii_2)
                                        vjj = T.axis.spatial(1024, jj_0_0 * 64 + jj_0_1 * 4 + jj_1 + jj_2)
                                        ...
                                        B_1 = T.match_buffer(B_shared_wmma_matrix_b[vkk, vjj, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[B_s0, B_s1], scope="wmma.matrix_b", offset_factor=16)
