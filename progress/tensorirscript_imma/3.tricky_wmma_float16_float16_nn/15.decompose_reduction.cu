                ...
                for (i_init: int32, 0, 16) {
                  for (j_init: int32, 0, 16) {
                    block([1024, 1024, 16, 16], "B_init") as [vii, vjj, vi, vj] {
                      ...
                      C_wmma.accumulator[vii, vjj, vi, vj] = 0f32
                  }
                }
              }
            }
                    ...
                    for (ax0_ax1_ax2_ax3_fused_3: int32, 0, 32) "thread_binding" {
                      for (ax0_ax1_ax2_ax3_fused_4: int32, 0, 8) "vectorized" {
                        block([1024, 1024, 16, 16], "A_shared") as [v0, v1, v2, v3] {
                          bind(v0, ((ii_0*8) + floordiv((((((ax0_ax1_ax2_ax3_fused_0*1024) + (ax0_ax1_ax2_ax3_fused_1*256)) + (ax0_ax1_ax2_ax3_fused_2*256)) + (ax0_ax1_ax2_ax3_fused_3*8)) + ax0_ax1_ax2_ax3_fused_4), 512)))
                    ...
                    for (ax0_ax1_ax2_ax3_fused_3_1: int32, 0, 32) "thread_binding" {
                      for (ax0_ax1_ax2_ax3_fused_4_1: int32, 0, 8) "vectorized" {
                        block([1024, 1024, 16, 16], "B_shared") as [v0_1, v1_1, v2_1, v3_1] {
                          bind(v0_1, ((kk_0*2) + floordiv((((((ax0_ax1_ax2_ax3_fused_0_1*2048) + (ax0_ax1_ax2_ax3_fused_1_1*512)) + (ax0_ax1_ax2_ax3_fused_2_1*256)) + (ax0_ax1_ax2_ax3_fused_3_1*8)) + ax0_ax1_ax2_ax3_fused_4_1), 4096)))
                          bind(v1_1, ((jj_0*16) + floordiv(floormod((((((ax0_ax1_ax2_ax3_fused_0_1*2048) + (ax0_ax1_ax2_ax3_fused_1_1*512)) + (ax0_ax1_ax2_ax3_fused_2_1*256)) + (ax0_ax1_ax2_ax3_fused_3_1*8)) + ax0_ax1_ax2_ax3_fused_4_1), 4096), 256)))
                          bind(v2_1, floordiv(floormod((((((ax0_ax1_ax2_ax3_fused_0_1*2048) + (ax0_ax1_ax2_ax3_fused_1_1*512)) + (ax0_ax1_ax2_ax3_fused_2_1*256)) + (ax0_ax1_ax2_ax3_fused_3_1*8)) + ax0_ax1_ax2_ax3_fused_4_1), 256), 16))
                          bind(v3_1, floormod((((((ax0_ax1_ax2_ax3_fused_0_1*2048) + (ax0_ax1_ax2_ax3_fused_1_1*512)) + (ax0_ax1_ax2_ax3_fused_2_1*256)) + (ax0_ax1_ax2_ax3_fused_3_1*8)) + ax0_ax1_ax2_ax3_fused_4_1), 16))
                      ...
                      for (j: int32, 0, 16) {
                        for (k: int32, 0, 16) {
                          block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                            ...
                            bind(vj_1, j)
                            bind(vk, k)
                            tir.reads([C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1], A_shared_wmma.matrix_a[vii_1, vkk, vi_1, vk], B_shared_wmma.matrix_b[vkk, vjj_1, vk, vj_1]])
                            tir.writes([C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1]])
                            C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1] = (C_wmma.accumulator[vii_1, vjj_1, vi_1, vj_1] + (A_shared_wmma.matrix_a[vii_1, vkk, vi_1, vk]*B_shared_wmma.matrix_b[vkk, vjj_1, vk, vj_1]))
                        }
                      }
                    }
                  }
