                    ...
                    for k_0 in T.serial(512):
                        ...
                        for i_1_1_0, j_1_1_0, k_1_0 in T.grid(4, 4, 2):
                            ...
                            with T.block("B_shared_warp_o"):
                                ...
                                T.ptx_ldmatrix(False, 4, ".b16", warp_1.data, warp_1.elem_offset + 8 * tx_1, T.tvm_access_ptr(T.type_annotation(dtype="float16"), shared_1.data, shared_1.elem_offset, shared_s0_1 * 16, 1, dtype="handle"), shared_s0_1 * 8 * (tx_1 // 16) + shared_s0_1 * (tx_1 % 8) + 8 * (tx_1 % 16 // 8), dtype="float16")
