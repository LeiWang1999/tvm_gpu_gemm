        ...
        for jj_0 in T.thread_binding(64, thread="blockIdx.x"):
            for ii_1 in T.thread_binding(1, thread="threadIdx.y"):
                for jj_1 in T.thread_binding(4, thread="threadIdx.z"):
                    for ii_2_init, jj_2_init in T.grid(8, 4):
                        with T.block("B_init_o"):
                            vii = T.axis.spatial(1024, ii_0 * 8 + ii_1 * 8 + ii_2_init)
                                    ...
                                    for ax0_ax1_ax2_ax3_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                        for ax0_ax1_ax2_ax3_fused_4 in T.vectorized(8):
                                            with T.block("A_shared"):
                                                v0 = T.axis.spatial(1024, ii_0 * 8 + (ax0_ax1_ax2_ax3_fused_0 * 4096 + ax0_ax1_ax2_ax3_fused_1 * 1024 + ax0_ax1_ax2_ax3_fused_2 * 256 + ax0_ax1_ax2_ax3_fused_3 * 8 + ax0_ax1_ax2_ax3_fused_4) // 512)
                                    ...
                                    for ax0_ax1_ax2_ax3_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                        for ax0_ax1_ax2_ax3_fused_4 in T.vectorized(8):
                                            with T.block("B_shared"):
                                                v0 = T.axis.spatial(1024, kk_0 * 2 + (ax0_ax1_ax2_ax3_fused_0 * 8192 + ax0_ax1_ax2_ax3_fused_1 * 2048 + ax0_ax1_ax2_ax3_fused_2 * 256 + ax0_ax1_ax2_ax3_fused_3 * 8 + ax0_ax1_ax2_ax3_fused_4) // 4096)
                                                v1 = T.axis.spatial(1024, jj_0 * 16 + (ax0_ax1_ax2_ax3_fused_0 * 8192 + ax0_ax1_ax2_ax3_fused_1 * 2048 + ax0_ax1_ax2_ax3_fused_2 * 256 + ax0_ax1_ax2_ax3_fused_3 * 8 + ax0_ax1_ax2_ax3_fused_4) % 4096 // 256)
                        ...
                        for kk_1 in T.serial(2):
                            for ax0 in T.serial(8):
                                with T.block("A_shared_wmma.matrix_a_o"):
                                    v0 = T.axis.spatial(1024, ii_0 * 8 + ax0)
                            ...
                            for ii_2, jj_2 in T.grid(8, 4):
                                with T.block("B_update_o"):
                                    vii = T.axis.spatial(1024, ii_0 * 8 + ii_1 * 8 + ii_2)
