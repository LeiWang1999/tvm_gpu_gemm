            ...
            for (i_1_1_0_init: int32, 0, 8) {
              for (j_1_1_0_init: int32, 0, 2) {
                block([16, 16], "B_init_o") as [vi_o, vj_o] {
                  bind(vi_o, ((i_1_0*8) + i_1_1_0_init))
                ...
                for (j_1_1_0: int32, 0, 2) {
                  for (k_1_0: int32, 0, 2) {
                    ...
                    block([16, 16], "B_shared_warp_o") as [v0_o_1, v1_o_1] {
                      ...
                      @tir.ptx_ldmatrix(False, 4, ".b16", warp_3: Pointer(warp float16), (elem_offset_3: int32 + (8*tx_2)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), shared_3: Pointer(shared float16), elem_offset_4: int32, (shared_s0_1: int32*16), 1, dtype=handle), ((((shared_s0_1*8)*floordiv(tx_2, 16)) + (shared_s0_1*floormod(tx_2, 8))) + (8*floordiv(floormod(tx_2, 16), 8))), dtype=float16)
                    block([16, 16, tir.reduce_axis(0, 16)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                      bind(vi_o_1, ((i_1_0*8) + i_1_1_0))
                      bind(vj_o_1, (((j_0*8) + (j_1_0*2)) + j_1_1_0))
                      bind(vk_o, ((k_0*2) + k_1_0))
                      tir.reads([C_warp[vi_o_1, vj_o_1, 0:32, 0:8], A_shared_warp[vi_o_1, vk_o, 0:32, 0:8], B_shared_warp[vj_o_1, vk_o, 0:32, 0:8]])
                      tir.writes([C_warp[vi_o_1, vj_o_1, 0:32, 0:8]])
                      A_2 = match_buffer(A_shared_warp[vi_o_1, vk_o, 0:32, 0:8])
                      B_2 = match_buffer(B_shared_warp[vj_o_1, vk_o, 0:32, 0:8])
