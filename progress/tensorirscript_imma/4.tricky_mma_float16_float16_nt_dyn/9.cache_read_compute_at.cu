                  ...
                  for (ax2: int32, 0, 16) {
                    for (ax3: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "A_shared.dyn") as [v0, v1, v2, v3] {
                        ...
                        A_shared.dyn[v0, v1, v2, v3] = A[v0, v1, v2, v3]
                    }
                  }
                }
              }
                  ...
                  for (ax2_1: int32, 0, 16) {
                    for (ax3_1: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "B_shared.dyn") as [v0_1, v1_1, v2_1, v3_1] {
                        bind(v0_1, ((jj_0*16) + ax0_1))
                        bind(v1_1, ((kk_0*2) + ax1_1))
                        bind(v2_1, ax2_1)
                        bind(v3_1, ax3_1)
                        tir.reads([B[v0_1, v1_1, v2_1, v3_1]])
                        tir.writes([B_shared.dyn[v0_1, v1_1, v2_1, v3_1]])
                        B_shared.dyn[v0_1, v1_1, v2_1, v3_1] = B[v0_1, v1_1, v2_1, v3_1]
                    }
                  }
                }
              }
                  ...
                  for (ax1_3: int32, 0, 16) {
                    for (ax2_3: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "B_shared.dyn_warp") as [v0_3, v1_3, v2_3, v3_3] {
                        bind(v0_3, (((jj_0*16) + (jj_1*8)) + ax0_3))
                ...
                for (ax2_4: int32, 0, 16) {
                  for (ax3_2: int32, 0, 16) {
                    block([1024, 1024, 16, 16], "C_warp") as [v0_4, v1_4, v2_4, v3_4] {
                      bind(v0_4, (((ii_0*8) + (ii_1*2)) + ax0_4))
                      bind(v1_4, (((jj_0*16) + (jj_1*8)) + ax1_4))
                      bind(v2_4, ax2_4)
                      bind(v3_4, ax3_2)
