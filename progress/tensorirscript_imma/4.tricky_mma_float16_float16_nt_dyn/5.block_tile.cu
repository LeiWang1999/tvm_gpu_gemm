...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    A_shared.dyn_warp = alloc_buffer(float16[1024, 1024, 16, 16])
    B_shared.dyn = alloc_buffer(float16[1024, 1024, 16, 16])
    B_shared.dyn_warp = alloc_buffer(float16[1024, 1024, 16, 16])
    C_warp = alloc_buffer(float16[1024, 1024, 16, 16])
     {
      for (ax0: int32, 0, 1024) {
        for (ax1: int32, 0, 1024) {
          for (ax2: int32, 0, 16) {
            for (ax3: int32, 0, 16) {
              block([1024, 1024, 16, 16], "B_shared.dyn") as [v0, v1, v2, v3] {
                bind(v0, ax0)
                bind(v1, ax1)
                bind(v2, ax2)
                bind(v3, ax3)
                tir.reads([B[v0, v1, v2, v3]])
                tir.writes([B_shared.dyn[v0, v1, v2, v3]])
                B_shared.dyn[v0, v1, v2, v3] = B[v0, v1, v2, v3]
            }
          }
        }
      }
        ...
        for (ax1_1: int32, 0, 1024) {
          for (ax2_1: int32, 0, 16) {
            for (ax3_1: int32, 0, 16) {
              block([1024, 1024, 16, 16], "A_shared.dyn") as [v0_1, v1_1, v2_1, v3_1] {
                bind(v0_1, ax0_1)
                bind(v1_1, ax1_1)
                bind(v2_1, ax2_1)
                bind(v3_1, ax3_1)
                tir.reads([A[v0_1, v1_1, v2_1, v3_1]])
                tir.writes([A_shared.dyn[v0_1, v1_1, v2_1, v3_1]])
                A_shared.dyn[v0_1, v1_1, v2_1, v3_1] = A[v0_1, v1_1, v2_1, v3_1]
            }
          }
        }
      }
        ...
        for (ax1_2: int32, 0, 1024) {
          for (ax2_2: int32, 0, 16) {
            for (ax3_2: int32, 0, 16) {
              block([1024, 1024, 16, 16], "A_shared.dyn_warp") as [v0_2, v1_2, v2_2, v3_2] {
                bind(v0_2, ax0_2)
                bind(v1_2, ax1_2)
                bind(v2_2, ax2_2)
                bind(v3_2, ax3_2)
                tir.reads([A_shared.dyn[v0_2, v1_2, v2_2, v3_2]])
                tir.writes([A_shared.dyn_warp[v0_2, v1_2, v2_2, v3_2]])
                A_shared.dyn_warp[v0_2, v1_2, v2_2, v3_2] = A_shared.dyn[v0_2, v1_2, v2_2, v3_2]
            }
          }
        }
      }
        ...
        for (ax1_3: int32, 0, 1024) {
          for (ax2_3: int32, 0, 16) {
            for (ax3_3: int32, 0, 16) {
              block([1024, 1024, 16, 16], "B_shared.dyn_warp") as [v0_3, v1_3, v2_3, v3_3] {
                bind(v0_3, ax0_3)
                bind(v1_3, ax1_3)
                bind(v2_3, ax2_3)
                bind(v3_3, ax3_3)
                tir.reads([B_shared.dyn[v0_3, v1_3, v2_3, v3_3]])
                tir.writes([B_shared.dyn_warp[v0_3, v1_3, v2_3, v3_3]])
                B_shared.dyn_warp[v0_3, v1_3, v2_3, v3_3] = B_shared.dyn[v0_3, v1_3, v2_3, v3_3]
            }
          }
        }
      }
      for (ii_0: int32, 0, 128) {
        for (jj_0: int32, 0, 64) {
          for (ii_1: int32, 0, 4) {
            for (jj_1: int32, 0, 2) {
                        ...
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B") as [vii, vjj, vkk, vi, vj, vk] {
                              ...
                              bind(vj, j)
                              bind(vk, k)
                              tir.reads([A_shared.dyn_warp[vii, vkk, vi, vk], B_shared.dyn_warp[vjj, vkk, vj, vk]])
                              tir.writes([C_warp[vii, vjj, vi, vj]])
                              with init() {
                                C_warp[vii, vjj, vi, vj] = 0f32
                              }
                              C_warp[vii, vjj, vi, vj] = (C_warp[vii, vjj, vi, vj] + (A_shared.dyn_warp[vii, vkk, vi, vk]*B_shared.dyn_warp[vjj, vkk, vj, vk]))
                          }
                        }
                      }
                    }
