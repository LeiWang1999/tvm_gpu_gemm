                  ...
                  for (ax1: int32, 0, 16) {
                    for (ax2: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "A_shared.dyn_warp") as [v0_2, v1_2, v2_2, v3_2] {
                        ...
                        tir.writes([A_shared.dyn_warp[v0_2, v1_2, ((v2_2*2) + floordiv(v3_2, 8)), floormod(v3_2, 8)]])
                        A_shared.dyn_warp[v0_2, v1_2, ((v2_2*2) + floordiv(v3_2, 8)), floormod(v3_2, 8)] = A_shared.dyn[v0_2, v1_2, v2_2, v3_2]
                    }
                  }
                }
                for (ax0_1: int32, 0, 8) {
                  for (ax1_1: int32, 0, 16) {
                    for (ax2_1: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "B_shared.dyn_warp") as [v0_3, v1_3, v2_3, v3_3] {
                        ...
                        tir.writes([B_shared.dyn_warp[v0_3, v1_3, ((v2_3*2) + floordiv(v3_3, 8)), floormod(v3_3, 8)]])
                        B_shared.dyn_warp[v0_3, v1_3, ((v2_3*2) + floordiv(v3_3, 8)), floormod(v3_3, 8)] = B_shared.dyn[v0_3, v1_3, v2_3, v3_3]
                    }
                  }
                }
                for (ii_2: int32, 0, 2) {
                      ...
                      for (j: int32, 0, 16) {
                        for (k: int32, 0, 16) {
                          block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                            ...
                            bind(vj_1, j)
                            bind(vk, k)
                            tir.reads([C_warp[vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))], A_shared.dyn_warp[vii_1, vkk, ((vi_1*2) + floordiv(vk, 8)), floormod(vk, 8)], B_shared.dyn_warp[vjj_1, vkk, ((vj_1*2) + floordiv(vk, 8)), floormod(vk, 8)]])
                ...
                for (ax2_2: int32, 0, 16) {
                  for (ax3: int32, 0, 16) {
                    block([1024, 1024, 16, 16], "C_warp") as [v0_4, v1_4, v2_4, v3_4] {
                      ...
                      bind(v1_4, (((jj_0*16) + (jj_1*8)) + ax1_2))
                      bind(v2_4, ax2_2)
                      bind(v3_4, ax3)
