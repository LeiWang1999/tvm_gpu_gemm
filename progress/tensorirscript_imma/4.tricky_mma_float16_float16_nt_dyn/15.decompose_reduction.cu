                      ...
                      for (j: int32, 0, 16) {
                        for (k: int32, 0, 16) {
                          block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                            ...
                            bind(vj_1, j)
                            bind(vk, k)
                            tir.reads([C_warp[vii_1, vjj_1, vi_1, vj_1], A_shared.dyn_warp[vii_1, vkk, vi_1, vk], B_shared.dyn_warp[vjj_1, vkk, vj_1, vk]])
                            tir.writes([C_warp[vii_1, vjj_1, vi_1, vj_1]])
                            C_warp[vii_1, vjj_1, vi_1, vj_1] = (C_warp[vii_1, vjj_1, vi_1, vj_1] + (A_shared.dyn_warp[vii_1, vkk, vi_1, vk]*B_shared.dyn_warp[vjj_1, vkk, vj_1, vk]))
                        }
                      }
                    }
                  }
