...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    for (ii_0: int32, 0, 4) "thread_binding" {
            ...
            for (kk_0: int32, 0, 4) {
              for (ax0: int32, 0, 4) {
                for (ax1: int32, 0, 2) {
                  for (ax2: int32, 0, 16) {
                    for (ax3: int32, 0, 32) {
                      block([16, 8, 16, 32], "A_shared") as [v0, v1, v2, v3] {
                        bind(v0, ((ii_0*4) + ax0))
                        bind(v1, ((kk_0*2) + ax1))
                        bind(v2, ax2)
                        bind(v3, ax3)
                ...
                for (ax1_1: int32, 0, 16) {
                  for (ax2_1: int32, 0, 32) {
                    for (ax3_1: int32, 0, 16) {
                      block([8, 16, 32, 16], "B_shared") as [v0_1, v1_1, v2_1, v3_1] {
                ...
                for (ax2_4: int32, 0, 16) {
                  for (ax3_2: int32, 0, 16) {
                    block([16, 16, 16, 16], "C_warp") as [v0_4, v1_4, v2_4, v3_4] {
                      bind(v0_4, (((ii_0*4) + (ii_1*2)) + ax0_4))
                      bind(v1_4, ((jj_1*8) + ax1_4))
                      bind(v2_4, ax2_4)
                      bind(v3_4, ax3_2)
