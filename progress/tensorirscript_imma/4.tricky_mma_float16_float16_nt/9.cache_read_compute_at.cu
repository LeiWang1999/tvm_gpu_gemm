                    ...
                    for (ax2_1: int32, 0, 16) {
                      for (ax3_1: int32, 0, 16) {
                        block([1024, 1024, 16, 16], "B_shared") as [v0_1, v1_1, v2_1, v3_1] {
                          bind(v0_1, (((jj_0_0*256) + (jj_0_1*16)) + ax0_1))
                    ...
                    for (ax1_3: int32, 0, 16) {
                      for (ax2_3: int32, 0, 16) {
                        block([1024, 1024, 16, 16], "B_shared_warp") as [v0_3, v1_3, v2_3, v3_3] {
                          bind(v0_3, ((((jj_0_0*256) + (jj_0_1*16)) + (jj_1*8)) + ax0_3))
                        ...
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B") as [vii, vjj, vkk, vi, vj, vk] {
                              bind(vii, (((ii_0*8) + (ii_1*4)) + ii_2))
                              bind(vjj, ((((jj_0_0*256) + (jj_0_1*16)) + (jj_1*8)) + jj_2))
                  ...
                  for (ax2_4: int32, 0, 16) {
                    for (ax3_2: int32, 0, 16) {
                      block([1024, 1024, 16, 16], "C_warp") as [v0_4, v1_4, v2_4, v3_4] {
                        bind(v0_4, (((ii_0*8) + (ii_1*4)) + ax0_4))
                        bind(v1_4, ((((jj_0_0*256) + (jj_0_1*16)) + (jj_1*8)) + ax1_4))
                        bind(v2_4, ax2_4)
                        bind(v3_4, ax3_2)
