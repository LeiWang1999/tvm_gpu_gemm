          ...
          for (ii_1: int32, 0, 2) "thread_binding" {
            for (jj_1: int32, 0, 2) "thread_binding" {
              ...
              for (kk_0: int32, 0, 512) {
                ...
                for (kk_1: int32, 0, 2) {
                  for (ax0: int32, 0, 4) {
                    block([1024, 1024, 1, 1], "A_shared_warp_o") as [v0_2, v1_2, v2_o, v3_o] {
                  ...
                  for (ax0_1: int32, 0, 8) {
                    block([1024, 1024, 1, 1], "B_shared_warp_o") as [v0_3, v1_3, v2_o_1, v3_o_1] {
              ...
              for (ax0_2: int32, 0, 4) {
                for (ax1: int32, 0, 8) {
                  block([1024, 1024, 1, 1], "C_warp_o") as [v0_4, v1_4, v2_o_2, v3_o_2] {
                    ...
                    bind(v1_4, ((((jj_0_0*256) + (jj_0_1*16)) + (jj_1*8)) + ax1))
                    bind(v2_o_2, 0)
                    bind(v3_o_2, 0)
