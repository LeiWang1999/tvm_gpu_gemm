                  ...
                  for (i_init: int32, 0, 16) {
                    for (j_init: int32, 0, 16) {
                      block([1, 196, 4, 16, 16], "B_init") as [vsk, vii, vjj, vi, vj] {
                        ...
                        bind(vj, j_init)
                        tir.reads([])
                        tir.writes([C_warp[vsk, vii, vjj, ((floormod(vi, 8)*4) + floordiv(floormod(vj, 8), 2)), (((floordiv(vj, 8)*4) + (floordiv(vi, 8)*2)) + floormod(vj, 2))]])
                        C_warp[vsk, vii, vjj, ((floormod(vi, 8)*4) + floordiv(floormod(vj, 8), 2)), (((floordiv(vj, 8)*4) + (floordiv(vi, 8)*2)) + floormod(vj, 2))] = 0f32
                    }
                  }
                }
              }
                        ...
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([1, 196, 4, tir.reduce_axis(0, 36), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vsk_1, vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                              ...
                              bind(vj_1, j)
                              bind(vk, k)
                              tir.reads([C_warp[vsk_1, vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))], A_shared_warp[vii_1, vkk, ((vi_1*2) + floordiv(vk, 8)), floormod(vk, 8)], B_shared_warp[vkk, vjj_1, ((vk*2) + floordiv(vj_1, 8)), floormod(vj_1, 8)]])
                              tir.writes([C_warp[vsk_1, vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))]])
                              C_warp[vsk_1, vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))] = (C_warp[vsk_1, vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))] + (A_shared_warp[vii_1, vkk, ((vi_1*2) + floordiv(vk, 8)), floormod(vk, 8)]*B_shared_warp[vkk, vjj_1, ((vk*2) + floordiv(vj_1, 8)), floormod(vj_1, 8)]))
                          }
                        }
                      }
                    }
