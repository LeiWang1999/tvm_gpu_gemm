                ...
                for (y_0_2_init: int32, 0, 2) {
                  for (x_1_init: int32, 0, 16) {
                    for (y_1_init: int32, 0, 16) {
                      block([1, 3136, 64], "Conv_init") as [v_n, v_x, v_y] {
                        bind(v_n, n)
                        bind(v_x, ((((x_0_0*16) + (x_0_1*16)) + (x_0_2_init*16)) + x_1_init))
                        bind(v_y, ((((y_0_0*32) + (y_0_1*32)) + (y_0_2_init*16)) + y_1_init))
                        tir.reads([])
                      ...
                      for (ax0_1: int32, 0, 16) {
                        for (ax1_1: int32, 0, 16) {
                          block([1, 3136, 576], "data_im2colPad_shared_wmma.matrix_a") as [v0_2, v1_2, v2_1] {
                            bind(v0_2, 0)
                            bind(v1_2, (((x_0_0*16) + (ax0_0*16)) + ax0_1))
                            bind(v2_1, (((k_0_0*16) + (ax1_0*16)) + ax1_1))
                      ...
                      for (ax0_1_1: int32, 0, 16) {
                        for (ax1_1_1: int32, 0, 16) {
                          block([576, 64], "weight_flattenPad_shared_wmma.matrix_b") as [v0_3, v1_3] {
                            bind(v0_3, (((k_0_0*16) + (ax0_0_1*16)) + ax0_1_1))
                            bind(v1_3, (((y_0_0*32) + (ax1_0_1*16)) + ax1_1_1))
                  ...
                  for (x_0_2: int32, 0, 1) {
                    for (y_0_2: int32, 0, 2) {
                      for (x_1: int32, 0, 16) {
                        for (y_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([1, 3136, 64, tir.reduce_axis(0, 576)], "Conv_update") as [v_n_1, v_x_1, v_y_1, v_k] {
                              bind(v_n_1, n)
                              bind(v_x_1, ((((x_0_0*16) + (x_0_1*16)) + (x_0_2*16)) + x_1))
                              bind(v_y_1, ((((y_0_0*32) + (y_0_1*32)) + (y_0_2*16)) + y_1))
                              bind(v_k, (((k_0_0*16) + (k_0_1*16)) + k_1))
                              tir.reads([CPad_shared_wmma.accumulator[v_n_1, floordiv(v_x_1, 16), floordiv(v_y_1, 16), floormod(v_x_1, 16), floormod(v_y_1, 16)], data_im2colPad_shared_wmma.matrix_a[v_n_1, floordiv(v_x_1, 16), floordiv(v_k, 16), floormod(v_x_1, 16), floormod(v_k, 16)], weight_flattenPad_shared_wmma.matrix_b[floordiv(v_k, 16), floordiv(v_y_1, 16), floormod(v_k, 16), floormod(v_y_1, 16)]])
                  ...
                  for (ax0_1_2: int32, 0, 16) {
                    for (ax1_1_2: int32, 0, 16) {
                      block([1, 3136, 64], "CPad_shared_wmma.accumulator") as [v0_4, v1_4, v2_2] {
                        bind(v0_4, 0)
                        bind(v1_4, (((x_0_0*16) + (ax0_0_2*16)) + ax0_1_2))
                        bind(v2_2, (((y_0_0*32) + (ax1_0_2*16)) + ax1_1_2))
