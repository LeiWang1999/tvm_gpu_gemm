                    ...
                    for (ax1_0_1: int32, 0, 2) {
                      for (ax0_1: int32, 0, 16) {
                        for (ax1_1: int32, 0, 16) {
                          block([576, 64], "weight_flattenPad_shared_wmma.matrix_b") as [v0_3, v1_2] {
                            bind(v0_3, (((k_0_0*16) + (ax0_0_1*16)) + ax0_1))
                            bind(v1_2, (((y_0_0*32) + (ax1_0_1*16)) + ax1_1))
                  ...
                  for (x_0_2: int32, 0, 1) {
                    for (y_0_2: int32, 0, 2) {
                      for (x_1: int32, 0, 16) {
                        for (y_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([1, 3136, 64, tir.reduce_axis(0, 576)], "Conv_update") as [v_n_1, v_x, v_y, v_k] {
                              bind(v_n_1, n)
                ...
                for (ax1_0_2: int32, 0, 2) {
                  for (ax0_1_1: int32, 0, 16) {
                    for (ax1_1_1: int32, 0, 16) {
                      block([1, 3136, 64], "CPad_shared_wmma.accumulator") as [v0_4, v1_3, v2_1] {
                        bind(v0_4, 0)
                        bind(v1_3, (((x_0_0*16) + (ax0_0_2*16)) + ax0_1_1))
                        bind(v2_1, (((y_0_0*32) + (ax1_0_2*16)) + ax1_1_1))
                  ...
                  for (ax0_ax1_fused_1: int32, 0, 1) "thread_binding" {
                    for (ax0_ax1_fused_2: int32, 0, 1) "thread_binding" {
                      for (ax0_ax1_fused_3: int32, 0, 32) "thread_binding" {
                        block([1, 3136, 64], "CPad_shared") as [v0_5, v1_4, v2_2] {
                          bind(v0_5, 0)
                          bind(v1_4, ((x_0_0*16) + floordiv(((((ax0_ax1_fused_0*32) + (ax0_ax1_fused_1*32)) + (ax0_ax1_fused_2*32)) + ax0_ax1_fused_3), 32)))
                          bind(v2_2, ((y_0_0*32) + floormod(((((ax0_ax1_fused_0*32) + (ax0_ax1_fused_1*32)) + (ax0_ax1_fused_2*32)) + ax0_ax1_fused_3), 32)))
