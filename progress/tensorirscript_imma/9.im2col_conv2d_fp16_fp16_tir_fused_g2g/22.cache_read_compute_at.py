                    ...
                    for y_0_1 in T.thread_binding(1, thread="threadIdx.z"):
                        for k_0_0 in T.serial(36):
                            for ax0, ax1 in T.grid(16, 16):
                                with T.block("data_im2colPad_shared"):
                                    ...
                                    v1 = T.axis.spatial(3136, x_0_0 * 16 + ax0)
                                    v2 = T.axis.spatial(576, k_0_0 * 16 + ax1)
                            ...
                            for ax0, ax1 in T.grid(16, 32):
                                with T.block("weight_flattenPad_shared"):
                                    v0 = T.axis.spatial(576, k_0_0 * 16 + ax0)
                                    v1 = T.axis.spatial(64, y_0_0 * 32 + ax1)
                        ...
                        for ax0, ax1 in T.grid(16, 32):
                            with T.block("CPad_shared_wmma.accumulator"):
                                v0 = T.axis.spatial(1, 0)
                                v1 = T.axis.spatial(3136, x_0_0 * 16 + ax0)
                                v2 = T.axis.spatial(64, y_0_0 * 32 + ax1)
