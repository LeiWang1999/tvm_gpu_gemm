...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    A_shared_warp = alloc_buffer(int8[256, 256])
    B_shared_warp = alloc_buffer(int8[256, 256])
    C_warp = alloc_buffer(int32[256, 256])
                      ...
                      for (j_1_1_1: int32, 0, 16) {
                        for (k_1_1: int32, 0, 32) {
                          block([256, 256, tir.reduce_axis(0, 256)], "B_update") as [vi_1, vj_1, vk] {
                            ...
                            tir.reads([C_warp[vi_1, vj_1], A_shared_warp[vi_1, vk], B_shared_warp[vk, vj_1]])
                            tir.writes([C_warp[vi_1, vj_1]])
                            C_warp[vi_1, vj_1] = (C_warp[vi_1, vj_1] + (cast(int32, A_shared_warp[vi_1, vk])*cast(int32, B_shared_warp[vk, vj_1])))
                        }
                      }
                    }
                  }
