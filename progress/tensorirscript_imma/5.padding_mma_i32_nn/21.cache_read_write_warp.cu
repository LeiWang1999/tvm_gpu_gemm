                      ...
                      for (j_1_1_1: int32, 0, 16) {
                        for (k_1_1: int32, 0, 32) {
                          block([256, 256, tir.reduce_axis(0, 256)], "B") as [vi, vj, vk] {
                            ...
                            tir.reads([A_shared_warp[vi, vk], B_shared_warp[vk, vj]])
                            tir.writes([C_warp[vi, vj]])
                            with init() {
                              C_warp[vi, vj] = 0
                            }
                            C_warp[vi, vj] = (C_warp[vi, vj] + (cast(int32, A_shared_warp[vi, vk])*cast(int32, B_shared_warp[vk, vj])))
                        }
                      }
                    }
                  }
