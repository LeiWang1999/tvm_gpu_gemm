                ...
                for (ax0_1: int32, 0, 16) {
                  for (ax1_1: int32, 0, 16) {
                    block([256, 256], "C_warp") as [v0_2, v1_2] {
                      ...
                      bind(v1_2, (((j_1_0*64) + (ax1_0*16)) + ax1_1))
