...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    A_shared_warp = alloc_buffer(int8[16, 8, 32, 16])
    B_shared_warp = alloc_buffer(int8[8, 16, 32, 16])
    C_warp = alloc_buffer(int32[16, 16, 32, 8])
          ...
          for (j_1_0: int32, 0, 4) "thread_binding" {
            for (i_1_1_0_init: int32, 0, 4) {
              for (j_1_1_0_init: int32, 0, 4) {
                block([16, 16], "B_init_o") as [vi_o, vj_o] {
                  bind(vi_o, (((i_0*8) + (i_1_0*4)) + i_1_1_0_init))
                  bind(vj_o, ((j_1_0*4) + j_1_1_0_init))
                  tir.reads([])
            ...
            for (k_0: int32, 0, 4) {
              ...
              for (i_1_1_0: int32, 0, 4) {
                for (j_1_1_0: int32, 0, 4) {
                  for (k_1_0: int32, 0, 2) {
                    block([16, 8], "A_shared_warp_o") as [v0_o, v1_o] {
                    ...
                    block([8, 16], "B_shared_warp_o") as [v0_o_1, v1_o_1] {
                      bind(v0_o_1, ((k_0*2) + k_1_0))
                      bind(v1_o_1, ((j_1_0*4) + j_1_1_0))
                      ...
                      @tir.ptx_ldmatrix(True, 4, ".b16", warp_3: Pointer(warp int8), (elem_offset_3: int32 + (16*tx_2)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=int8), shared_3: Pointer(shared int8), elem_offset_4: int32, (shared_s0_1: int32*32), 1, dtype=handle), shared_s0_1, dtype=int8)
                    block([16, 16, tir.reduce_axis(0, 8)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                      bind(vi_o_1, (((i_0*8) + (i_1_0*4)) + i_1_1_0))
                      bind(vj_o_1, ((j_1_0*4) + j_1_1_0))
                      bind(vk_o, ((k_0*2) + k_1_0))
                      tir.reads([C_warp[vi_o_1, vj_o_1, 0:32, 0:8], A_shared_warp[vi_o_1, vk_o, 0:32, 0:16], B_shared_warp[vk_o, vj_o_1, 0:32, 0:16]])
                      tir.writes([C_warp[vi_o_1, vj_o_1, 0:32, 0:8]])
                      A_2 = match_buffer(A_shared_warp[vi_o_1, vk_o, 0:32, 0:16])
                      B_2 = match_buffer(B_shared_warp[vk_o, vj_o_1, 0:32, 0:16])
            ...
            for (ax0_0: int32, 0, 4) {
              for (ax1_0: int32, 0, 4) {
                block([16, 16], "C_warp_o") as [v0_o_2, v1_o_2] {
                  bind(v0_o_2, (((i_0*8) + (i_1_0*4)) + ax0_0))
                  bind(v1_o_2, ((j_1_0*4) + ax1_0))
