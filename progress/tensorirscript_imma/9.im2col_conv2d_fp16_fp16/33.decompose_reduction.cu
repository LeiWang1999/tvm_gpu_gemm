                ...
                for (y_0_2_init: int32, 0, 2) {
                  for (x_1_init: int32, 0, 16) {
                    for (y_1_init: int32, 0, 16) {
                      block([1, 3200, 128], "Conv_init") as [v_n, v_x, v_y] {
                        bind(v_n, n)
                        bind(v_x, ((((x_0_0*128) + (x_0_1*128)) + (x_0_2_init*16)) + x_1_init))
                        bind(v_y, ((((y_0_0*128) + (y_0_1*32)) + (y_0_2_init*16)) + y_1_init))
                        tir.reads([])
                  ...
                  for (x_0_2: int32, 0, 8) {
                    for (y_0_2: int32, 0, 2) {
                      for (x_1: int32, 0, 16) {
                        for (y_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([1, 3200, 128, tir.reduce_axis(0, 640)], "Conv_update") as [v_n_1, v_x_1, v_y_1, v_k] {
                              bind(v_n_1, n)
                              bind(v_x_1, ((((x_0_0*128) + (x_0_1*128)) + (x_0_2*16)) + x_1))
                              bind(v_y_1, ((((y_0_0*128) + (y_0_1*32)) + (y_0_2*16)) + y_1))
