                        ...
                        for y_0_1 in T.thread_binding(1, thread="threadIdx.z"):
                            for k_0_0 in T.serial(196):
                                for ax0, ax1 in T.grid(16, 64):
                                    with T.block("data_im2col_global_shared"):
                                        ...
                                        v1 = T.axis.spatial(48400, x_0_0 * 16 + ax0)
                                        v2 = T.axis.spatial(12544, k_0_0 * 64 + ax1)
                                ...
                                for ax0, ax1 in T.grid(64, 16):
                                    with T.block("weight_flatten_global_shared"):
                                        v0 = T.axis.spatial(12544, k_0_0 * 64 + ax0)
                                        v1 = T.axis.spatial(512, y_0_0_0 * 256 + y_0_0_1 * 16 + ax1)
                                ...
                                for k_0_1 in T.serial(4):
                                    for ax0, ax1 in T.grid(16, 16):
                                        with T.block("data_im2col_global_shared_wmma.matrix_a"):
                                            v0 = T.axis.spatial(1, 0)
                                            v1 = T.axis.spatial(48400, x_0_0 * 16 + ax0)
                                            v2 = T.axis.spatial(12544, k_0_0 * 64 + k_0_1 * 16 + ax1)
                                    ...
                                    for ax0, ax1 in T.grid(16, 16):
                                        with T.block("weight_flatten_global_shared_wmma.matrix_b"):
                                            v0 = T.axis.spatial(12544, k_0_0 * 64 + k_0_1 * 16 + ax0)
                                            v1 = T.axis.spatial(512, y_0_0_0 * 256 + y_0_0_1 * 16 + ax1)
                            ...
                            for ax0, ax1 in T.grid(16, 16):
                                with T.block("Conv_wmma.accumulator"):
                                    v0 = T.axis.spatial(1, 0)
                                    v1 = T.axis.spatial(48400, x_0_0 * 16 + ax0)
                                    v2 = T.axis.spatial(512, y_0_0_0 * 256 + y_0_0_1 * 16 + ax1)
