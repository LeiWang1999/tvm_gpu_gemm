            ...
            for (ax1_ax2_fused_2: int32, 0, 1) "thread_binding" {
              for (ax1_ax2_fused_3: int32, 0, 128) "thread_binding" {
                for (ax1_ax2_fused_4: int32, 0, 8) "thread_binding" {
                  for (ax1_ax2_fused_5: int32, 0, 10) {
                    for (ax1_ax2_fused_6: int32, 0, 8) "vectorized" {
                      block([1, 48400, 12544], "data_im2col_global") as [v0, v1, v2] {
                        where(((((((((((((ax1_ax2_fused_0*2048) + ax1_ax2_fused_1) + ax1_ax2_fused_2)*128) + ax1_ax2_fused_3)*8) + ax1_ax2_fused_4)*10) + ax1_ax2_fused_5)*8) + ax1_ax2_fused_6) < 607129600))
                        bind(v0, ax0)
                        bind(v1, floordiv((((((((ax1_ax2_fused_0*167772160) + (ax1_ax2_fused_1*81920)) + (ax1_ax2_fused_2*81920)) + (ax1_ax2_fused_3*640)) + (ax1_ax2_fused_4*80)) + (ax1_ax2_fused_5*8)) + ax1_ax2_fused_6), 12544))
                        bind(v2, floormod((((((((ax1_ax2_fused_0*167772160) + (ax1_ax2_fused_1*81920)) + (ax1_ax2_fused_2*81920)) + (ax1_ax2_fused_3*640)) + (ax1_ax2_fused_4*80)) + (ax1_ax2_fused_5*8)) + ax1_ax2_fused_6), 12544))
                ...
                for (ax0_ax1_fused_5: int32, 0, 1) {
                  for (ax0_ax1_fused_6: int32, 0, 8) "vectorized" {
                    block([12544, 512], "weight_flatten_global") as [v0_1, v1_1] {
                      where((((((((((((ax0_ax1_fused_0*2048) + ax0_ax1_fused_1) + ax0_ax1_fused_2)*128) + ax0_ax1_fused_3)*8) + ax0_ax1_fused_4) + ax0_ax1_fused_5)*8) + ax0_ax1_fused_6) < 6422528))
                      bind(v0_1, floordiv((((((((ax0_ax1_fused_0*16777216) + (ax0_ax1_fused_1*8192)) + (ax0_ax1_fused_2*8192)) + (ax0_ax1_fused_3*64)) + (ax0_ax1_fused_4*8)) + (ax0_ax1_fused_5*8)) + ax0_ax1_fused_6), 512))
                      bind(v1_1, floormod((((((((ax0_ax1_fused_0*16777216) + (ax0_ax1_fused_1*8192)) + (ax0_ax1_fused_2*8192)) + (ax0_ax1_fused_3*64)) + (ax0_ax1_fused_4*8)) + (ax0_ax1_fused_5*8)) + ax0_ax1_fused_6), 512))
