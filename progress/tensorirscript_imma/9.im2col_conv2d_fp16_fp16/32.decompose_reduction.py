            ...
            for y_0_0 in T.thread_binding(1, thread="blockIdx.x"):
                for x_0_1 in T.thread_binding(1, thread="threadIdx.y"):
                    for y_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                        for x_0_2_init, y_0_2_init, x_1_init, y_1_init in T.grid(8, 2, 16, 16):
                            with T.block("Conv_init"):
                                v_n = T.axis.spatial(1, n)
                                v_x = T.axis.spatial(3200, x_0_0 * 128 + x_0_1 * 128 + x_0_2_init * 16 + x_1_init)
                                v_y = T.axis.spatial(128, y_0_0 * 128 + y_0_1 * 32 + y_0_2_init * 16 + y_1_init)
                                T.reads()
