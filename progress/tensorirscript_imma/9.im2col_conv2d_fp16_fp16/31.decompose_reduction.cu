                    ...
                    for (y_0_2_init: int32, 0, 1) {
                      for (x_1_init: int32, 0, 16) {
                        for (y_1_init: int32, 0, 16) {
                          block([1, 48400, 512], "Conv_init") as [v_n, v_x, v_y] {
                            bind(v_n, n)
                            bind(v_x, ((((x_0_0*16) + (x_0_1*16)) + (x_0_2_init*16)) + x_1_init))
                            bind(v_y, (((((y_0_0_0*256) + (y_0_0_1*16)) + (y_0_1*16)) + (y_0_2_init*16)) + y_1_init))
                            tir.reads([])
                          ...
                          for (ax0_1_1: int32, 0, 16) {
                            for (ax1_1_1: int32, 0, 16) {
                              block([1, 48400, 12544], "data_im2col_global_shared_wmma.matrix_a") as [v0_4, v1_4, v2_2] {
                                bind(v0_4, 0)
                                bind(v1_4, (((x_0_0*16) + (ax0_0*16)) + ax0_1_1))
                                bind(v2_2, ((((k_0_0*64) + (k_0_1*16)) + (ax1_0*16)) + ax1_1_1))
                          ...
                          for (ax0_1_2: int32, 0, 16) {
                            for (ax1_1_2: int32, 0, 16) {
                              block([12544, 512], "weight_flatten_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                                bind(v0_5, ((((k_0_0*64) + (k_0_1*16)) + (ax0_0_1*16)) + ax0_1_2))
                                bind(v1_5, ((((y_0_0_0*256) + (y_0_0_1*16)) + (ax1_0_1*16)) + ax1_1_2))
                      ...
                      for (x_0_2: int32, 0, 1) {
                        for (y_0_2: int32, 0, 1) {
                          for (x_1: int32, 0, 16) {
                            for (y_1: int32, 0, 16) {
                              for (k_1: int32, 0, 16) {
                                block([1, 48400, 512, tir.reduce_axis(0, 12544)], "Conv_update") as [v_n_1, v_x_1, v_y_1, v_k] {
                                  bind(v_n_1, n)
                                  bind(v_x_1, ((((x_0_0*16) + (x_0_1*16)) + (x_0_2*16)) + x_1))
                                  bind(v_y_1, (((((y_0_0_0*256) + (y_0_0_1*16)) + (y_0_1*16)) + (y_0_2*16)) + y_1))
                                  bind(v_k, (((k_0_0*64) + (k_0_1*16)) + k_1))
                                  tir.reads([CPad_shared_wmma.accumulator[v_n_1, floordiv(v_x_1, 16), floordiv(v_y_1, 16), floormod(v_x_1, 16), floormod(v_y_1, 16)], data_im2col_global_shared_wmma.matrix_a[v_n_1, floordiv(v_x_1, 16), floordiv(v_k, 16), floormod(v_x_1, 16), floormod(v_k, 16)], weight_flatten_global_shared_wmma.matrix_b[floordiv(v_k, 16), floordiv(v_y_1, 16), floormod(v_k, 16), floormod(v_y_1, 16)]])
                                  tir.writes([CPad_shared_wmma.accumulator[v_n_1, floordiv(v_x_1, 16), floordiv(v_y_1, 16), floormod(v_x_1, 16), floormod(v_y_1, 16)]])
                                  CPad_shared_wmma.accumulator[v_n_1, floordiv(v_x_1, 16), floordiv(v_y_1, 16), floormod(v_x_1, 16), floormod(v_y_1, 16)] = (CPad_shared_wmma.accumulator[v_n_1, floordiv(v_x_1, 16), floordiv(v_y_1, 16), floormod(v_x_1, 16), floormod(v_y_1, 16)] + (data_im2col_global_shared_wmma.matrix_a[v_n_1, floordiv(v_x_1, 16), floordiv(v_k, 16), floormod(v_x_1, 16), floormod(v_k, 16)]*weight_flatten_global_shared_wmma.matrix_b[floordiv(v_k, 16), floordiv(v_y_1, 16), floormod(v_k, 16), floormod(v_y_1, 16)]))
                              }
                            }
                          }
                        }
                      ...
                      for (ax0_1_3: int32, 0, 16) {
                        for (ax1_1_3: int32, 0, 16) {
                          block([1, 48400, 512], "CPad_shared_wmma.accumulator") as [v0_6, v1_6, v2_3] {
                            bind(v0_6, 0)
                            bind(v1_6, (((x_0_0*16) + (ax0_0_2*16)) + ax0_1_3))
                            bind(v2_3, ((((y_0_0_0*256) + (y_0_0_1*16)) + (ax1_0_2*16)) + ax1_1_3))
