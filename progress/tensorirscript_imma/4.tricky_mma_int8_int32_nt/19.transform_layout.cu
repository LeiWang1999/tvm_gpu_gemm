                  ...
                  for (ax1: int32, 0, 16) {
                    for (ax2: int32, 0, 32) {
                      block([1024, 512, 16, 32], "A_shared_warp") as [v0_2, v1_2, v2_2, v3_2] {
                        ...
                        tir.writes([A_shared_warp[v0_2, v1_2, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)]])
                        A_shared_warp[v0_2, v1_2, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)] = A_shared[v0_2, v1_2, v2_2, v3_2]
                    }
                  }
                }
                for (ax0_1: int32, 0, 4) {
                ...
                for (ii_2: int32, 0, 4) {
                  for (jj_2: int32, 0, 4) {
                    for (i: int32, 0, 16) {
                      for (j: int32, 0, 16) {
                        for (k: int32, 0, 32) {
                          block([1024, 1024, tir.reduce_axis(0, 512), 16, 16, tir.reduce_axis(0, 32)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                            ...
                            bind(vj_1, j)
                            bind(vk, k)
                            tir.reads([C_warp[vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))], A_shared_warp[vii_1, vkk, ((vi_1*2) + floordiv(vk, 16)), floormod(vk, 16)], B_shared_warp[vjj_1, vkk, ((vj_1*2) + floordiv(vk, 16)), floormod(vk, 16)]])
