            ...
            for (kk_0: int32, 0, 256) {
              ...
              for (kk_1: int32, 0, 2) {
                ...
                for (ax0_1: int32, 0, 4) {
                  for (ax1: int32, 0, 16) {
                    for (ax2: int32, 0, 32) {
                      block([1024, 512, 16, 32], "B_shared_warp") as [v0_3, v1_3, v2_2, v3_2] {
                        bind(v0_3, ((jj_0*4) + ax0_1))
                        bind(v1_3, ((kk_0*2) + kk_1))
                        bind(v2_2, ax1)
                        bind(v3_2, ax2)
                        tir.reads([B_shared[v0_3, v1_3, v2_2, v3_2]])
                        tir.writes([B_shared_warp[v0_3, v1_3, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)]])
                        B_shared_warp[v0_3, v1_3, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)] = B_shared[v0_3, v1_3, v2_2, v3_2]
                    }
                  }
                }
                for (ii_2: int32, 0, 4) {
