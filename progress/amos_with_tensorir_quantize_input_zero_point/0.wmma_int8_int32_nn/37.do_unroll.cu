                      ...
                      for (ax0_ax1_fused_1: int32, 0, 1) "thread_binding" {
                        for (ax0_ax1_fused_2: int32, 0, 32) "thread_binding" {
                          block([16384, 16384], "C") as [vi, vj] {
                            bind(vi, (((i_0_0*256) + (ax0_0_2*16)) + floordiv((((ax0_ax1_fused_0*32) + (ax0_ax1_fused_1*32)) + ax0_ax1_fused_2), 16)))
                            bind(vj, ((((j_0_0_0*1024) + (j_0_0_1*64)) + (j_0_1*16)) + floormod((((ax0_ax1_fused_0*32) + (ax0_ax1_fused_1*32)) + ax0_ax1_fused_2), 16)))
                      ...
                      for (ax0_ax1_fused_1_1: int32, 0, 1) "thread_binding" {
                        for (ax0_ax1_fused_2_1: int32, 0, 32) "thread_binding" {
                          block([16384, 16384], "C_local") as [v0_4, v1_4] {
                            bind(v0_4, (((i_0_0*256) + (ax0_0_2*16)) + floordiv((((ax0_ax1_fused_0_1*32) + (ax0_ax1_fused_1_1*32)) + ax0_ax1_fused_2_1), 16)))
                            bind(v1_4, ((((j_0_0_0*1024) + (j_0_0_1*64)) + (j_0_1*16)) + floormod((((ax0_ax1_fused_0_1*32) + (ax0_ax1_fused_1_1*32)) + ax0_ax1_fused_2_1), 16)))
