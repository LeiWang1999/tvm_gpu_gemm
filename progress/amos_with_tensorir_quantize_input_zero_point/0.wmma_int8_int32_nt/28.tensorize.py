                    ...
                    for j_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                            ...
                            for k_0_1 in T.serial(2):
                                for ax0_0, ax1_0 in T.grid(16, 1):
                                    with T.block("A_global_shared_wmma.matrix_a_o"):
                                        v0_o = T.axis.spatial(1024, i_0_0 * 16 + ax0_0)
                                ...
                                for ax0_0, ax1_0 in T.grid(1, 1):
                                    with T.block("B_global_shared_wmma.matrix_b_o"):
                                        ...
                                        v1_o = T.axis.spatial(1024, j_0_0_0 * 64 + j_0_0_1 * 4 + j_0_1 + ax1_0)
                                ...
                                for i_0_2, j_0_2 in T.grid(16, 1):
                                    with T.block("B_update_o"):
                                        vi_o = T.axis.spatial(1024, i_0_0 * 16 + i_0_1 * 16 + i_0_2)
                                        vj_o = T.axis.spatial(1024, j_0_0_0 * 64 + j_0_0_1 * 4 + j_0_1 + j_0_2)
                                        vk_o = T.axis.reduce(1024, k_0_0 * 2 + k_0_1)
                                        T.reads(QC_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], A_global_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], B_global_shared_wmma_matrix_b[vk_o, vj_o, 0 : 16, 0 : 16])
                                        T.writes(QC_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                        ...
                        for ax0_0, ax1_0 in T.grid(16, 1):
                            with T.block("QC_wmma.accumulator_o"):
                                ...
                                C_5 = T.match_buffer(QC[v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16], [16, 16], dtype="int32", strides=[C_s0_4, C_s1_4], scope="shared", offset_factor=16)
                            ...
                            for ax0, ax1 in T.grid(16, 16):
                                with T.block("C"):
                                    vi = T.axis.spatial(16384, i_0_0 * 256 + ax0_0 * 16 + ax0)
                            ...
                            for ax0, ax1 in T.grid(16, 16):
                                with T.block("C_local"):
                                    v0 = T.axis.spatial(16384, i_0_0 * 256 + ax0_0 * 16 + ax0)
