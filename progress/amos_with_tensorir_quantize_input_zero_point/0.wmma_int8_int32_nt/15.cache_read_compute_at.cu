          ...
          for (j_0_0_1: int32, 0, 16) "thread_binding" {
            for (i_0_1: int32, 0, 1) "thread_binding" {
              for (j_0_1: int32, 0, 4) "thread_binding" {
                  ...
                  for (ax0_3: int32, 0, 32) {
                    for (ax1_3: int32, 0, 64) {
                      block([16384, 16384], "B_global_shared") as [v0_3, v1_3] {
                        ...
                        bind(v1_3, (((j_0_0_0*1024) + (j_0_0_1*64)) + ax1_3))
                    ...
                    for (ax0_5: int32, 0, 16) {
                      for (ax1_5: int32, 0, 16) {
                        block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                          ...
                          bind(v1_5, ((((j_0_0_0*1024) + (j_0_0_1*64)) + (j_0_1*16)) + ax1_5))
                ...
                for (ax0_6: int32, 0, 256) {
                  for (ax1_6: int32, 0, 16) {
                    block([16384, 16384], "QC_wmma.accumulator") as [v0_6, v1_6] {
                      bind(v0_6, ((i_0_0*256) + ax0_6))
                      bind(v1_6, ((((j_0_0_0*1024) + (j_0_0_1*64)) + (j_0_1*16)) + ax1_6))
                ...
                for (ax0_7: int32, 0, 256) {
                  for (ax1_7: int32, 0, 16) {
                    block([16384, 16384], "C") as [vi_1, vj_1] {
                      bind(vi_1, ((i_0_0*256) + ax0_7))
                      bind(vj_1, ((((j_0_0_0*1024) + (j_0_0_1*64)) + (j_0_1*16)) + ax1_7))
                      tir.reads([QC[vi_1, vj_1], PB[vj_1]])
                      tir.writes([C_local[vi_1, vj_1]])
                      C_local[vi_1, vj_1] = ((QC[vi_1, vj_1] + 12) + PB[vj_1])
                  }
                }
                for (ax0_8: int32, 0, 256) {
                  for (ax1_8: int32, 0, 16) {
                    block([16384, 16384], "C_local") as [v0_7, v1_7] {
                      bind(v0_7, ((i_0_0*256) + ax0_8))
                      bind(v1_7, ((((j_0_0_0*1024) + (j_0_0_1*64)) + (j_0_1*16)) + ax1_8))
