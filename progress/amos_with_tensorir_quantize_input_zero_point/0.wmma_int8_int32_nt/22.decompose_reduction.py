            ...
            for j_0_0_1 in T.thread_binding(16, thread="blockIdx.x"):
                for i_0_1 in T.thread_binding(1, thread="threadIdx.y"):
                    for j_0_1 in T.thread_binding(4, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init, i_1_init, j_1_init in T.grid(16, 1, 16, 16):
                            with T.block("B_init"):
                                vi = T.axis.spatial(16384, i_0_0 * 256 + i_0_1 * 256 + i_0_2_init * 16 + i_1_init)
                                vj = T.axis.spatial(16384, j_0_0_0 * 1024 + j_0_0_1 * 64 + j_0_1 * 16 + j_0_2_init * 16 + j_1_init)
                                T.reads()
