        ...
        for i_0 in T.thread_binding(128, thread="blockIdx.x"):
            for j_1_0 in T.thread_binding(4, thread="vthread.y"):
                for i_1_0 in T.thread_binding(4, thread="vthread.x"):
                    for k_0, k_1_0, k_1_1_0, j_1_1_0, i_1_1_0, k_1_1_1, j_1_1_1, i_1_1_1 in T.grid(512, 1, 8, 32, 32, 4, 1, 1):
                        with T.block("B"):
                            vi = T.axis.spatial(16384, i_1_1_1 + i_0 * 128 + i_1_0 * 32 + i_1_1_0)
                            vj = T.axis.spatial(16384, j_0 * 128 + j_1_0 * 32 + j_1_1_0 + j_1_1_1)
