        ...
        for (ax0: int32, 0, 16) {
          for (ax1: int32, 0, 32) {
            block([1, 1, 16, 32], "A_shared_warp") as [v0_1, v1_1, v2_1, v3_1] {
              ...
              tir.writes([A_shared_warp[v0_1, v1_1, ((v2_1*2) + floordiv(v3_1, 16)), floormod(v3_1, 16)]])
              A_shared_warp[v0_1, v1_1, ((v2_1*2) + floordiv(v3_1, 16)), floormod(v3_1, 16)] = A_shared[v0_1, v1_1, v2_1, v3_1]
          }
        }
        ...
        for (ax0_1: int32, 0, 16) {
          for (ax1_1: int32, 0, 32) {
            block([1, 1, 16, 32], "B_shared_warp") as [v0_3, v1_3, v2_3, v3_3] {
              ...
              tir.writes([B_shared_warp[v0_3, v1_3, ((v2_3*2) + floordiv(v3_3, 16)), floormod(v3_3, 16)]])
              B_shared_warp[v0_3, v1_3, ((v2_3*2) + floordiv(v3_3, 16)), floormod(v3_3, 16)] = B_shared[v0_3, v1_3, v2_3, v3_3]
          }
        }
        for (ax0_2: int32, 0, 16) {
          for (ax1_2: int32, 0, 32) {
            block([1, 1, 16, 32], "B_shared_warp_warp") as [v0_4, v1_4, v2_4, v3_4] {
              ...
              bind(v2_4, ax0_2)
              bind(v3_4, ax1_2)
              tir.reads([B_shared_warp[v0_4, v1_4, ((v2_4*2) + floordiv(v3_4, 16)), floormod(v3_4, 16)]])
              tir.writes([B_shared_warp_warp[v0_4, v1_4, ((v2_4*2) + floordiv(v3_4, 16)), floormod(v3_4, 16)]])
              B_shared_warp_warp[v0_4, v1_4, ((v2_4*2) + floordiv(v3_4, 16)), floormod(v3_4, 16)] = B_shared_warp[v0_4, v1_4, ((v2_4*2) + floordiv(v3_4, 16)), floormod(v3_4, 16)]
          }
        }
        for (i_init: int32, 0, 16) {
          for (j_init: int32, 0, 16) {
            block([1, 1, 16, 16], "B_init") as [vii, vjj, vi, vj] {
              ...
              C_warp[vii, vjj, ((floormod(vi, 8)*4) + floordiv(floormod(vj, 8), 2)), (((floordiv(vj, 8)*4) + (floordiv(vi, 8)*2)) + floormod(vj, 2))] = 0
          }
        }
        for (kk: int32, 0, 1) {
          for (i: int32, 0, 16) {
            for (j: int32, 0, 16) {
              for (k: int32, 0, 32) {
                block([1, 1, tir.reduce_axis(0, 1), 16, 16, tir.reduce_axis(0, 32)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                  ...
                  bind(vj_1, j)
                  bind(vk, k)
                  tir.reads([C_warp[vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))], A_shared_warp[vii_1, vkk, ((vi_1*2) + floordiv(vk, 16)), floormod(vk, 16)], B_shared_warp_warp[vjj_1, vkk, ((vj_1*2) + floordiv(vk, 16)), floormod(vk, 16)]])
                  ...
                  C_warp[vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))] = (C_warp[vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))] + (cast(int32, A_shared_warp[vii_1, vkk, ((vi_1*2) + floordiv(vk, 16)), floormod(vk, 16)])*cast(int32, B_shared_warp_warp[vjj_1, vkk, ((vj_1*2) + floordiv(vk, 16)), floormod(vk, 16)])))
              }
            }
          }
        }
        for (ax0_3: int32, 0, 16) {
          for (ax1_3: int32, 0, 16) {
            block([1, 1, 16, 16], "C_warp") as [v0_5, v1_5, v2_5, v3_5] {
              ...
              bind(v2_5, ax0_3)
              bind(v3_5, ax1_3)
              tir.reads([C_warp[v0_5, v1_5, ((floormod(v2_5, 8)*4) + floordiv(floormod(v3_5, 8), 2)), (((floordiv(v3_5, 8)*4) + (floordiv(v2_5, 8)*2)) + floormod(v3_5, 2))]])
              tir.writes([C[v0_5, v1_5, v2_5, v3_5]])
              C[v0_5, v1_5, v2_5, v3_5] = C_warp[v0_5, v1_5, ((floormod(v2_5, 8)*4) + floordiv(floormod(v3_5, 8), 2)), (((floordiv(v3_5, 8)*4) + (floordiv(v2_5, 8)*2)) + floormod(v3_5, 2))]
          }
        }
      }
    }
