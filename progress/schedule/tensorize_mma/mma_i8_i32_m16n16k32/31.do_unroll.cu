      ...
      for (jj: int32, 0, 1) "thread_binding" {
          ...
          for (i0: int32, 0, 32) {
            block([32], "B_warp_warp") as [v0_5] {
              ...
              tir.writes([B_warp_permutated[v0_5, 0:16]])
               {
                B_warp_permutated[v0_5, 0] = B_warp[v0_5, 0]
                B_warp_permutated[v0_5, 1] = B_warp[v0_5, 1]
                B_warp_permutated[v0_5, 2] = B_warp[v0_5, 2]
                B_warp_permutated[v0_5, 3] = B_warp[v0_5, 3]
                B_warp_permutated[v0_5, 4] = B_warp[v0_5, 4]
              }
          }
        ...
        for (kk: int32, 0, 1) {
          block([1, 1, tir.reduce_axis(0, 1), 1, 1, tir.reduce_axis(0, 1)], "B_update_o") as [vii_1, vjj_1, vkk, vi_o_1, vj_o_1, vk_o] {
            ...
            bind(vj_o_1, 0)
            bind(vk_o, 0)
            tir.reads([C_warp[vii_1, vjj_1, 0:32, 0:8], A_shared_warp[vii_1, vkk, 0:32, 0:16], B_shared_warp_warp[vjj_1, vkk, 0:32, 0:16]])
            tir.writes([C_warp[vii_1, vjj_1, 0:32, 0:8]])
            A_2 = match_buffer(A_shared_warp[vii_1, vkk, 0:32, 0:16])
            B_2 = match_buffer(B_shared_warp_warp[vjj_1, vkk, 0:32, 0:16])
            C_2 = match_buffer(C_warp[vii_1, vjj_1, 0:32, 0:8])
            attr [IterVar(tx_4: int32, [0:32], "ThreadIndex", "threadIdx.x")] "thread_extent" = 32 {
              @tir.ptx_mma("m16n8k32", "row", "col", "int8", "int8", "int32", A_3: Pointer(warp int8), (elem_offset_5: int32 + (tx_4*16)), B_3: Pointer(warp int8), (elem_offset_6: int32 + (tx_4*16)), C_3: Pointer(warp int32), (elem_offset_7: int32 + (tx_4*8)), False, dtype=int32)
              @tir.ptx_mma("m16n8k32", "row", "col", "int8", "int8", "int32", A_3, (elem_offset_5 + (tx_4*16)), B_3, ((elem_offset_6 + (tx_4*16)) + floordiv(16, 2)), C_3, ((elem_offset_7 + (tx_4*8)) + floordiv(8, 2)), False, dtype=int32)
            }
        }
        block([1, 1, 1, 1], "C_warp_o") as [v0_6, v1_5, v2_o_3, v3_o_3] {
          bind(v0_6, 0)
          bind(v1_5, 0)
          bind(v2_o_3, 0)
          bind(v3_o_3, 0)
          tir.reads([C_warp[v0_6, v1_5, 0:32, 0:8]])
          tir.writes([C[v0_6, v1_5, 0:16, 0:16]])
          C_warp_3 = match_buffer(C_warp[v0_6, v1_5, 0:32, 0:8])
          C_4 = match_buffer(C[v0_6, v1_5, 0:16, 0:16])
          attr [IterVar(tx_5: int32, [0:32], "ThreadIndex", "threadIdx.x")] "thread_extent" = 32;
