  ...
  block([], "root") {
    ...
    for (ii: int32, 0, 1) "thread_binding" {
      for (jj: int32, 0, 1) "thread_binding" {
        ...
        for (ax0: int32, 0, 16) {
          for (ax1: int32, 0, 32) {
            block([1, 1, 16, 32], "B_shared_warp_warp") as [v0_4, v1_4, v2_2, v3_2] {
              bind(v0_4, 0)
              bind(v1_4, 0)
              bind(v2_2, ax0)
              bind(v3_2, ax1)
              tir.reads([B_shared_warp[v0_4, v1_4, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)]])
              tir.writes([B_shared_warp_warp[v0_4, v1_4, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)]])
              B_shared_warp_warp[v0_4, v1_4, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)] = B_shared_warp[v0_4, v1_4, ((v2_2*2) + floordiv(v3_2, 16)), floormod(v3_2, 16)]
          }
        }
        ...
        for (ax0_1: int32, 0, 16) {
          for (ax1_1: int32, 0, 16) {
            block([1, 1, 16, 16], "C_warp") as [v0_5, v1_5, v2_3, v3_3] {
              bind(v0_5, 0)
              bind(v1_5, 0)
              bind(v2_3, ax0_1)
              bind(v3_3, ax1_1)
              tir.reads([C_warp[v0_5, v1_5, ((floormod(v2_3, 8)*4) + floordiv(floormod(v3_3, 8), 2)), (((floordiv(v3_3, 8)*4) + (floordiv(v2_3, 8)*2)) + floormod(v3_3, 2))]])
              tir.writes([C[v0_5, v1_5, v2_3, v3_3]])
              C[v0_5, v1_5, v2_3, v3_3] = C_warp[v0_5, v1_5, ((floormod(v2_3, 8)*4) + floordiv(floormod(v3_3, 8), 2)), (((floordiv(v3_3, 8)*4) + (floordiv(v2_3, 8)*2)) + floormod(v3_3, 2))]
          }
        }
      }
    }
