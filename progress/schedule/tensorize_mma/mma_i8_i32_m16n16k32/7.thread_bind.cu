    ...
    C_warp = alloc_buffer(int32[1, 1, 16, 16])
     {
      for (ax0: int32, 0, 1) {
        for (ax1: int32, 0, 1) {
          for (ax2: int32, 0, 16) {
            for (ax3: int32, 0, 32) {
              block([1, 1, 16, 32], "B_shared") as [v0, v1, v2, v3] {
                bind(v0, ax0)
                bind(v1, ax1)
                bind(v2, ax2)
                bind(v3, ax3)
        ...
        for (ax1_1: int32, 0, 1) {
          for (ax2_1: int32, 0, 16) {
            for (ax3_1: int32, 0, 32) {
              block([1, 1, 16, 32], "A_shared") as [v0_1, v1_1, v2_1, v3_1] {
                bind(v0_1, ax0_1)
                bind(v1_1, ax1_1)
                bind(v2_1, ax2_1)
                bind(v3_1, ax3_1)
        ...
        for (ax1_2: int32, 0, 1) {
          for (ax2_2: int32, 0, 16) {
            for (ax3_2: int32, 0, 32) {
              block([1, 1, 16, 32], "A_shared_warp") as [v0_2, v1_2, v2_2, v3_2] {
                bind(v0_2, ax0_2)
                bind(v1_2, ax1_2)
                bind(v2_2, ax2_2)
                bind(v3_2, ax3_2)
      ...
      for (ax0_5: int32, 0, 1) {
        for (ax1_5: int32, 0, 1) {
          for (ax2_5: int32, 0, 16) {
            for (ax3_5: int32, 0, 16) {
