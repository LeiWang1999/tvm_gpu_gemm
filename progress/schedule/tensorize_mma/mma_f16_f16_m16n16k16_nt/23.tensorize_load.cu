  ...
  block([], "root") {
    ...
    for (ii: int32, 0, 1) "thread_binding" {
      for (jj: int32, 0, 1) "thread_binding" {
        ...
        for (ax0: int32, 0, 16) {
          for (ax1: int32, 0, 16) {
            block([1, 1, 16, 16], "B_shared_warp") as [v0_3, v1_3, v2_2, v3_2] {
              bind(v0_3, 0)
              bind(v1_3, 0)
              bind(v2_2, ax0)
              bind(v3_2, ax1)
        ...
        block([1, 1, 1, 1], "B_init_o") as [vii, vjj, vi_o, vj_o] {
          ...
          @tir.mma_fill(8, C_warp_2: Pointer(warp float16), elem_offset_2: int32, dtype=float16)
        for (kk: int32, 0, 1) {
          for (i: int32, 0, 16) {
            for (j: int32, 0, 16) {
              for (k: int32, 0, 16) {
        ...
        for (ax0_1: int32, 0, 16) {
          for (ax1_1: int32, 0, 16) {
            block([1, 1, 16, 16], "C_warp") as [v0_4, v1_4, v2_3, v3_3] {
              bind(v0_4, 0)
              bind(v1_4, 0)
              bind(v2_3, ax0_1)
              bind(v3_3, ax1_1)
