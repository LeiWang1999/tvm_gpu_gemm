                    ...
                    for k_0 in T.serial(256):
                        ...
                        for i_1_1_0, j_1_1_0, k_1_0 in T.grid(4, 4, 2):
                            ...
                            with T.block("B_shared_warp_o"):
                                ...
                                T.ptx_ldmatrix(False, 4, ".b16", warp_1.data, warp_1.elem_offset + 16 * tx_1, T.tvm_access_ptr(T.type_annotation(dtype="int8"), shared_1.data, shared_1.elem_offset, shared_s0_1 * 16, 1, dtype="handle"), shared_s0_1 * 8 * (tx_1 // 16) + tx_1 % 8 * shared_s0_1 + 16 * (tx_1 % 16 // 8), dtype="int8")
                        ...
                        for ax0_0 in T.thread_binding(128, thread="blockIdx.y"):
                            for ax0_1, ax1 in T.grid(128, 16384):
                                with T.block("Pre_compute_A"):
                                    vi = T.axis.spatial(16384, ax0_0 * 128 + ax0_1)
