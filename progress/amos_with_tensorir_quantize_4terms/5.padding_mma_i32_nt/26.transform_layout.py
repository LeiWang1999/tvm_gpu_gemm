                        ...
                        for i_1_1_0, j_1_1_0, k_1_0 in T.grid(4, 4, 2):
                            for ax0, ax1 in T.grid(16, 32):
                                with T.block("A_shared_warp"):
                                    ...
                                    T.writes(A_shared_warp[v0 // 16, v1 // 32, v0 % 8 * 4 + v1 % 16 // 4, v1 % 32 // 16 * 8 + v0 % 16 // 8 * 4 + v1 % 4])
                                    A_shared_warp[v0 // 16, v1 // 32, v0 % 8 * 4 + v1 % 16 // 4, v1 % 32 // 16 * 8 + v0 % 16 // 8 * 4 + v1 % 4] = A_shared[v0, v1]
                            for ax0, ax1 in T.grid(16, 32):
                                with T.block("B_shared_warp"):
                                    v0 = T.axis.spatial(16384, j_0 * 256 + j_1_0 * 64 + j_1_1_0 * 16 + ax0)
                                    v1 = T.axis.spatial(16384, k_0 * 64 + k_1_0 * 32 + ax1)
                                    T.reads(B_shared[v0, v1])
                                    T.writes(B_shared_warp[v0 // 16, v1 // 32, v0 % 8 * 4 + v1 % 16 // 4, v1 % 32 // 16 * 8 + v0 % 16 // 8 * 4 + v1 % 4])
                                    B_shared_warp[v0 // 16, v1 // 32, v0 % 8 * 4 + v1 % 16 // 4, v1 % 32 // 16 * 8 + v0 % 16 // 8 * 4 + v1 % 4] = B_shared[v0, v1]
