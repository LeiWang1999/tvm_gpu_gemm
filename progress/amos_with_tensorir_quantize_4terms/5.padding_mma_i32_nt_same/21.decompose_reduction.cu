...
@main = primfn(A_handle: handle, B_handle: handle, C_handle: handle) -> ()
  ...
  block([], "root") {
    ...
    A_shared_warp = alloc_buffer(int8[16384, 16384])
    B_shared_warp = alloc_buffer(int8[16384, 16384])
                      ...
                      for (j_1_1_1: int32, 0, 16) {
                        for (k_1_1: int32, 0, 32) {
                          block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_2, vj_1, vk] {
                            ...
                            tir.reads([C_warp[vi_2, vj_1], A_shared_warp[vi_2, vk], B_shared_warp[vj_1, vk]])
                            tir.writes([C_warp[vi_2, vj_1]])
                            C_warp[vi_2, vj_1] = (C_warp[vi_2, vj_1] + (cast(int32, A_shared_warp[vi_2, vk])*cast(int32, B_shared_warp[vj_1, vk])))
                        }
                      }
                    }
                  }
