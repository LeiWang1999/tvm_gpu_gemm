                ...
                for (ax0_3: int32, 0, 64) {
                  for (ax1_3: int32, 0, 64) {
                    block([16384, 16384], "B_global_shared") as [v0_3, v1_3] {
                      bind(v0_3, ((j_0_0*64) + ax0_3))
                      bind(v1_3, ((k_0_0*64) + ax1_3))
                  ...
                  for (ax0_4: int32, 0, 64) {
                    for (ax1_4: int32, 0, 16) {
                      block([16384, 16384], "A_global_shared_wmma.matrix_a") as [v0_4, v1_4] {
                        bind(v0_4, (((i_0_0*256) + (i_0_1*64)) + ax0_4))
                        bind(v1_4, (((k_0_0*64) + (k_0_1*16)) + ax1_4))
                  ...
                  for (ax0_5: int32, 0, 64) {
                    for (ax1_5: int32, 0, 16) {
                      block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                        bind(v0_5, ((j_0_0*64) + ax0_5))
                        bind(v1_5, (((k_0_0*64) + (k_0_1*16)) + ax1_5))
              ...
              for (ax0_7: int32, 0, 64) {
                for (ax1_7: int32, 0, 64) {
                  block([16384, 16384], "QC_wmma.accumulator") as [v0_6, v1_6] {
                    bind(v0_6, (((i_0_0*256) + (i_0_1*64)) + ax0_7))
                    bind(v1_6, ((j_0_0*64) + ax1_7))
