            ...
            for (j_0_1: int32, 0, 1) "thread_binding" {
              ...
              for (k_0_0: int32, 0, 256) {
                ...
                for (k_0_1: int32, 0, 4) {
                  ...
                  for (i_0_2: int32, 0, 4) {
                    for (j_0_2: int32, 0, 4) {
                      block([1024, 1024, tir.reduce_axis(0, 1024)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                        ...
                        bind(vj_o_1, (((j_0_0*4) + (j_0_1*4)) + j_0_2))
                        bind(vk_o, ((k_0_0*4) + k_0_1))
                        tir.reads([QC_wmma.accumulator[vi_o_1, vj_o_1, 0:16, 0:16], A_global_shared_wmma.matrix_a[vi_o_1, vk_o, 0:16, 0:16], B_global_shared_wmma.matrix_b[vj_o_1, vk_o, 0:16, 0:16]])
                  ...
                  for (ax0_0_2: int32, 0, 64) "thread_binding" {
                    for (ax0_1: int32, 0, 256) {
                      for (ax1: int32, 0, 16384) {
                        block([16384, tir.reduce_axis(0, 16384)], "Pre_compute_A") as [vi, vk] {
                          bind(vi, ((ax0_0_2*256) + ax0_1))
                          bind(vk, ax1)
                          tir.reads([A_global_shared[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)]])
                          tir.writes([PA[vi]])
                          with init() {
                            PA[vi] = 0
                          }
                          PA[vi] = (PA[vi] + (4*cast(int32, A_global_shared[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)])))
                      }
                    }
                  }
                }
              ...
              for (ax0_0_3: int32, 0, 4) {
                for (ax1_0_2: int32, 0, 4) {
                  block([1024, 1024], "QC_wmma.accumulator_o") as [v0_o_2, v1_o_2] {
                    bind(v0_o_2, (((i_0_0*16) + (i_0_1*4)) + ax0_0_3))
                    bind(v1_o_2, ((j_0_0*4) + ax1_0_2))
