                ...
                for j_0_1 in T.thread_binding(1, thread="threadIdx.z"):
                    for k_0_0 in T.serial(256, annotations={"thread_rasterization":32}):
                        ...
                        for ax0, ax1 in T.grid(64, 64):
                            with T.block("B_global_shared"):
                                v0 = T.axis.spatial(16384, j_0_0 * 64 + ax0)
                                v1 = T.axis.spatial(16384, k_0_0 * 64 + ax1)
                        ...
                        for k_0_1 in T.serial(4):
                            for ax0, ax1 in T.grid(64, 16):
                                with T.block("A_global_shared_wmma.matrix_a"):
                                    ...
                                    v1 = T.axis.spatial(16384, k_0_0 * 64 + k_0_1 * 16 + ax1)
                    ...
                    for ax0, ax1 in T.grid(64, 64):
                        with T.block("QC_wmma.accumulator"):
                            v0 = T.axis.spatial(16384, i_0_0 * 256 + i_0_1 * 64 + ax0)
                            v1 = T.axis.spatial(16384, j_0_0 * 64 + ax1)
