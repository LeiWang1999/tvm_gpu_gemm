                  ...
                  for (i_1_init: int32, 0, 16) {
                    for (j_1_init: int32, 0, 16) {
                      block([16384, 16384], "B_init") as [vi, vj] {
                        bind(vi, ((((i_0_0*256) + (i_0_1*64)) + (i_0_2_init*16)) + i_1_init))
                        bind(vj, ((((j_0_0*64) + (j_0_1*64)) + (j_0_2_init*16)) + j_1_init))
                        tir.reads([])
                        ...
                        for (j_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                              bind(vi_1, ((((i_0_0*256) + (i_0_1*64)) + (i_0_2*16)) + i_1))
                              bind(vj_1, ((((j_0_0*64) + (j_0_1*64)) + (j_0_2*16)) + j_1))
                              bind(vk, (((k_0_0*64) + (k_0_1*16)) + k_1))
                              tir.reads([QC_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)], A_global_shared_wmma.matrix_a[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)], B_global_shared_wmma.matrix_b[floordiv(vj_1, 16), floordiv(vk, 16), floormod(vj_1, 16), floormod(vk, 16)]])
                  ...
                  for (ax0_2: int32, 0, 16384) {
                    for (ax1_2: int32, 0, 16384) {
                      block([16384, tir.reduce_axis(0, 16384)], "Pre_compute_A") as [vi_2, vk_1] {
                        bind(vi_2, ax0_2)
                        bind(vk_1, ax1_2)
                        tir.reads([A_global_shared[floordiv(vi_2, 16), floordiv(vk_1, 16), floormod(vi_2, 16), floormod(vk_1, 16)]])
                        tir.writes([PA[vi_2]])
                        with init() {
                          PA[vi_2] = 0
                        }
                        PA[vi_2] = (PA[vi_2] + (4*cast(int32, A_global_shared[floordiv(vi_2, 16), floordiv(vk_1, 16), floormod(vi_2, 16), floormod(vk_1, 16)])))
                    }
                  }
                }
              }
