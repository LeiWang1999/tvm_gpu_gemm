      ...
      for (ii.inner.inner.outer: int32, 0, 16) {
        for (ii.inner.inner.inner: int32, 0, 4) {
          for (jj.inner: int32, 0, 128) {
            C[((((((blockIdx.y*2097152) + (ii.inner.outer*1048576)) + (ii.inner.inner.outer*65536)) + (ii.inner.inner.inner*16384)) + (blockIdx.x*128)) + jj.inner)] = C.local_1[((((ii.inner.outer*8192) + (ii.inner.inner.outer*512)) + (ii.inner.inner.inner*128)) + jj.inner)]
          }
        }
      }
    }
