              ...
              for (ii.c.inner: int32, 0, 16) {
                for (jj.c.inner: int32, 0, 16) {
                  for (rk.inner: int32, 0, 16) {
                    let cse_var_7: int32 = (rk.outer.outer*64)
                    let cse_var_6: int32 = (rk.outer.inner*16)
                    let cse_var_5: int32 = ((((ii.c.outer*2048) + (ii.c.inner*128)) + (jj.c.outer*16)) + jj.c.inner)
                    C.wmma.accumulator_1[cse_var_5] = (C.wmma.accumulator_1[cse_var_5] + (cast(int32, A.global.shared.wmma.matrix_a_1[(((((ii.c.outer*262144) + (ii.c.inner*16384)) + cse_var_7) + cse_var_6) + rk.inner)])*cast(int32, B.global.shared.wmma.matrix_b_1[(((((jj.c.outer*262144) + (jj.c.inner*16384)) + cse_var_7) + cse_var_6) + rk.inner)])))
                  }
                }
              }
            }
