  ...
  allocate(C.wmma.accumulator.global: Pointer(global int32), int32, [268435456]), storage_scope = global {
    ...
    for (ax0_4: int32, 0, 16384) {
      for (ax1_4: int32, 0, 16384) {
        let cse_var_7: int32 = ((ax0_4*16384) + ax1_4)
        C.wmma.accumulator.global_1: Buffer(C.wmma.accumulator.global, int32, [268435456], [])[cse_var_7] = C.wmma.accumulator_1[cse_var_7]
      }
    }
    for (ii: int32, 0, 16384) {
      for (jj: int32, 0, 16384) {
        let cse_var_8: int32 = ((ii*16384) + jj)
        C[cse_var_8] = C.wmma.accumulator.global_1[cse_var_8]
      }
    }
  }
}
