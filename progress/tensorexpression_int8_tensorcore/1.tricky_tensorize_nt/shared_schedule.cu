        ...
        for (ax0: int32, 0, 2) {
          for (ax2: int32, 0, 16) {
            for (ax3: int32, 0, 16) {
              ...
              A.shared.wmma.matrix_a_1: Buffer(A.shared.wmma.matrix_a, int8, [512], [], scope="wmma.matrix_a")[(((ax0*256) + cse_var_2) + ax3)] = A.shared_1[(((((threadIdx.y*2048) + (ax0*1024)) + (k1.inner*256)) + cse_var_2) + ax3)]
            }
          }
        }
        for (ax0_1: int32, 0, 8) {
          for (ax2_1: int32, 0, 16) {
            for (ax3_1: int32, 0, 16) {
              ...
              B.shared.wmma.matrix_b_1: Buffer(B.shared.wmma.matrix_b, int8, [2048], [], scope="wmma.matrix_b")[(((ax0_1*256) + cse_var_3) + ax3_1)] = B.shared_1[(((((threadIdx.z*8192) + (ax0_1*1024)) + (k1.inner*256)) + cse_var_3) + ax3_1)]
            }
          }
        }
        for (i.c: int32, 0, 2) {
            ...
            for (ii.c: int32, 0, 16) {
              for (jj.c: int32, 0, 16) {
                for (k2: int32, 0, 16) {
                  ...
                  let cse_var_4: int32 = ((((i.c*2048) + cse_var_6) + cse_var_5) + jj.c)
                  C.wmma.accumulator_1[cse_var_4] = (C.wmma.accumulator_1[cse_var_4] + (cast(int32, A.shared.wmma.matrix_a_1[(((i.c*256) + cse_var_5) + k2)])*cast(int32, B.shared.wmma.matrix_b_1[((cse_var_6 + (jj.c*16)) + k2)])))
                }
              }
            }
          }
      ...
      for (j.inner: int32, 0, 8) {
        for (ii: int32, 0, 16) {
          for (jj: int32, 0, 16) {
            ...
            C[((((((((blockIdx.x*1048576) + (threadIdx.y*524288)) + (i.inner*262144)) + (blockIdx.y*4096)) + (threadIdx.z*2048)) + cse_var_8) + cse_var_7) + jj)] = C.wmma.accumulator_1[((((i.inner*2048) + cse_var_8) + cse_var_7) + jj)]
          }
        }
      }
    }
