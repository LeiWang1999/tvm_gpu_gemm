                      ...
                      for (j_1_1_1: int32, 0, 16) {
                        for (k_1_1: int32, 0, 32) {
                          block([16384, 16384, tir.reduce_axis(0, 16384)], "B") as [vi, vj, vk] {
                            ...
                            tir.reads([A_shared_warp[floordiv(vi, 8), floordiv(vk, 64), floormod(vi, 8), floormod(vk, 64)], B_shared_warp[floordiv(vj, 8), floordiv(vk, 64), floormod(vj, 8), floormod(vk, 64)]])
                            tir.writes([C_warp[vi, vj]])
                            with init() {
                              C_warp[vi, vj] = 0
                            }
                            C_warp[vi, vj] = (C_warp[vi, vj] + (cast(int32, A_shared_warp[floordiv(vi, 8), floordiv(vk, 64), floormod(vi, 8), floormod(vk, 64)])*cast(int32, B_shared_warp[floordiv(vj, 8), floordiv(vk, 64), floormod(vj, 8), floormod(vk, 64)])))
                        }
                      }
                    }
                  }
            ...
            for (ax0_2: int32, 0, 64) {
              for (ax1_2: int32, 0, 64) {
                block([16384, 16384], "C_warp") as [v0_4, v1_4] {
                  bind(v0_4, (((i_0*128) + (i_1_0*64)) + ax0_2))
                  bind(v1_4, (((j_0*256) + (j_1_0*64)) + ax1_2))
