...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    A_shared_warp = alloc_buffer(int8[512, 1024, 32, 16])
    B_shared_warp = alloc_buffer(int8[512, 1024, 32, 16])
          ...
          for (j_1_0: int32, 0, 4) "thread_binding" {
            ...
            for (k_0: int32, 0, 256) {
              ...
              for (k_1_0: int32, 0, 2) {
                for (ax0_0: int32, 0, 2) {
                  for (ax1_0: int32, 0, 2) {
                    block([512, 1024], "A_shared_warp_o") as [v0_o, v1_o] {
                      bind(v0_o, (((i_0*4) + (i_1_0*2)) + ax0_0))
                      bind(v1_o, (((k_0*4) + (k_1_0*2)) + ax1_0))
                      tir.reads([A_shared[(v0_o*32):((v0_o*32) + 32), (v1_o*16):((v1_o*16) + 16)]])
                      tir.writes([A_shared_warp[v0_o, v1_o, 0:32, 0:16]])
                      warp = match_buffer(A_shared_warp[v0_o, v1_o, 0:32, 0:16])
                      shared = match_buffer(A_shared[(v0_o*32):((v0_o*32) + 32), (v1_o*16):((v1_o*16) + 16)])
                      attr [IterVar(tx: int32, [0:32], "ThreadIndex", "threadIdx.x")] "thread_extent" = 32;
                      @tir.ptx_ldmatrix(True, 4, ".b16", warp_1: Pointer(warp int8), (elem_offset: int32 + (16*tx)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=int8), shared_1: Pointer(shared int8), elem_offset_1: int32, (shared_s0: int32*32), 1, dtype=handle), shared_s0, dtype=int8)
                  }
                }
                for (ax0_0_1: int32, 0, 2) {
                  for (ax1_0_1: int32, 0, 2) {
                    block([512, 1024], "B_shared_warp_o") as [v0_o_1, v1_o_1] {
                      bind(v0_o_1, (((j_0*8) + (j_1_0*2)) + ax0_0_1))
                      bind(v1_o_1, (((k_0*4) + (k_1_0*2)) + ax1_0_1))
                      tir.reads([B_shared[(v0_o_1*32):((v0_o_1*32) + 32), (v1_o_1*16):((v1_o_1*16) + 16)]])
                      tir.writes([B_shared_warp[v0_o_1, v1_o_1, 0:32, 0:16]])
                      warp_2 = match_buffer(B_shared_warp[v0_o_1, v1_o_1, 0:32, 0:16])
                      shared_2 = match_buffer(B_shared[(v0_o_1*32):((v0_o_1*32) + 32), (v1_o_1*16):((v1_o_1*16) + 16)])
                      attr [IterVar(tx_1: int32, [0:32], "ThreadIndex", "threadIdx.x")] "thread_extent" = 32;
                      @tir.ptx_ldmatrix(True, 4, ".b16", warp_3: Pointer(warp int8), (elem_offset_2: int32 + (16*tx_1)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=int8), shared_3: Pointer(shared int8), elem_offset_3: int32, (shared_s0_1: int32*32), 1, dtype=handle), shared_s0_1, dtype=int8)
                  }
                }
                      ...
                      for (j_1_1_1: int32, 0, 16) {
                        for (k_1_1: int32, 0, 32) {
                          block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                            ...
                            tir.reads([C_warp[floordiv(vi_1, 16), floordiv(vj_1, 16), ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(floormod(vj_1, 16), 8)*4) + (floordiv(floormod(vi_1, 16), 8)*2)) + floormod(vj_1, 2))], A_shared_warp[floordiv(vi_1, 32), floordiv(vk, 16), ((floormod(vk, 8)*4) + floordiv(floormod(vi_1, 16), 4)), (((floordiv(floormod(vk, 16), 8)*8) + (floordiv(floormod(vi_1, 32), 16)*4)) + floormod(vi_1, 4))], B_shared_warp[floordiv(vj_1, 32), floordiv(vk, 16), ((floormod(vk, 8)*4) + floordiv(floormod(vj_1, 16), 4)), (((floordiv(floormod(vk, 16), 8)*8) + (floordiv(floormod(vj_1, 32), 16)*4)) + floormod(vj_1, 4))]])
                            ...
                            C_warp[floordiv(vi_1, 16), floordiv(vj_1, 16), ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(floormod(vj_1, 16), 8)*4) + (floordiv(floormod(vi_1, 16), 8)*2)) + floormod(vj_1, 2))] = (C_warp[floordiv(vi_1, 16), floordiv(vj_1, 16), ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(floormod(vj_1, 16), 8)*4) + (floordiv(floormod(vi_1, 16), 8)*2)) + floormod(vj_1, 2))] + (cast(int32, A_shared_warp[floordiv(vi_1, 32), floordiv(vk, 16), ((floormod(vk, 8)*4) + floordiv(floormod(vi_1, 16), 4)), (((floordiv(floormod(vk, 16), 8)*8) + (floordiv(floormod(vi_1, 32), 16)*4)) + floormod(vi_1, 4))])*cast(int32, B_shared_warp[floordiv(vj_1, 32), floordiv(vk, 16), ((floormod(vk, 8)*4) + floordiv(floormod(vj_1, 16), 4)), (((floordiv(floormod(vk, 16), 8)*8) + (floordiv(floormod(vj_1, 32), 16)*4)) + floormod(vj_1, 4))])))
                        }
                      }
                    }
                  }
                ...
                for (ax0_1: int32, 0, 16) {
                  for (ax1_1: int32, 0, 16) {
                    block([16384, 16384], "C_warp") as [v0_2, v1_2] {
                      bind(v0_2, ((((i_0*128) + (i_1_0*64)) + (ax0_0_2*16)) + ax0_1))
                      bind(v1_2, ((((j_0*256) + (j_1_0*64)) + (ax1_0_2*16)) + ax1_1))
