                ...
                for j_1_0 in T.thread_binding(4, thread="threadIdx.y"):
                    ...
                    for k_0 in T.serial(256):
                        ...
                        for k_1_0 in T.serial(2):
                            for ax0, ax1_0, ax2_0, ax1_1, ax2_1 in T.grid(8, 1, 2, 32, 16):
                                with T.block("A_shared_warp"):
                                    T.where(ax1_0 * 32 + ax1_1 < 8)
                                    v0 = T.axis.spatial(2048, i_0 * 16 + i_1_0 * 8 + ax0)
                                    v1 = T.axis.spatial(256, k_0)
                                    v2 = T.axis.spatial(8, ax1_0 * 32 + ax1_1)
                                    v3 = T.axis.spatial(64, k_1_0 * 32 + ax2_0 * 16 + ax2_1)
                            ...
                            for i_1_1_0, j_1_1_0, i_1_1_1, j_1_1_1, k_1_1 in T.grid(4, 4, 16, 16, 32):
                                with T.block("B_update"):
                                    ...
                                    T.reads(C_warp[vi, vj], A_shared_warp[vi // 8, vk // 64, vi % 8, vk % 64], B_shared_warp[vj // 8, vk // 64, vj % 8, vk % 64])
                                    T.writes(C_warp[vi, vj])
