              ...
              for (k_1_0: int32, 0, 2) {
                    ...
                    for (ax0_1: int32, 0, 32) {
                      for (ax1_1: int32, 0, 16) {
                        block([16384, 16384], "A_shared_warp") as [v0_2, v1_2] {
                          bind(v0_2, ((((i_0*128) + (i_1_0*64)) + (ax0_0*32)) + ax0_1))
                          bind(v1_2, ((((k_0*64) + (k_1_0*32)) + (ax1_0*16)) + ax1_1))
                          tir.reads([A_shared[v0_2, v1_2]])
                          tir.writes([A_shared_warp[floordiv(v0_2, 32), floordiv(v1_2, 16), ((floormod(v1_2, 8)*4) + floordiv(floormod(v0_2, 16), 4)), (((floordiv(floormod(v1_2, 16), 8)*8) + (floordiv(floormod(v0_2, 32), 16)*4)) + floormod(v0_2, 4))]])
                          A_shared_warp[floordiv(v0_2, 32), floordiv(v1_2, 16), ((floormod(v1_2, 8)*4) + floordiv(floormod(v0_2, 16), 4)), (((floordiv(floormod(v1_2, 16), 8)*8) + (floordiv(floormod(v0_2, 32), 16)*4)) + floormod(v0_2, 4))] = A_shared[v0_2, v1_2]
                      }
                    }
                  }
                }
                for (ax0_0_1: int32, 0, 2) {
                  for (ax1_0_1: int32, 0, 2) {
                    for (ax0_1_1: int32, 0, 32) {
                      for (ax1_1_1: int32, 0, 16) {
                        block([16384, 16384], "B_shared_warp") as [v0_3, v1_3] {
                          bind(v0_3, ((((j_0*256) + (j_1_0*64)) + (ax0_0_1*32)) + ax0_1_1))
                          bind(v1_3, ((((k_0*64) + (k_1_0*32)) + (ax1_0_1*16)) + ax1_1_1))
                          tir.reads([B_shared[v0_3, v1_3]])
                          tir.writes([B_shared_warp[floordiv(v0_3, 32), floordiv(v1_3, 16), ((floormod(v1_3, 8)*4) + floordiv(floormod(v0_3, 16), 4)), (((floordiv(floormod(v1_3, 16), 8)*8) + (floordiv(floormod(v0_3, 32), 16)*4)) + floormod(v0_3, 4))]])
                          B_shared_warp[floordiv(v0_3, 32), floordiv(v1_3, 16), ((floormod(v1_3, 8)*4) + floordiv(floormod(v0_3, 16), 4)), (((floordiv(floormod(v1_3, 16), 8)*8) + (floordiv(floormod(v0_3, 32), 16)*4)) + floormod(v0_3, 4))] = B_shared[v0_3, v1_3]
                      }
                    }
                  }
                }
                ...
                for (ax0_1_2: int32, 0, 16) {
                  for (ax1_1_2: int32, 0, 16) {
                    block([16384, 16384], "C_warp") as [v0_4, v1_4] {
                      bind(v0_4, ((((i_0*128) + (i_1_0*64)) + (ax0_0_2*16)) + ax0_1_2))
