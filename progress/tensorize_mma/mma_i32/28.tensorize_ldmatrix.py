                        ...
                        for i_1_1_0, j_1_1_0, k_1_0 in T.grid(4, 4, 2):
                            ...
                            for i_1_1_1, j_1_1_1, k_1_1 in T.grid(16, 16, 32):
                                with T.block("B_update"):
                                    ...
                                    T.reads(C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2], A_shared_warp[vi // 16, vk // 32, vi % 8 * 4 + vk % 16 // 4, vk % 32 // 16 * 8 + vi % 16 // 8 * 4 + vk % 4], B_shared_warp[vj // 16, vk // 32, vj % 8 * 4 + vk % 16 // 4, vk % 32 // 16 * 8 + vj % 16 // 8 * 4 + vk % 4])
                                    T.writes(C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2])
                                    C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2] = C_warp[vi // 16, vj // 16, vi % 8 * 4 + vj % 8 // 2, vj % 16 // 8 * 4 + vi % 16 // 8 * 2 + vj % 2] + T.Cast("int32", A_shared_warp[vi // 16, vk // 32, vi % 8 * 4 + vk % 16 // 4, vk % 32 // 16 * 8 + vi % 16 // 8 * 4 + vk % 4]) * T.Cast("int32", B_shared_warp[vj // 16, vk // 32, vj % 8 * 4 + vk % 16 // 4, vk % 32 // 16 * 8 + vj % 16 // 8 * 4 + vk % 4])
