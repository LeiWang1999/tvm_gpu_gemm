                        ...
                        for k_0_0 in T.serial(256):
                            ...
                            for k_0_1 in T.serial(4):
                                for ax0_0, ax1_0 in T.grid(4, 1):
                                    with T.block("QA_shared_wmma.matrix_a_o"):
                                        v0_o = T.axis.spatial(1024, i_0_0 * 16 + i_0_1 * 4 + ax0_0)
                                        v1_o = T.axis.spatial(1024, k_0_0 * 4 + k_0_1 + ax1_0)
                                        T.reads(QA_shared[v0_o, v1_o, 0 : 16, 0 : 16])
                                        T.writes(QA_shared_wmma_matrix_a[v0_o, v1_o, 0 : 16, 0 : 16])
                                        A_1 = T.match_buffer(QA_shared[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0, A_s1], scope="shared", offset_factor=16)
                                        C_2 = T.match_buffer(QA_shared_wmma_matrix_a[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[C_s0_1, C_s1_1], scope="wmma.matrix_a", offset_factor=16)
                                ...
                                for ax0_0, ax1_0 in T.grid(4, 1):
                                    with T.block("QB_shared_wmma.matrix_b_o"):
                                        v0_o = T.axis.spatial(1024, j_0_0_0 * 128 + j_0_0_1 * 4 + ax0_0)
                                        v1_o = T.axis.spatial(1024, k_0_0 * 4 + k_0_1 + ax1_0)
                                        T.reads(QB_shared[v0_o, v1_o, 0 : 16, 0 : 16])
                                        T.writes(QB_shared_wmma_matrix_b[v0_o, v1_o, 0 : 16, 0 : 16])
                                        A_2 = T.match_buffer(QB_shared[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0_1, A_s1_1], scope="shared", offset_factor=16)
                                        C_3 = T.match_buffer(QB_shared_wmma_matrix_b[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[C_s0_2, C_s1_2], scope="wmma.matrix_b", offset_factor=16)
                                ...
                                for i_0_2, j_0_2 in T.grid(4, 4):
                                    with T.block("B_update_o"):
                                        ...
                                        T.reads(QC_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], QA_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], QB_shared_wmma_matrix_b[vj_o, vk_o, 0 : 16, 0 : 16])
                                        T.writes(QC_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                                        A_3 = T.match_buffer(QA_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[A_s0_2, A_s1_2], scope="wmma.matrix_a", offset_factor=16)
                                        B_1 = T.match_buffer(QB_shared_wmma_matrix_b[vj_o, vk_o, 0 : 16, 0 : 16], [16, 16], dtype="int8", strides=[B_s0, B_s1], scope="wmma.matrix_b", offset_factor=16)
