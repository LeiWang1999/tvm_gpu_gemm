                      ...
                      for (ax1_0_1: int32, 0, 1) {
                        for (ax0_1_1: int32, 0, 16) {
                          for (ax1_1_1: int32, 0, 16) {
                            block([16384, 16384], "QB_shared_wmma.matrix_b") as [v0_4, v1_4] {
                              bind(v0_4, ((((j_0_0_0*2048) + (j_0_0_1*64)) + (ax0_0_1*16)) + ax0_1_1))
                              bind(v1_4, ((((k_0_0*64) + (k_0_1*16)) + (ax1_0_1*16)) + ax1_1_1))
                              tir.reads([QB_shared[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]])
                              tir.writes([QB_shared_wmma.matrix_b[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]])
                              QB_shared_wmma.matrix_b[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)] = QB_shared[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]
                          }
                        }
                      }
                    }
                          ...
                          for (j_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_2, vj_2, vk] {
                                ...
                                tir.reads([QC_wmma.accumulator[floordiv(vi_2, 16), floordiv(vj_2, 16), floormod(vi_2, 16), floormod(vj_2, 16)], QA_shared_wmma.matrix_a[floordiv(vi_2, 16), floordiv(vk, 16), floormod(vi_2, 16), floormod(vk, 16)], QB_shared_wmma.matrix_b[floordiv(vj_2, 16), floordiv(vk, 16), floormod(vj_2, 16), floormod(vk, 16)]])
                    ...
                    for (ax0_1_2: int32, 0, 16) {
                      for (ax1_1_2: int32, 0, 16) {
                        block([16384, 16384], "QC_wmma.accumulator") as [v0_5, v1_5] {
                          ...
                          bind(v1_5, ((((j_0_0_0*2048) + (j_0_0_1*64)) + (ax1_0_2*16)) + ax1_1_2))
