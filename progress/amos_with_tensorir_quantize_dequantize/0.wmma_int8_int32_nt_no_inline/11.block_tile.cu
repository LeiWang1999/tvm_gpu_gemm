    ...
    QC_wmma.accumulator = alloc_buffer(int32[1024, 1024, 16, 16])
     {
      ...
      for (ax0_3: int32, 0, 16384) {
        for (ax1_3: int32, 0, 16384) {
          block([16384, 16384], "QA_shared_wmma.matrix_a") as [v0_3, v1_3] {
            bind(v0_3, ax0_3)
            bind(v1_3, ax1_3)
            tir.reads([QA_shared[floordiv(v0_3, 16), floordiv(v1_3, 16), floormod(v0_3, 16), floormod(v1_3, 16)]])
            tir.writes([QA_shared_wmma.matrix_a[floordiv(v0_3, 16), floordiv(v1_3, 16), floormod(v0_3, 16), floormod(v1_3, 16)]])
            QA_shared_wmma.matrix_a[floordiv(v0_3, 16), floordiv(v1_3, 16), floormod(v0_3, 16), floormod(v1_3, 16)] = QA_shared[floordiv(v0_3, 16), floordiv(v1_3, 16), floormod(v0_3, 16), floormod(v1_3, 16)]
        }
      }
      for (ax0_4: int32, 0, 16384) {
        for (ax1_4: int32, 0, 16384) {
          block([16384, 16384], "QB_shared") as [v0_4, v1_4] {
            ...
            tir.writes([QB_shared[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)]])
            QB_shared[floordiv(v0_4, 16), floordiv(v1_4, 16), floormod(v0_4, 16), floormod(v1_4, 16)] = QB[v0_4, v1_4]
        }
      }
      ...
      for (i_0_0: int32, 0, 64) {
        for (j_0_0_0: int32, 0, 8) {
          for (j_0_0_1: int32, 0, 32) {
            for (i_0_1: int32, 0, 4) {
              for (j_0_1: int32, 0, 1) {
