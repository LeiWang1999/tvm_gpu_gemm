            ...
            for (i_0_1: int32, 0, 4) "thread_binding" {
              for (j_0_1: int32, 0, 1) "thread_binding" {
                ...
                for (k_0_0: int32, 0, 256) {
                  for (ax0_4: int32, 0, 256) {
                    for (ax1_4: int32, 0, 64) {
                      block([16384, 16384], "QA_shared") as [v0_2, v1_2] {
                        bind(v0_2, ((i_0_0*256) + ax0_4))
                        bind(v1_2, ((k_0_0*64) + ax1_4))
                  ...
                  for (ax0_5: int32, 0, 64) {
                    for (ax1_5: int32, 0, 64) {
                      block([16384, 16384], "QB_shared") as [v0_3, v1_3] {
                        bind(v0_3, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax0_5))
                        bind(v1_3, ((k_0_0*64) + ax1_5))
                  ...
                  for (k_0_1: int32, 0, 4) {
                    for (ax0_6: int32, 0, 64) {
                      for (ax1_6: int32, 0, 16) {
                        block([16384, 16384], "QA_shared_wmma.matrix_a") as [v0_4, v1_4] {
                          bind(v0_4, (((i_0_0*256) + (i_0_1*64)) + ax0_6))
                          bind(v1_4, (((k_0_0*64) + (k_0_1*16)) + ax1_6))
                    ...
                    for (ax0_7: int32, 0, 64) {
                      for (ax1_7: int32, 0, 16) {
                        block([16384, 16384], "QB_shared_wmma.matrix_b") as [v0_5, v1_5] {
                          bind(v0_5, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax0_7))
                          bind(v1_5, (((k_0_0*64) + (k_0_1*16)) + ax1_7))
                ...
                for (ax0_8: int32, 0, 64) {
                  for (ax1_8: int32, 0, 64) {
                    block([16384, 16384], "QC_wmma.accumulator") as [v0_6, v1_6] {
                      bind(v0_6, (((i_0_0*256) + (i_0_1*64)) + ax0_8))
                      bind(v1_6, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax1_8))
                ...
                for (ax0_9: int32, 0, 64) {
                  for (ax1_9: int32, 0, 64) {
                    block([16384, 16384], "DeQuantize_C") as [vi_3, vj_3] {
                      bind(vi_3, (((i_0_0*256) + (i_0_1*64)) + ax0_9))
                      bind(vj_3, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax1_9))
