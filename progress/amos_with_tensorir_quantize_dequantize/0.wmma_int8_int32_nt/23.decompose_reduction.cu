                        ...
                        for (ax0_1_1: int32, 0, 16) {
                          for (ax1_1_1: int32, 0, 16) {
                            block([16384, 16384], "QA_local_shared_wmma.matrix_a") as [v0_6, v1_6] {
                              bind(v0_6, ((((i_0_0*256) + (i_0_1*64)) + (ax0_0*16)) + ax0_1_1))
                              bind(v1_6, ((((k_0_0*64) + (k_0_1*16)) + (ax1_0*16)) + ax1_1_1))
                        ...
                        for (ax0_1_2: int32, 0, 16) {
                          for (ax1_1_2: int32, 0, 16) {
                            block([16384, 16384], "QB_local_shared_wmma.matrix_b") as [v0_7, v1_7] {
                              bind(v0_7, ((((j_0_0_0*2048) + (j_0_0_1*64)) + (ax0_0_1*16)) + ax0_1_2))
                              bind(v1_7, ((((k_0_0*64) + (k_0_1*16)) + (ax1_0_1*16)) + ax1_1_2))
                          ...
                          for (j_1_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_3, vj_3, vk] {
                                bind(vi_3, ((((i_0_0*256) + (i_0_1*64)) + (i_0_2*16)) + i_1_1))
                                bind(vj_3, (((((j_0_0_0*2048) + (j_0_0_1*64)) + (j_0_1*64)) + (j_0_2*16)) + j_1_1))
                                bind(vk, (((k_0_0*64) + (k_0_1*16)) + k_1))
                                tir.reads([QC_shared_wmma.accumulator[floordiv(vi_3, 16), floordiv(vj_3, 16), floormod(vi_3, 16), floormod(vj_3, 16)], QA_local_shared_wmma.matrix_a[floordiv(vi_3, 16), floordiv(vk, 16), floormod(vi_3, 16), floormod(vk, 16)], QB_local_shared_wmma.matrix_b[floordiv(vj_3, 16), floordiv(vk, 16), floormod(vj_3, 16), floormod(vk, 16)]])
                                tir.writes([QC_shared_wmma.accumulator[floordiv(vi_3, 16), floordiv(vj_3, 16), floormod(vi_3, 16), floormod(vj_3, 16)]])
                                QC_shared_wmma.accumulator[floordiv(vi_3, 16), floordiv(vj_3, 16), floormod(vi_3, 16), floormod(vj_3, 16)] = (QC_shared_wmma.accumulator[floordiv(vi_3, 16), floordiv(vj_3, 16), floormod(vi_3, 16), floormod(vj_3, 16)] + (cast(int32, QA_local_shared_wmma.matrix_a[floordiv(vi_3, 16), floordiv(vk, 16), floormod(vi_3, 16), floormod(vk, 16)])*cast(int32, QB_local_shared_wmma.matrix_b[floordiv(vj_3, 16), floordiv(vk, 16), floormod(vj_3, 16), floormod(vk, 16)])))
                            }
                          }
                        }
                      }
                    ...
                    for (ax0_1_3: int32, 0, 16) {
                      for (ax1_1_3: int32, 0, 16) {
                        block([16384, 16384], "QC_shared_wmma.accumulator") as [v0_8, v1_8] {
                          bind(v0_8, ((((i_0_0*256) + (i_0_1*64)) + (ax0_0_2*16)) + ax0_1_3))
                          bind(v1_8, ((((j_0_0_0*2048) + (j_0_0_1*64)) + (ax1_0_2*16)) + ax1_1_3))
