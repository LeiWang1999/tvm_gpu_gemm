              ...
              for (j_0_1: int32, 0, 1) "thread_binding" {
                      ...
                      for (ax1_0_1: int32, 0, 1) {
                        for (ax0_1_1: int32, 0, 16) {
                          for (ax1_1_1: int32, 0, 16) {
                            block([16384, 16384], "QB_local_shared_wmma.matrix_b") as [v0_6, v1_6] {
                              bind(v0_6, ((((j_0_0_0*2048) + (j_0_0_1*64)) + (ax0_0_1*16)) + ax0_1_1))
                              bind(v1_6, ((((k_0_0*64) + (k_0_1*16)) + (ax1_0_1*16)) + ax1_1_1))
                              tir.reads([QB_local_shared[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]])
                              tir.writes([QB_local_shared_wmma.matrix_b[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]])
                              QB_local_shared_wmma.matrix_b[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)] = QB_local_shared[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]
                          }
                        }
                      }
                    }
                      ...
                      for (j_0_2: int32, 0, 4) {
                        for (i_1_1: int32, 0, 16) {
                          for (j_1_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_2, vj_2, vk] {
                                ...
                                tir.reads([QC_shared_wmma.accumulator[floordiv(vi_2, 16), floordiv(vj_2, 16), floormod(vi_2, 16), floormod(vj_2, 16)], QA_local_shared_wmma.matrix_a[floordiv(vi_2, 16), floordiv(vk, 16), floormod(vi_2, 16), floormod(vk, 16)], QB_local_shared_wmma.matrix_b[floordiv(vj_2, 16), floordiv(vk, 16), floormod(vj_2, 16), floormod(vk, 16)]])
                  ...
                  for (ax1_0_2: int32, 0, 4) {
                    for (ax0_1_2: int32, 0, 16) {
                      for (ax1_1_2: int32, 0, 16) {
                        block([16384, 16384], "QC_shared_wmma.accumulator") as [v0_7, v1_7] {
                          bind(v0_7, ((((i_0_0*256) + (i_0_1*64)) + (ax0_0_2*16)) + ax0_1_2))
                          bind(v1_7, ((((j_0_0_0*2048) + (j_0_0_1*64)) + (ax1_0_2*16)) + ax1_1_2))
                          tir.reads([QC_shared_wmma.accumulator[floordiv(v0_7, 16), floordiv(v1_7, 16), floormod(v0_7, 16), floormod(v1_7, 16)]])
                          tir.writes([QC_shared[v0_7, v1_7]])
                          QC_shared[v0_7, v1_7] = QC_shared_wmma.accumulator[floordiv(v0_7, 16), floordiv(v1_7, 16), floormod(v0_7, 16), floormod(v1_7, 16)]
                      }
                    }
                  }
                }
                for (ax0_4: int32, 0, 64) {
                  for (ax1_4: int32, 0, 64) {
                    block([16384, 16384], "QC_shared") as [v0_8, v1_8] {
                      bind(v0_8, (((i_0_0*256) + (i_0_1*64)) + ax0_4))
                      bind(v1_8, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax1_4))
                      tir.reads([QC_shared[v0_8, v1_8]])
                      tir.writes([C[v0_8, v1_8]])
                      C[v0_8, v1_8] = cast(int8, ((cast(float32, QC_shared[v0_8, v1_8]) / 0.01f32) + 0f32))
                  }
                }
              }
            }
