                            ...
                            for k_0_1 in T.serial(4):
                                ...
                                for i_0_2, j_0_2, i_1, j_1, k_1 in T.grid(4, 4, 16, 16, 16):
                                    with T.block("B_update"):
                                        ...
                                        T.reads(QC_shared_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16], QA_local_shared_wmma_matrix_a[vi // 16, vk // 16, vi % 16, vk % 16], QB_local_shared_wmma_matrix_b[vj // 16, vk // 16, vj % 16, vk % 16])
