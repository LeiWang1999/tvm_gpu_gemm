                  ...
                  for (ax0_4: int32, 0, 256) {
                    for (ax1_4: int32, 0, 64) {
                      block([16384, 16384], "QA_local_shared") as [v0_4, v1_4] {
                        bind(v0_4, ((i_0_0*256) + ax0_4))
                        bind(v1_4, ((k_0_0*64) + ax1_4))
                  ...
                  for (ax0_5: int32, 0, 64) {
                    for (ax1_5: int32, 0, 64) {
                      block([16384, 16384], "QB_local_shared") as [v0_5, v1_5] {
                        bind(v0_5, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax0_5))
                        bind(v1_5, ((k_0_0*64) + ax1_5))
                    ...
                    for (ax0_6: int32, 0, 64) {
                      for (ax1_6: int32, 0, 16) {
                        block([16384, 16384], "QA_local_shared_wmma.matrix_a") as [v0_6, v1_6] {
                          bind(v0_6, (((i_0_0*256) + (i_0_1*64)) + ax0_6))
                          bind(v1_6, (((k_0_0*64) + (k_0_1*16)) + ax1_6))
                    ...
                    for (ax0_7: int32, 0, 64) {
                      for (ax1_7: int32, 0, 16) {
                        block([16384, 16384], "QB_local_shared_wmma.matrix_b") as [v0_7, v1_7] {
                          bind(v0_7, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax0_7))
                          bind(v1_7, (((k_0_0*64) + (k_0_1*16)) + ax1_7))
                ...
                for (ax0_8: int32, 0, 64) {
                  for (ax1_8: int32, 0, 64) {
                    block([16384, 16384], "QC_shared_wmma.accumulator") as [v0_8, v1_8] {
                      bind(v0_8, (((i_0_0*256) + (i_0_1*64)) + ax0_8))
                      bind(v1_8, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax1_8))
                ...
                for (ax0_9: int32, 0, 64) {
                  for (ax1_9: int32, 0, 64) {
                    block([16384, 16384], "QC_shared") as [v0_9, v1_9] {
                      bind(v0_9, (((i_0_0*256) + (i_0_1*64)) + ax0_9))
                      bind(v1_9, (((j_0_0_0*2048) + (j_0_0_1*64)) + ax1_9))
