    ...
    C_local = alloc_buffer(float32[16384, 16384])
     {
      ...
      for (ax0_1: int32, 0, 16384) {
        for (ax1_1: int32, 0, 16384) {
          block([16384, 16384], "AT_shared") as [v0_1, v1_1] {
            bind(v0_1, ax0_1)
            bind(v1_1, ax1_1)
            tir.reads([AT[v0_1, v1_1]])
            tir.writes([AT_shared[v0_1, v1_1]])
            AT_shared[v0_1, v1_1] = AT[v0_1, v1_1]
        }
      }
                  ...
                  for (ax0_4: int32, 0, 4) {
                    for (ax1_4: int32, 0, 4) {
                      block([16384, 16384], "C_local") as [v0_4, v1_4] {
                        ...
                        bind(v1_4, ((((j_0*128) + (j_1*64)) + (j_2*4)) + ax1_4))
