                ...
                for (i_3_init: int32, 0, 4) {
                  for (j_3_init: int32, 0, 4) {
                    block([16384, 16384], "B_init") as [vi, vj] {
                      bind(vi, ((((i_0*32) + (i_1*16)) + (i_2*4)) + i_3_init))
                      bind(vj, ((((j_0*256) + (j_1*128)) + (j_2*4)) + j_3_init))
                      tir.reads([])
                    ...
                    for (i_3: int32, 0, 4) {
                      for (j_3: int32, 0, 4) {
                        block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                          bind(vi_1, ((((i_0*32) + (i_1*16)) + (i_2*4)) + i_3))
                          bind(vj_1, ((((j_0*256) + (j_1*128)) + (j_2*4)) + j_3))
                          bind(vk, ((k_0*32) + k_1))
                          tir.reads([C_local[vi_1, vj_1], A_local_shared_local[vi_1, vk], B_shared_local[vk, vj_1]])
                          tir.writes([C_local[vi_1, vj_1]])
                          C_local[vi_1, vj_1] = (C_local[vi_1, vj_1] + (A_local_shared_local[vi_1, vk]*B_shared_local[vk, vj_1]))
                      }
                    }
                  }
                }
