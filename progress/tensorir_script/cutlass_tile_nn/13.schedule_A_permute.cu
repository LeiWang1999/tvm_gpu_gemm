                  ...
                  for (ax0_1: int32, 0, 32) {
                    for (ax1: int32, 0, 32) {
                      block([16384, 16384], "A_local_shared") as [v0_1, v1_1] {
                        bind(v0_1, ((i_0*32) + ax0_1))
                        bind(v1_1, ((k_0*32) + ax1))
                        tir.reads([A_local[v0_1, v1_1]])
                        tir.writes([A_local_shared[v0_1, v1_1]])
                        A_local_shared[v0_1, v1_1] = A_local[v0_1, v1_1]
                    }
                  }
                  for (ax0_2: int32, 0, 32) {
                    for (ax1_2: int32, 0, 256) {
                      block([16384, 16384], "B_shared") as [v0_2, v1_2] {
                        bind(v0_2, ((k_0*32) + ax0_2))
                        bind(v1_2, ((j_0*256) + ax1_2))
                  ...
                  for (k_1: int32, 0, 32) {
                    for (ax0_3: int32, 0, 4) {
                      block([16384, 16384], "A_local_shared_local") as [v0_3, v1_3] {
                        bind(v0_3, ((((i_0*32) + (i_1*16)) + (i_2*4)) + ax0_3))
                    ...
                    for (ax0_4: int32, 0, 4) {
                      block([16384, 16384], "B_shared_local") as [v0_4, v1_4] {
                        ...
                        bind(v1_4, ((((j_0*256) + (j_1*128)) + (j_2*4)) + ax0_4))
                ...
                for (ax0_5: int32, 0, 4) {
                  for (ax1_3: int32, 0, 4) {
                    block([16384, 16384], "C_local") as [v0_5, v1_5] {
                      bind(v0_5, ((((i_0*32) + (i_1*16)) + (i_2*4)) + ax0_5))
                      bind(v1_5, ((((j_0*256) + (j_1*128)) + (j_2*4)) + ax1_3))
