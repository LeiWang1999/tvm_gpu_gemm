    ...
    C_wmma.accumulator = alloc_buffer(int32[1024, 1024, 16, 16])
     {
      ...
      for (i_0_0: int32, 0, 256) "thread_binding" {
        for (j_0_0_0: int32, 0, 64) "thread_binding" {
          for (j_0_0_1: int32, 0, 1) "thread_binding" {
                ...
                for (i_0_2_init: int32, 0, 2) {
                  for (j_0_2_init: int32, 0, 8) {
                    block([1024, 1024], "B_init_o") as [vi_o, vj_o] {
                      ...
                      bind(vj_o, ((((j_0_0_0*16) + (j_0_0_1*16)) + (j_0_1*8)) + j_0_2_init))
                      tir.reads([])
                      tir.writes([C_wmma.accumulator[vi_o, vj_o, 0:16, 0:16]])
                      C_2 = match_buffer(C_wmma.accumulator[vi_o, vj_o, 0:16, 0:16])
                        ...
                        for (ax0_0_ax1_0_ax0_1_ax1_1_fused_3: int32, 0, 32) "thread_binding" {
                          for (ax0_0_ax1_0_ax0_1_ax1_1_fused_4: int32, 0, 16) "vectorized" {
                            block([16384, 16384], "A_global_shared") as [v0_2, v1_2] {
                              bind(v0_2, (((i_0_0*64) + (floordiv((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0*1024) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4), 512)*16)) + floordiv(floormod((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0*1024) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4), 256), 16)))
                              bind(v1_2, (((k_0_0*32) + (floordiv(floormod((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0*1024) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4), 512), 256)*16)) + floormod((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0*1024) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4), 16)))
                        ...
                        for (ax0_0_ax1_0_ax0_1_ax1_1_fused_3_1: int32, 0, 32) "thread_binding" {
                          for (ax0_0_ax1_0_ax0_1_ax1_1_fused_4_1: int32, 0, 16) "vectorized" {
                            block([16384, 16384], "B_global_shared") as [v0_3, v1_3] {
                              bind(v0_3, (((j_0_0_0*256) + (floordiv((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0_1*4096) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1_1*2048)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3_1*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4_1), 512)*16)) + floordiv(floormod((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0_1*4096) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1_1*2048)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3_1*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4_1), 256), 16)))
                              bind(v1_3, (((k_0_0*32) + (floordiv(floormod((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0_1*4096) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1_1*2048)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3_1*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4_1), 512), 256)*16)) + floormod((((((ax0_0_ax1_0_ax0_1_ax1_1_fused_0_1*4096) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_1_1*2048)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_2_1*512)) + (ax0_0_ax1_0_ax0_1_ax1_1_fused_3_1*16)) + ax0_0_ax1_0_ax0_1_ax1_1_fused_4_1), 16)))
                        ...
                        for (ax0_1_1: int32, 0, 16) {
                          for (ax1_1_1: int32, 0, 16) {
                            block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_4, v1_4] {
                              bind(v0_4, ((((j_0_0_0*256) + (j_0_1*128)) + (ax0_0_1*16)) + ax0_1_1))
                              bind(v1_4, ((((k_0_0*32) + (k_0_1*16)) + (ax1_0_1*16)) + ax1_1_1))
                          ...
                          for (j_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi, vj, vk] {
                                ...
                                bind(vj, (((((j_0_0_0*256) + (j_0_0_1*256)) + (j_0_1*128)) + (j_0_2*16)) + j_1))
                                bind(vk, (((k_0_0*32) + (k_0_1*16)) + k_1))
                                tir.reads([C_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)], A_global_shared_wmma.matrix_a[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)], B_global_shared_wmma.matrix_b[floordiv(vj, 16), floordiv(vk, 16), floormod(vj, 16), floormod(vk, 16)]])
                                tir.writes([C_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)]])
                                C_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)] = (C_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)] + (cast(int32, A_global_shared_wmma.matrix_a[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)])*cast(int32, B_global_shared_wmma.matrix_b[floordiv(vj, 16), floordiv(vk, 16), floormod(vj, 16), floormod(vk, 16)])))
                            }
                          }
                        }
                      }
                  ...
                  for (ax1_0_2: int32, 0, 8) {
                    for (ax0_1_2: int32, 0, 16) {
                      for (ax1_1_2: int32, 0, 16) {
                        block([16384, 16384], "C_wmma.accumulator") as [v0_5, v1_5] {
                          bind(v0_5, ((((i_0_0*64) + (i_0_1*32)) + (ax0_0_2*16)) + ax0_1_2))
                          bind(v1_5, ((((j_0_0_0*256) + (j_0_1*128)) + (ax1_0_2*16)) + ax1_1_2))
                          tir.reads([C_wmma.accumulator[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]])
                          tir.writes([C[v0_5, v1_5]])
                          C[v0_5, v1_5] = C_wmma.accumulator[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]
                      }
                    }
                  }
                }
