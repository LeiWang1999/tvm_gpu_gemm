                    ...
                    for (i_1_init: int32, 0, 16) {
                      for (j_1_init: int32, 0, 16) {
                        block([16384, 16384], "B_init") as [vi, vj] {
                          ...
                          bind(vj, (((((j_0_0_0*256) + (j_0_0_1*256)) + (j_0_1*128)) + (j_0_2_init*16)) + j_1_init))
                          tir.reads([])
                          tir.writes([C_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)]])
                          C_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)] = 0
                      }
                    }
                  }
                }
                        ...
                        for (ax0_1_2: int32, 0, 16) {
                          for (ax1_1_2: int32, 0, 16) {
                            block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                              bind(v0_5, ((((j_0_0_0*256) + (j_0_1*128)) + (ax0_0_1*16)) + ax0_1_2))
                          ...
                          for (j_1: int32, 0, 16) {
                            for (k_1: int32, 0, 16) {
                              block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                                ...
                                bind(vj_1, (((((j_0_0_0*256) + (j_0_0_1*256)) + (j_0_1*128)) + (j_0_2*16)) + j_1))
                                bind(vk, (((k_0_0*32) + (k_0_1*16)) + k_1))
                                tir.reads([C_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)], A_global_shared_wmma.matrix_a[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)], B_global_shared_wmma.matrix_b[floordiv(vj_1, 16), floordiv(vk, 16), floormod(vj_1, 16), floormod(vk, 16)]])
                                tir.writes([C_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)]])
                                C_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] = (C_wmma.accumulator[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] + (cast(int32, A_global_shared_wmma.matrix_a[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)])*cast(int32, B_global_shared_wmma.matrix_b[floordiv(vj_1, 16), floordiv(vk, 16), floormod(vj_1, 16), floormod(vk, 16)])))
                            }
                          }
                        }
                      }
                    ...
                    for (ax0_1_3: int32, 0, 16) {
                      for (ax1_1_3: int32, 0, 16) {
                        block([16384, 16384], "C_wmma.accumulator") as [v0_6, v1_6] {
                          ...
                          bind(v1_6, ((((j_0_0_0*256) + (j_0_1*128)) + (ax1_0_2*16)) + ax1_1_3))
                          tir.reads([C_wmma.accumulator[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]])
                          tir.writes([C[v0_6, v1_6]])
                          C[v0_6, v1_6] = C_wmma.accumulator[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]
                      }
                    }
                  }
                }
