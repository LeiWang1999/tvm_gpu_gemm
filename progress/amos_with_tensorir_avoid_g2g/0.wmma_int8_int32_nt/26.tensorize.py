                    ...
                    for j_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init in T.grid(2, 8):
                            with T.block("B_init_o"):
                                ...
                                vj_o = T.axis.spatial(1024, j_0_0_0 * 16 + j_0_0_1 * 16 + j_0_1 * 8 + j_0_2_init)
                                T.reads()
                            ...
                            for k_0_1 in T.serial(2):
                                ...
                                for ax0_0, ax1_0 in T.grid(8, 1):
                                    with T.block("B_global_shared_wmma.matrix_b_o"):
                                        v0_o = T.axis.spatial(1024, j_0_0_0 * 16 + j_0_1 * 8 + ax0_0)
                                        v1_o = T.axis.spatial(1024, k_0_0 * 2 + k_0_1 + ax1_0)
                                ...
                                for i_0_2, j_0_2 in T.grid(2, 8):
                                    with T.block("B_update_o"):
                                        ...
                                        vj_o = T.axis.spatial(1024, j_0_0_0 * 16 + j_0_0_1 * 16 + j_0_1 * 8 + j_0_2)
                                        vk_o = T.axis.reduce(1024, k_0_0 * 2 + k_0_1)
                                        T.reads(C_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], A_global_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], B_global_shared_wmma_matrix_b[vj_o, vk_o, 0 : 16, 0 : 16])
                                        T.writes(C_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                        ...
                        for ax0_0, ax1_0 in T.grid(2, 8):
                            with T.block("C_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(1024, i_0_0 * 4 + i_0_1 * 2 + ax0_0)
                                v1_o = T.axis.spatial(1024, j_0_0_0 * 16 + j_0_1 * 8 + ax1_0)
