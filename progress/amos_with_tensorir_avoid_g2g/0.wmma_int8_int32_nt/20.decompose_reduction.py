                    ...
                    for j_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init, i_1_init, j_1_init in T.grid(2, 8, 16, 16):
                            with T.block("B_init"):
                                ...
                                vj = T.axis.spatial(16384, j_0_0_0 * 256 + j_0_0_1 * 256 + j_0_1 * 128 + j_0_2_init * 16 + j_1_init)
                                T.reads()
                            ...
                            for k_0_1 in T.serial(2):
                                ...
                                for i_0_2, j_0_2, i_1, j_1, k_1 in T.grid(2, 8, 16, 16, 16):
                                    with T.block("B_update"):
                                        ...
                                        T.reads(C_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16], A_global_shared_wmma_matrix_a[vi // 16, vk // 16, vi % 16, vk % 16], B_global_shared_wmma_matrix_b[vj // 16, vk // 16, vj % 16, vk % 16])
                                        T.writes(C_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16])
