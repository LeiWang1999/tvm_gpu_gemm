...
def func(A: T.Buffer[(16384, 16384), "int8"], B: T.Buffer[(16384, 16384), "int8"], C: T.Buffer[(16384, 16384), "int32"]):
    ...
    C_wmma_accumulator = T.alloc_buffer([16384, 16384], dtype="int32", scope="wmma.accumulator")
    ...
    for i, j, k in T.grid(16384, 16384, 16384):
        with T.block("B"):
            ...
            with T.init():
                C_wmma_accumulator[vi, vj] = 0
            C_wmma_accumulator[vi, vj] = C_wmma_accumulator[vi, vj] + T.Cast("int32", A_global_shared_wmma_matrix_a[vi, vk]) * T.Cast("int32", B_global_shared_wmma_matrix_b[vj, vk])
    for ax0, ax1 in T.grid(16384, 16384):
