                    ...
                    for (ax0_0_1: int32, 0, 8) {
                      for (ax1_0_1: int32, 0, 1) {
                        block([1024, 1024], "B_global_shared_wmma.matrix_b_o") as [v0_o_1, v1_o_1] {
                          bind(v0_o_1, (((j_0_0_0*16) + (j_0_1*8)) + ax0_0_1))
                    ...
                    for (i_0_2: int32, 0, 2) {
                      for (j_0_2: int32, 0, 8) {
                        block([1024, 1024, tir.reduce_axis(0, 1024)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                          ...
                          bind(vj_o_1, ((((j_0_0_0*16) + (j_0_0_1*16)) + (j_0_1*8)) + j_0_2))
                          bind(vk_o, ((k_0_0*2) + k_0_1))
                          tir.reads([C_wmma.accumulator[vi_o_1, vj_o_1, 0:16, 0:16], A_global_shared_wmma.matrix_a[vi_o_1, vk_o, 0:16, 0:16], B_global_shared_wmma.matrix_b[vj_o_1, vk_o, 0:16, 0:16]])
                          tir.writes([C_wmma.accumulator[vi_o_1, vj_o_1, 0:16, 0:16]])
                          ...
                          C_8 = match_buffer(C_wmma.accumulator[vi_o_1, vj_o_1, 0:16, 0:16])
                ...
                for (ax0_0_2: int32, 0, 2) {
                  for (ax1_0_2: int32, 0, 8) {
                    block([1024, 1024], "C_wmma.accumulator_o") as [v0_o_2, v1_o_2] {
                      ...
                      bind(v1_o_2, (((j_0_0_0*16) + (j_0_1*8)) + ax1_0_2))
                      tir.reads([C_wmma.accumulator[v0_o_2, v1_o_2, 0:16, 0:16]])
                      tir.writes([C[(v0_o_2*16):((v0_o_2*16) + 16), (v1_o_2*16):((v1_o_2*16) + 16)]])
                      A_8 = match_buffer(C_wmma.accumulator[v0_o_2, v1_o_2, 0:16, 0:16])
