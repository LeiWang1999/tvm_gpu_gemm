          ...
          for (j_0_0_1: int32, 0, 1) "thread_binding" {
            for (i_0_1: int32, 0, 2) "thread_binding" {
              for (j_0_1: int32, 0, 2) "thread_binding" {
                    ...
                    for (ax0_4: int32, 0, 32) {
                      for (ax1_4: int32, 0, 16) {
                        block([16384, 16384], "A_global_shared_wmma.matrix_a") as [v0_4, v1_4] {
                          bind(v0_4, (((i_0_0*64) + (i_0_1*32)) + ax0_4))
                    ...
                    for (ax0_5: int32, 0, 128) {
                      for (ax1_5: int32, 0, 16) {
                        block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_5, v1_5] {
                          bind(v0_5, (((j_0_0_0*256) + (j_0_1*128)) + ax0_5))
                ...
                for (ax0_6: int32, 0, 32) {
                  for (ax1_6: int32, 0, 128) {
                    block([16384, 16384], "C_wmma.accumulator") as [v0_6, v1_6] {
                      bind(v0_6, (((i_0_0*64) + (i_0_1*32)) + ax0_6))
                      bind(v1_6, (((j_0_0_0*256) + (j_0_1*128)) + ax1_6))
