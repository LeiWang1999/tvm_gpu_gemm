            ...
            for j_0_0_1 in T.thread_binding(16, thread="blockIdx.x"):
                for i_0_1 in T.thread_binding(4, thread="threadIdx.y"):
                    for j_0_1 in T.thread_binding(1, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init, i_1_init, j_1_init in T.grid(2, 16, 16, 16):
                            with T.block("B_init"):
                                vi = T.axis.spatial(16384, i_0_0 * 128 + i_0_1 * 32 + i_0_2_init * 16 + i_1_init)
                                vj = T.axis.spatial(16384, j_0_0_0 * 4096 + j_0_0_1 * 256 + j_0_1 * 256 + j_0_2_init * 16 + j_1_init)
                                T.reads()
                            ...
                            for k_0_1 in T.serial(2):
                                for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(2, 1, 16, 16):
                                    with T.block("A_shared_warp"):
                                        ...
                                        T.writes(A_shared_warp[v0 // 16, v1 // 16, v0 % 16 * 2 + v1 % 16 // 8, v1 % 8])
                                        A_shared_warp[v0 // 16, v1 // 16, v0 % 16 * 2 + v1 % 16 // 8, v1 % 8] = A_shared[v0 // 16, v1 // 16, v0 % 16, v1 % 16]
