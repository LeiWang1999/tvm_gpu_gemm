                            ...
                            for k_0_1 in T.serial(2):
                                ...
                                for ax0_0, ax1_0 in T.grid(1, 16):
                                    with T.block("B_shared_warp_o"):
                                        v0_o = T.axis.spatial(1024, k_0_0 * 2 + k_0_1)
                                        v1_o = T.axis.spatial(1024, j_0_0_0 * 256 + j_0_0_1 * 16 + ax1_0)
                                        T.reads(B_shared[v0_o, v1_o, 0 : 16, 0 : 16])
                                        ...
                                        shared_1 = T.match_buffer(B_shared[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="float16", strides=[shared_s0_1, shared_s1_1], scope="shared", offset_factor=16)
                                        T.launch_thread(tx, 32)
                                        T.ptx_ldmatrix(True, 4, ".b16", warp_1.data, warp_1.elem_offset + 8 * tx, T.tvm_access_ptr(T.type_annotation(dtype="float16"), shared_1.data, shared_1.elem_offset, shared_s0_1 * 16, 1, dtype="handle"), 8 * tx, dtype="float16")
                                for i_0_2, j_0_2 in T.grid(2, 16):
                                    with T.block("B_update_o"):
                                        vi_o = T.axis.spatial(1024, i_0_0 * 8 + i_0_1 * 2 + i_0_2)
                                        vj_o = T.axis.spatial(1024, j_0_0_0 * 256 + j_0_0_1 * 16 + j_0_2)
