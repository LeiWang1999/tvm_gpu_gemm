          ...
          for (i_0_1: int32, 0, 4) "thread_binding" {
            for (j_0_1: int32, 0, 1) "thread_binding" {
                    ...
                    for (ax0_1: int32, 0, 16) {
                      for (ax1_1: int32, 0, 16) {
                        block([16384, 16384], "A_shared") as [v0, v1] {
                          bind(v0, (((i_0_0*128) + (ax0_0*16)) + ax0_1))
                          bind(v1, (((k_0_0*32) + (ax1_0*16)) + ax1_1))
                          tir.reads([A[v0, v1]])
                          tir.writes([A_shared[floordiv(v0, 16), floordiv(v1, 16), floormod(v0, 16), floormod(v1, 16)]])
                          A_shared[floordiv(v0, 16), floordiv(v1, 16), floormod(v0, 16), floormod(v1, 16)] = A[v0, v1]
                      }
                    }
                  }
                }
                    ...
                    for (ax0_1_1: int32, 0, 16) {
                      for (ax1_1_1: int32, 0, 16) {
                        block([16384, 16384], "B_shared") as [v0_1, v1_1] {
                          ...
                          bind(v1_1, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (ax1_0_1*16)) + ax1_1_1))
                          tir.reads([B[v0_1, v1_1]])
                          tir.writes([B_shared[floordiv(v0_1, 16), floordiv(v1_1, 16), floormod(v0_1, 16), floormod(v1_1, 16)]])
                          B_shared[floordiv(v0_1, 16), floordiv(v1_1, 16), floormod(v0_1, 16), floormod(v1_1, 16)] = B[v0_1, v1_1]
                      }
                    }
                  }
                }
                      ...
                      for (ax0_1_2: int32, 0, 16) {
                        for (ax1_1_2: int32, 0, 16) {
                          block([16384, 16384], "A_shared_warp") as [v0_2, v1_2] {
                            bind(v0_2, ((((i_0_0*128) + (i_0_1*32)) + (ax0_0_2*16)) + ax0_1_2))
                            bind(v1_2, ((((k_0_0*32) + (k_0_1*16)) + (ax1_0_2*16)) + ax1_1_2))
                      ...
                      for (ax0_1_3: int32, 0, 16) {
                        for (ax1_1_3: int32, 0, 16) {
                          block([16384, 16384], "B_shared_warp") as [v0_3, v1_3] {
                            ...
                            bind(v1_3, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (ax1_0_3*16)) + ax1_1_3))
              ...
              for (ax0_0_4: int32, 0, 2) {
                for (ax1_0_4: int32, 0, 16) {
                  for (ax0_1_4: int32, 0, 16) {
                    for (ax1_1_4: int32, 0, 16) {
                      block([16384, 16384], "C_warp") as [v0_4, v1_4] {
                        bind(v0_4, ((((i_0_0*128) + (i_0_1*32)) + (ax0_0_4*16)) + ax0_1_4))
                        bind(v1_4, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (ax1_0_4*16)) + ax1_1_4))
