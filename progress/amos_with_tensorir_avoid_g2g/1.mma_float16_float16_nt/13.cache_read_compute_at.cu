                ...
                for (ax0: int32, 0, 128) {
                  for (ax1: int32, 0, 32) {
                    block([16384, 16384], "A_shared") as [v0, v1] {
                      bind(v0, ((i_0_0*128) + ax0))
                      bind(v1, ((k_0_0*32) + ax1))
                      tir.reads([A[v0, v1]])
                ...
                for (ax0_1: int32, 0, 32) {
                  for (ax1_1: int32, 0, 256) {
                    block([16384, 16384], "B_shared") as [v0_1, v1_1] {
                      bind(v0_1, ((k_0_0*32) + ax0_1))
                      bind(v1_1, (((j_0_0_0*4096) + (j_0_0_1*256)) + ax1_1))
                  ...
                  for (ax0_2: int32, 0, 32) {
                    for (ax1_2: int32, 0, 16) {
                      block([16384, 16384], "A_shared_warp") as [v0_2, v1_2] {
                        bind(v0_2, (((i_0_0*128) + (i_0_1*32)) + ax0_2))
                        bind(v1_2, (((k_0_0*32) + (k_0_1*16)) + ax1_2))
                  ...
                  for (ax0_3: int32, 0, 16) {
                    for (ax1_3: int32, 0, 256) {
                      block([16384, 16384], "B_shared_warp") as [v0_3, v1_3] {
                        bind(v0_3, (((k_0_0*32) + (k_0_1*16)) + ax0_3))
                        bind(v1_3, (((j_0_0_0*4096) + (j_0_0_1*256)) + ax1_3))
              ...
              for (ax0_4: int32, 0, 32) {
                for (ax1_4: int32, 0, 256) {
                  block([16384, 16384], "C_warp") as [v0_4, v1_4] {
                    bind(v0_4, (((i_0_0*128) + (i_0_1*32)) + ax0_4))
                    bind(v1_4, (((j_0_0_0*4096) + (j_0_0_1*256)) + ax1_4))
