                    ...
                    for (ax1_0_1: int32, 0, 16) {
                      for (ax0_1: int32, 0, 16) {
                        for (ax1_1: int32, 0, 16) {
                          block([16384, 16384], "B_shared_warp") as [v0_2, v1_2] {
                            bind(v0_2, ((((k_0_0*32) + (k_0_1*16)) + (ax0_0_1*16)) + ax0_1))
                            bind(v1_2, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (ax1_0_1*16)) + ax1_1))
                            tir.reads([B_shared[floordiv(v0_2, 16), floordiv(v1_2, 16), floormod(v0_2, 16), floormod(v1_2, 16)]])
                            tir.writes([B_shared_warp[floordiv(v0_2, 16), floordiv(v1_2, 16), ((floormod(v0_2, 16)*2) + floordiv(floormod(v1_2, 16), 8)), floormod(v1_2, 8)]])
                            B_shared_warp[floordiv(v0_2, 16), floordiv(v1_2, 16), ((floormod(v0_2, 16)*2) + floordiv(floormod(v1_2, 16), 8)), floormod(v1_2, 8)] = B_shared[floordiv(v0_2, 16), floordiv(v1_2, 16), floormod(v0_2, 16), floormod(v1_2, 16)]
                        }
                      }
                    }
                  }
                ...
                for (ax1_0_2: int32, 0, 16) {
                  for (ax0_1_1: int32, 0, 16) {
                    for (ax1_1_1: int32, 0, 16) {
                      block([16384, 16384], "C_warp") as [v0_3, v1_3] {
                        bind(v0_3, ((((i_0_0*128) + (i_0_1*32)) + (ax0_0_2*16)) + ax0_1_1))
                        bind(v1_3, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (ax1_0_2*16)) + ax1_1_1))
                        tir.reads([C_warp[floordiv(v0_3, 16), floordiv(v1_3, 16), ((floormod(v0_3, 8)*4) + floordiv(floormod(v1_3, 8), 2)), (((floordiv(floormod(v1_3, 16), 8)*4) + (floordiv(floormod(v0_3, 16), 8)*2)) + floormod(v1_3, 2))]])
                        tir.writes([C[v0_3, v1_3]])
                        C[v0_3, v1_3] = C_warp[floordiv(v0_3, 16), floordiv(v1_3, 16), ((floormod(v0_3, 8)*4) + floordiv(floormod(v1_3, 8), 2)), (((floordiv(floormod(v1_3, 16), 8)*4) + (floordiv(floormod(v0_3, 16), 8)*2)) + floormod(v1_3, 2))]
                    }
                  }
                }
              }
