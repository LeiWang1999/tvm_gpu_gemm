                  ...
                  for (i_1_init: int32, 0, 16) {
                    for (j_1_init: int32, 0, 16) {
                      block([16384, 16384], "B_init") as [vi, vj] {
                        ...
                        bind(vj, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*256)) + (j_0_2_init*16)) + j_1_init))
                        tir.reads([])
                        ...
                        for (j_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                              ...
                              bind(vj_1, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*256)) + (j_0_2*16)) + j_1))
                              bind(vk, (((k_0_0*32) + (k_0_1*16)) + k_1))
                              tir.reads([C_warp[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)], A_shared_warp[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)], B_shared_warp[floordiv(vk, 16), floordiv(vj_1, 16), floormod(vk, 16), floormod(vj_1, 16)]])
                              tir.writes([C_warp[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)]])
                              C_warp[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] = (C_warp[floordiv(vi_1, 16), floordiv(vj_1, 16), floormod(vi_1, 16), floormod(vj_1, 16)] + (A_shared_warp[floordiv(vi_1, 16), floordiv(vk, 16), floormod(vi_1, 16), floormod(vk, 16)]*B_shared_warp[floordiv(vk, 16), floordiv(vj_1, 16), floormod(vk, 16), floormod(vj_1, 16)]))
                          }
                        }
                      }
                    }
