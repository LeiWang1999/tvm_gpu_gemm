    ...
    C_global_wmma.accumulator = alloc_buffer(int32[1024, 1024, 16, 16])
     {
                      ...
                      for (ax0_1_1: int32, 0, 16) {
                        for (ax1_1_1: int32, 0, 16) {
                          block([16384, 16384], "B_global_shared_wmma.matrix_b") as [v0_4, v1_4] {
                            bind(v0_4, ((((j_0_0*256) + (j_0_1*128)) + (ax0_0_1*16)) + ax0_1_1))
                        ...
                        for (j_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi, vj, vk] {
                              ...
                              tir.reads([C_global_wmma.accumulator[floordiv(vi, 16), floordiv(vj, 16), floormod(vi, 16), floormod(vj, 16)], A_global_shared_wmma.matrix_a[floordiv(vi, 16), floordiv(vk, 16), floormod(vi, 16), floormod(vk, 16)], B_global_shared_wmma.matrix_b[floordiv(vj, 16), floordiv(vk, 16), floormod(vj, 16), floormod(vk, 16)]])
                ...
                for (ax1_0_2: int32, 0, 8) {
                  for (ax0_1_2: int32, 0, 16) {
                    for (ax1_1_2: int32, 0, 16) {
                      block([16384, 16384], "C_global_wmma.accumulator") as [v0_5, v1_5] {
                        bind(v0_5, ((((i_0_0*64) + (i_0_1*32)) + (ax0_0_2*16)) + ax0_1_2))
                        bind(v1_5, ((((j_0_0*256) + (j_0_1*128)) + (ax1_0_2*16)) + ax1_1_2))
                        tir.reads([C_global_wmma.accumulator[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]])
                        tir.writes([C_global[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]])
                        C_global[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)] = C_global_wmma.accumulator[floordiv(v0_5, 16), floordiv(v1_5, 16), floormod(v0_5, 16), floormod(v1_5, 16)]
                    }
                  }
                }
              }
      ...
      for (ax0_2: int32, 0, 16384) {
        for (ax1_2: int32, 0, 16384) {
          block([16384, 16384], "C_global") as [v0_6, v1_6] {
            bind(v0_6, ax0_2)
            bind(v1_6, ax1_2)
            tir.reads([C_global[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]])
            tir.writes([C[v0_6, v1_6]])
            C[v0_6, v1_6] = C_global[floordiv(v0_6, 16), floordiv(v1_6, 16), floormod(v0_6, 16), floormod(v1_6, 16)]
        }
      }
    }
}
