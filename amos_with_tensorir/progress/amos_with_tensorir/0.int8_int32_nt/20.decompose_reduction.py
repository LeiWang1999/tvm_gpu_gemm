        ...
        for j_0_0 in T.thread_binding(64, thread="blockIdx.y"):
            for i_0_1 in T.thread_binding(2, thread="threadIdx.y"):
                for j_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                    for i_0_2_init, j_0_2_init, i_1_init, j_1_init in T.grid(2, 8, 16, 16):
                        with T.block("B_init"):
                            vi = T.axis.spatial(16384, i_0_0 * 64 + i_0_1 * 32 + i_0_2_init * 16 + i_1_init)
                            vj = T.axis.spatial(16384, j_0_0 * 256 + j_0_1 * 128 + j_0_2_init * 16 + j_1_init)
                            T.reads()
                            T.writes(C_global_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16])
                            C_global_wmma_accumulator[vi // 16, vj // 16, vi % 16, vj % 16] = 0
