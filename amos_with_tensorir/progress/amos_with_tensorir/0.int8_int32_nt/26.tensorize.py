...
def func(A: T.Buffer[(16384, 16384), "int8"], B: T.Buffer[(16384, 16384), "int8"], C: T.Buffer[(16384, 16384), "int32"]):
    ...
    C_global_wmma_accumulator = T.alloc_buffer([1024, 1024, 16, 16], dtype="int32", scope="wmma.accumulator")
    ...
    for i_0_0 in T.thread_binding(256, thread="blockIdx.x"):
        for j_0_0 in T.thread_binding(64, thread="blockIdx.y"):
            for i_0_1 in T.thread_binding(2, thread="threadIdx.y"):
                for j_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                    for i_0_2_init, j_0_2_init in T.grid(2, 8):
                        with T.block("B_init_o"):
                            vi_o = T.axis.spatial(1024, i_0_0 * 4 + i_0_1 * 2 + i_0_2_init)
                            vj_o = T.axis.spatial(1024, j_0_0 * 16 + j_0_1 * 8 + j_0_2_init)
                            T.reads()
                            T.writes(C_global_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                            C_1 = T.match_buffer(C_global_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0, C_s1], scope="wmma.accumulator", offset_factor=16)
                                    ...
                                    for ax0_ax1_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                        for ax0_ax1_fused_4 in T.vectorized(16):
                                            with T.block("A_global_shared"):
                                                v0 = T.axis.spatial(16384, i_0_0 * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 512 + ax0_ax1_fused_2 * 512 + ax0_ax1_fused_3 * 16 + ax0_ax1_fused_4) // 32)
                                                v1 = T.axis.spatial(16384, k_0_0 * 32 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 512 + ax0_ax1_fused_2 * 512 + ax0_ax1_fused_3 * 16 + ax0_ax1_fused_4) % 32)
                                    ...
                                    for ax0_ax1_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                        for ax0_ax1_fused_4 in T.vectorized(16):
                                            with T.block("B_global_shared"):
                                                v0 = T.axis.spatial(16384, j_0_0 * 256 + (ax0_ax1_fused_0 * 4096 + ax0_ax1_fused_1 * 2048 + ax0_ax1_fused_2 * 512 + ax0_ax1_fused_3 * 16 + ax0_ax1_fused_4) // 32)
                                                v1 = T.axis.spatial(16384, k_0_0 * 32 + (ax0_ax1_fused_0 * 4096 + ax0_ax1_fused_1 * 2048 + ax0_ax1_fused_2 * 512 + ax0_ax1_fused_3 * 16 + ax0_ax1_fused_4) % 32)
                        ...
                        for k_0_1 in T.serial(2):
                            for ax0_0, ax1_0 in T.grid(2, 1):
                                with T.block("A_global_shared_wmma.matrix_a_o"):
                                    v0_o = T.axis.spatial(1024, i_0_0 * 4 + i_0_1 * 2 + ax0_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(8, 1):
                                with T.block("B_global_shared_wmma.matrix_b_o"):
                                    v0_o = T.axis.spatial(1024, j_0_0 * 16 + j_0_1 * 8 + ax0_0)
                                    v1_o = T.axis.spatial(1024, k_0_0 * 2 + k_0_1)
                            ...
                            for i_0_2, j_0_2 in T.grid(2, 8):
                                with T.block("B_update_o"):
                                    vi_o = T.axis.spatial(1024, i_0_0 * 4 + i_0_1 * 2 + i_0_2)
                                    vj_o = T.axis.spatial(1024, j_0_0 * 16 + j_0_1 * 8 + j_0_2)
                                    vk_o = T.axis.reduce(1024, k_0_0 * 2 + k_0_1)
                                    T.reads(C_global_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], A_global_shared_wmma_matrix_a[vi_o, vk_o, 0 : 16, 0 : 16], B_global_shared_wmma_matrix_b[vj_o, vk_o, 0 : 16, 0 : 16])
                                    T.writes(C_global_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16])
                                    ...
                                    C_4 = T.match_buffer(C_global_wmma_accumulator[vi_o, vj_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0_3, C_s1_3], scope="wmma.accumulator", offset_factor=16)
                    ...
                    for ax0_0, ax1_0 in T.grid(2, 8):
                        with T.block("C_global_wmma.accumulator_o"):
                            v0_o = T.axis.spatial(1024, i_0_0 * 4 + i_0_1 * 2 + ax0_0)
                            v1_o = T.axis.spatial(1024, j_0_0 * 16 + j_0_1 * 8 + ax1_0)
                            T.reads(C_global_wmma_accumulator[v0_o, v1_o, 0 : 16, 0 : 16])
                            T.writes(C_global[v0_o, v1_o, 0 : 16, 0 : 16])
                            A_4 = T.match_buffer(C_global_wmma_accumulator[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[A_s0_3, A_s1_3], scope="wmma.accumulator", offset_factor=16)
                            C_5 = T.match_buffer(C_global[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="int32", strides=[C_s0_4, C_s1_4], offset_factor=16)
