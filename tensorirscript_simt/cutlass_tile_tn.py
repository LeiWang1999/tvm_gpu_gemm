...
log_path = "progress/tensorir_script/cutlass_tile_tn"
count = 0
...
A_shared_outer, A_shared_ty, A_shared_tx, A_shared_vi = sch.split(
    A_shared_fused, factors=[None, block_row_warps, block_col_warps, vec])
...
sch.annotate(ko, ann_key="thread_rasterization", ann_val=1)
