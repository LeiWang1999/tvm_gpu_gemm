...
BACKEND=c-cuda STEP=1000 COMPUTE_V1='- einstein_v2("output0[M // 16, N // 16, M % 16, N % 16] =. input0[M, N]", input_dict={"input0": {"dtype": "float32", "shape": [384, 1024]}, "output0": {"dtype": "float32", "shape": [24, 64, 16, 16]}})' antares save ./weight_permutation.cu
