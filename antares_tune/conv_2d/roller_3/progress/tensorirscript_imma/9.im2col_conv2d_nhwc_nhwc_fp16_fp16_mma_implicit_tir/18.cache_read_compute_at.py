                ...
                for y_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                    for k_0_0 in T.serial(32):
                        for ax0, ax1 in T.grid(256, 32):
                            with T.block("data_im2col_shared"):
                                v0 = T.axis.spatial(225792, x_0_0 * 256 + ax0)
                                v1 = T.axis.spatial(1024, k_0_0 * 32 + ax1)
                        ...
                        for ax0, ax1 in T.grid(128, 32):
                            with T.block("weight_flatten_shared"):
                                v0 = T.axis.spatial(384, y_0_0 * 128 + ax0)
                                v1 = T.axis.spatial(1024, k_0_0 * 32 + ax1)
                        ...
                        for k_0_1 in T.serial(2):
                            for ax0, ax1 in T.grid(64, 16):
                                with T.block("data_im2col_shared_warp"):
                                    v0 = T.axis.spatial(225792, x_0_0 * 256 + x_0_1 * 64 + ax0)
                                    v1 = T.axis.spatial(1024, k_0_0 * 32 + k_0_1 * 16 + ax1)
                            ...
                            for ax0, ax1 in T.grid(64, 16):
                                with T.block("weight_flatten_shared_warp"):
                                    v0 = T.axis.spatial(384, y_0_0 * 128 + y_0_1 * 64 + ax0)
                                    v1 = T.axis.spatial(1024, k_0_0 * 32 + k_0_1 * 16 + ax1)
                    ...
                    for ax0, ax1 in T.grid(64, 64):
                        with T.block("Conv_warp"):
                            v0 = T.axis.spatial(225792, x_0_0 * 256 + x_0_1 * 64 + ax0)
                            v1 = T.axis.spatial(384, y_0_0 * 128 + y_0_1 * 64 + ax1)
