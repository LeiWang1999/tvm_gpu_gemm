                        ...
                        for k_0_1 in T.serial(2):
                            ...
                            for x_0_2, y_0_2, x_1, y_1, k_1 in T.grid(4, 4, 16, 16, 16):
                                with T.block("Conv_update"):
                                    ...
                                    T.reads(Conv_warp[v_x // 16, v_y // 16, v_x % 16, v_y % 16], data_im2col_shared_warp[v_x // 16, v_k // 16, v_x % 16, v_k % 16], weight_flatten_shared_warp[v_y // 16, v_k // 16, v_y % 16, v_k % 16])
                                    T.writes(Conv_warp[v_x // 16, v_y // 16, v_x % 16, v_y % 16])
