      ...
      for (ax0_2: int32, 0, 384) {
        for (ax1_2: int32, 0, 1024) {
          block([384, 1024], "weight_flatten_shared") as [v0_2, v1_2] {
            ...
            weight_flatten_shared[v0_2, v1_2] = W[v0_2, floordiv(floordiv(v1_2, 1024), 1), floormod(floordiv(v1_2, 1024), 1), floormod(v1_2, 1024)]
        }
      }
        ...
        for (y: int32, 0, 384) {
          for (k: int32, 0, 1024) {
            block([225792, 384, tir.reduce_axis(0, 1024)], "Conv") as [v_x, v_y, v_k] {
              ...
              bind(v_y, y)
              bind(v_k, k)
              tir.reads([data_im2col_shared_warp[v_x, v_k], weight_flatten_shared_warp[v_y, v_k]])
