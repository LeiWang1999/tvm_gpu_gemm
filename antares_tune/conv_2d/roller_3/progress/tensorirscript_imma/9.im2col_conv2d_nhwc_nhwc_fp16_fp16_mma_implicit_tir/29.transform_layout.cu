                ...
                for (x_1_init: int32, 0, 16) {
                  for (y_1_init: int32, 0, 16) {
                    block([225792, 384], "Conv_init") as [v_x, v_y] {
                      ...
                      Conv_warp[floordiv(v_x, 16), floordiv(v_y, 16), ((floormod(v_x, 8)*4) + floordiv(floormod(v_y, 8), 2)), (((floordiv(floormod(v_y, 16), 8)*4) + (floordiv(floormod(v_x, 16), 8)*2)) + floormod(v_y, 2))] = 0f16
                  }
                }
              }
            }
                    ...
                    for (ax0_1: int32, 0, 16) {
                      for (ax1_1: int32, 0, 16) {
                        block([225792, 1024], "data_im2col_shared_warp") as [v0_2, v1_2] {
                          ...
                          tir.writes([data_im2col_shared_warp[floordiv(v0_2, 16), floordiv(v1_2, 16), ((floormod(v0_2, 16)*2) + floordiv(floormod(v1_2, 16), 8)), floormod(v1_2, 8)]])
                          data_im2col_shared_warp[floordiv(v0_2, 16), floordiv(v1_2, 16), ((floormod(v0_2, 16)*2) + floordiv(floormod(v1_2, 16), 8)), floormod(v1_2, 8)] = data_im2col_shared[floordiv(v0_2, 16), floordiv(v1_2, 16), floormod(v0_2, 16), floormod(v1_2, 16)]
                      }
                    }
                  }
                }
                    ...
                    for (ax0_1_1: int32, 0, 16) {
                      for (ax1_1_1: int32, 0, 16) {
                        block([384, 1024], "weight_flatten_shared_warp") as [v0_3, v1_3] {
                          ...
                          tir.writes([weight_flatten_shared_warp[floordiv(v0_3, 16), floordiv(v1_3, 16), ((floormod(v0_3, 16)*2) + floordiv(floormod(v1_3, 16), 8)), floormod(v1_3, 8)]])
                          weight_flatten_shared_warp[floordiv(v0_3, 16), floordiv(v1_3, 16), ((floormod(v0_3, 16)*2) + floordiv(floormod(v1_3, 16), 8)), floormod(v1_3, 8)] = weight_flatten_shared[floordiv(v0_3, 16), floordiv(v1_3, 16), floormod(v0_3, 16), floormod(v1_3, 16)]
                      }
                    }
                  }
                }
                      ...
                      for (y_1: int32, 0, 16) {
                        for (k_1: int32, 0, 16) {
                          block([225792, 384, tir.reduce_axis(0, 1024)], "Conv_update") as [v_x_1, v_y_1, v_k] {
                            ...
                            tir.reads([Conv_warp[floordiv(v_x_1, 16), floordiv(v_y_1, 16), ((floormod(v_x_1, 8)*4) + floordiv(floormod(v_y_1, 8), 2)), (((floordiv(floormod(v_y_1, 16), 8)*4) + (floordiv(floormod(v_x_1, 16), 8)*2)) + floormod(v_y_1, 2))], data_im2col_shared_warp[floordiv(v_x_1, 16), floordiv(v_k, 16), ((floormod(v_x_1, 16)*2) + floordiv(floormod(v_k, 16), 8)), floormod(v_k, 8)], weight_flatten_shared_warp[floordiv(v_y_1, 16), floordiv(v_k, 16), ((floormod(v_y_1, 16)*2) + floordiv(floormod(v_k, 16), 8)), floormod(v_k, 8)]])
                            tir.writes([Conv_warp[floordiv(v_x_1, 16), floordiv(v_y_1, 16), ((floormod(v_x_1, 8)*4) + floordiv(floormod(v_y_1, 8), 2)), (((floordiv(floormod(v_y_1, 16), 8)*4) + (floordiv(floormod(v_x_1, 16), 8)*2)) + floormod(v_y_1, 2))]])
                            Conv_warp[floordiv(v_x_1, 16), floordiv(v_y_1, 16), ((floormod(v_x_1, 8)*4) + floordiv(floormod(v_y_1, 8), 2)), (((floordiv(floormod(v_y_1, 16), 8)*4) + (floordiv(floormod(v_x_1, 16), 8)*2)) + floormod(v_y_1, 2))] = (Conv_warp[floordiv(v_x_1, 16), floordiv(v_y_1, 16), ((floormod(v_x_1, 8)*4) + floordiv(floormod(v_y_1, 8), 2)), (((floordiv(floormod(v_y_1, 16), 8)*4) + (floordiv(floormod(v_x_1, 16), 8)*2)) + floormod(v_y_1, 2))] + (data_im2col_shared_warp[floordiv(v_x_1, 16), floordiv(v_k, 16), ((floormod(v_x_1, 16)*2) + floordiv(floormod(v_k, 16), 8)), floormod(v_k, 8)]*weight_flatten_shared_warp[floordiv(v_y_1, 16), floordiv(v_k, 16), ((floormod(v_y_1, 16)*2) + floordiv(floormod(v_k, 16), 8)), floormod(v_k, 8)]))
                        }
                      }
                    }
                  }
                ...
                for (ax0_1_2: int32, 0, 16) {
                  for (ax1_1_2: int32, 0, 16) {
                    block([225792, 384], "Conv_warp") as [v0_4, v1_4] {
                      ...
                      tir.reads([Conv_warp[floordiv(v0_4, 16), floordiv(v1_4, 16), ((floormod(v0_4, 8)*4) + floordiv(floormod(v1_4, 8), 2)), (((floordiv(floormod(v1_4, 16), 8)*4) + (floordiv(floormod(v0_4, 16), 8)*2)) + floormod(v1_4, 2))]])
                      tir.writes([Conv[v0_4, v1_4]])
                      Conv[v0_4, v1_4] = Conv_warp[floordiv(v0_4, 16), floordiv(v1_4, 16), ((floormod(v0_4, 8)*4) + floordiv(floormod(v1_4, 8), 2)), (((floordiv(floormod(v1_4, 16), 8)*4) + (floordiv(floormod(v0_4, 16), 8)*2)) + floormod(v1_4, 2))]
                  }
                }
              }
            }
