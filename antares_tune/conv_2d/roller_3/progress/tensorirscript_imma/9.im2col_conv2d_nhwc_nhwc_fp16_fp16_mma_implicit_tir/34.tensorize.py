                ...
                for y_0_1 in T.thread_binding(2, thread="threadIdx.z"):
                        ...
                        for k_0_1 in T.serial(2):
                            ...
                            for ax0_0, ax1_0 in T.grid(4, 1):
                                with T.block("weight_flatten_shared_warp_o"):
                                    ...
                                    v1_o = T.axis.spatial(64, k_0_0 * 2 + k_0_1 + ax1_0)
                                    T.reads(weight_flatten_shared[v0_o, v1_o, 0 : 16, 0 : 16])
                                    T.writes(weight_flatten_shared_warp[v0_o, v1_o, 0 : 32, 0 : 8])
                                    warp_1 = T.match_buffer(weight_flatten_shared_warp[v0_o, v1_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=16)
                                    shared_1 = T.match_buffer(weight_flatten_shared[v0_o, v1_o, 0 : 16, 0 : 16], [16, 16], dtype="float16", strides=[shared_s0_1, shared_s1_1], scope="shared", offset_factor=16)
                            ...
                            for x_0_2, y_0_2 in T.grid(4, 4):
                                with T.block("Conv_update_o"):
                                    ...
                                    v_k_o = T.axis.reduce(64, k_0_0 * 2 + k_0_1)
                                    T.reads(Conv_warp[v_x_o, v_y_o, 0 : 32, 0 : 8], data_im2col_shared_warp[v_x_o, v_k_o, 0 : 32, 0 : 8], weight_flatten_shared_warp[v_y_o, v_k_o, 0 : 32, 0 : 8])
                                    T.writes(Conv_warp[v_x_o, v_y_o, 0 : 32, 0 : 8])
                                    A_1 = T.match_buffer(data_im2col_shared_warp[v_x_o, v_k_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=16)
                                    B = T.match_buffer(weight_flatten_shared_warp[v_y_o, v_k_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=16)
                                    C = T.match_buffer(Conv_warp[v_x_o, v_y_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=16)
                                    T.launch_thread(tx_3, 32)
                                    T.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1.data, A_1.elem_offset + tx_3 * 8, B.data, B.elem_offset + tx_3 * 8, C.data, C.elem_offset + tx_3 * 8, False, dtype="float16")
                                    T.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1.data, A_1.elem_offset + tx_3 * 8, B.data, B.elem_offset + tx_3 * 8 + T.FloorDiv(8, 2), C.data, C.elem_offset + tx_3 * 8 + T.FloorDiv(8, 2), False, dtype="float16")
                    for ax0_0, ax1_0 in T.grid(4, 4):
                        with T.block("Conv_warp_o"):
                            ...
                            C_warp_1 = T.match_buffer(Conv_warp[v0_o, v1_o, 0 : 32, 0 : 8], [32, 8], dtype="float16", scope="warp", offset_factor=1)
                            C_1 = T.match_buffer(Conv[v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16], [16, 16], dtype="float16", strides=[C_s0, C_s1], offset_factor=1)
