                        ...
                        for k_0_0 in T.serial(256):
                            for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(8, 2, 16, 16):
                                with T.block("A_global_shared"):
                                    ...
                                    v1 = T.axis.spatial(8192, k_0_0 * 32 + ax1_0 * 16 + ax1_1)
                            ...
                            for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(2, 16, 16, 16):
                                with T.block("B_global_shared"):
                                    v0 = T.axis.spatial(8192, k_0_0 * 32 + ax0_0 * 16 + ax0_1)
                                    v1 = T.axis.spatial(8192, j_0_0_0 * 4096 + j_0_0_1 * 256 + ax1_0 * 16 + ax1_1)
