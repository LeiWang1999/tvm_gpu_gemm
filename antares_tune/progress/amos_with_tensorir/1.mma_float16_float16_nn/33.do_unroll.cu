...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    A_global_shared_warp = alloc_buffer(float16[512, 512, 32, 8])
    B_global = alloc_buffer(float16[512, 512, 16, 16])
    B_global_shared = alloc_buffer(float16[512, 512, 16, 16])
    B_global_shared_warp = alloc_buffer(float16[512, 512, 32, 8])
    C_warp = alloc_buffer(float16[512, 512, 32, 8])
     {
      for (ax0_ax1_fused_0: int32, 0, 256) "thread_binding" {
        for (ax0_ax1_fused_1: int32, 0, 256) "thread_binding" {
          for (ax0_ax1_fused_2: int32, 0, 1) "thread_binding" {
            for (ax0_ax1_fused_3: int32, 0, 2) "thread_binding" {
              for (ax0_ax1_fused_4: int32, 0, 8) "thread_binding" {
                for (ax0_ax1_fused_5: int32, 0, 32) {
                  for (ax0_ax1_fused_6: int32, 0, 2) "vectorized" {
                    block([8192, 8192], "B_global") as [v0, v1] {
                      bind(v0, floordiv((((((((ax0_ax1_fused_0*262144) + (ax0_ax1_fused_1*1024)) + (ax0_ax1_fused_2*1024)) + (ax0_ax1_fused_3*512)) + (ax0_ax1_fused_4*64)) + (ax0_ax1_fused_5*2)) + ax0_ax1_fused_6), 8192))
                      bind(v1, floormod((((((((ax0_ax1_fused_0*262144) + (ax0_ax1_fused_1*1024)) + (ax0_ax1_fused_2*1024)) + (ax0_ax1_fused_3*512)) + (ax0_ax1_fused_4*64)) + (ax0_ax1_fused_5*2)) + ax0_ax1_fused_6), 8192))
                      tir.reads([B[v0, v1]])
      ...
      for (ax0_ax1_fused_0_1: int32, 0, 256) "thread_binding" {
        for (ax0_ax1_fused_1_1: int32, 0, 256) "thread_binding" {
          for (ax0_ax1_fused_2_1: int32, 0, 1) "thread_binding" {
            for (ax0_ax1_fused_3_1: int32, 0, 2) "thread_binding" {
              for (ax0_ax1_fused_4_1: int32, 0, 8) "thread_binding" {
                for (ax0_ax1_fused_5_1: int32, 0, 32) {
                  for (ax0_ax1_fused_6_1: int32, 0, 2) "vectorized" {
                    block([8192, 8192], "A_global") as [v0_1, v1_1] {
                      bind(v0_1, floordiv((((((((ax0_ax1_fused_0_1*262144) + (ax0_ax1_fused_1_1*1024)) + (ax0_ax1_fused_2_1*1024)) + (ax0_ax1_fused_3_1*512)) + (ax0_ax1_fused_4_1*64)) + (ax0_ax1_fused_5_1*2)) + ax0_ax1_fused_6_1), 8192))
                      bind(v1_1, floormod((((((((ax0_ax1_fused_0_1*262144) + (ax0_ax1_fused_1_1*1024)) + (ax0_ax1_fused_2_1*1024)) + (ax0_ax1_fused_3_1*512)) + (ax0_ax1_fused_4_1*64)) + (ax0_ax1_fused_5_1*2)) + ax0_ax1_fused_6_1), 8192))
              ...
              for (j_0_1: int32, 0, 4) "thread_binding" {
                for (i_0_2_init: int32, 0, 8) {
                  for (j_0_2_init: int32, 0, 4) {
                    block([512, 512], "B_init_o") as [vi_o, vj_o] {
                      bind(vi_o, (((i_0_0*8) + (i_0_1*8)) + i_0_2_init))
                      bind(vj_o, ((((j_0_0_0*256) + (j_0_0_1*16)) + (j_0_1*4)) + j_0_2_init))
                      tir.reads([])
                ...
                for (k_0_0: int32, 0, 256) {
                  ...
                  for (k_0_1: int32, 0, 2) {
                    for (ax0_0: int32, 0, 8) {
                      for (ax1_0: int32, 0, 1) {
                        block([512, 512], "A_global_shared_warp_o") as [v0_o, v1_o] {
                    ...
                    for (ax0_0_1: int32, 0, 1) {
                      for (ax1_0_1: int32, 0, 4) {
                        block([512, 512], "B_global_shared_warp_o") as [v0_o_1, v1_o_1] {
                          bind(v0_o_1, (((k_0_0*2) + k_0_1) + ax0_0_1))
                          bind(v1_o_1, ((((j_0_0_0*256) + (j_0_0_1*16)) + (j_0_1*4)) + ax1_0_1))
                    ...
                    for (i_0_2: int32, 0, 8) {
                      for (j_0_2: int32, 0, 4) {
                        block([512, 512, tir.reduce_axis(0, 512)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                          bind(vi_o_1, (((i_0_0*8) + (i_0_1*8)) + i_0_2))
                          bind(vj_o_1, ((((j_0_0_0*256) + (j_0_0_1*16)) + (j_0_1*4)) + j_0_2))
                ...
                for (ax0_0_2: int32, 0, 8) {
                  for (ax1_0_2: int32, 0, 4) {
                    block([512, 512], "C_warp_o") as [v0_o_2, v1_o_2] {
                      bind(v0_o_2, ((i_0_0*8) + ax0_0_2))
                      bind(v1_o_2, ((((j_0_0_0*256) + (j_0_0_1*16)) + (j_0_1*4)) + ax1_0_2))
