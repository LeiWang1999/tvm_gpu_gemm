...
def func(A: T.Buffer[(8192, 8192), "float16"], B: T.Buffer[(8192, 8192), "float16"], C: T.Buffer[(8192, 8192), "float16"]):
    ...
    for ax0_ax1_fused_0 in T.thread_binding(256, thread="blockIdx.y"):
        for ax0_ax1_fused_1 in T.thread_binding(256, thread="blockIdx.x"):
            for ax0_ax1_fused_2 in T.thread_binding(1, thread="vthread.x"):
                for ax0_ax1_fused_3 in T.thread_binding(2, thread="threadIdx.y"):
                    for ax0_ax1_fused_4 in T.thread_binding(8, thread="threadIdx.x"):
                        for ax0_ax1_fused_5 in T.serial(32):
                            for ax0_ax1_fused_6 in T.vectorized(2):
                                with T.block("B_global"):
                                    v0 = T.axis.spatial(8192, (ax0_ax1_fused_0 * 262144 + ax0_ax1_fused_1 * 1024 + ax0_ax1_fused_2 * 1024 + ax0_ax1_fused_3 * 512 + ax0_ax1_fused_4 * 64 + ax0_ax1_fused_5 * 2 + ax0_ax1_fused_6) // 8192)
                                    v1 = T.axis.spatial(8192, (ax0_ax1_fused_0 * 262144 + ax0_ax1_fused_1 * 1024 + ax0_ax1_fused_2 * 1024 + ax0_ax1_fused_3 * 512 + ax0_ax1_fused_4 * 64 + ax0_ax1_fused_5 * 2 + ax0_ax1_fused_6) % 8192)
                                    T.reads(B[v0, v1])
