                      ...
                      for (ax0_1_2: int32, 0, 16) {
                        for (ax1_1_2: int32, 0, 16) {
                          block([8192, 8192], "B_global_shared") as [v0_3, v1_3] {
                            ...
                            bind(v1_3, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (ax1_0_1*16)) + ax1_1_2))
                        ...
                        for (ax0_1_4: int32, 0, 16) {
                          for (ax1_1_4: int32, 0, 16) {
                            block([8192, 8192], "B_global_shared_warp") as [v0_5, v1_5] {
                              ...
                              bind(v1_5, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*64)) + (ax1_0_3*16)) + ax1_1_4))
                    ...
                    for (ax0_1_5: int32, 0, 16) {
                      for (ax1_1_5: int32, 0, 16) {
                        block([8192, 8192], "C_warp") as [v0_6, v1_6] {
                          ...
                          bind(v1_6, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*64)) + (ax1_0_4*16)) + ax1_1_5))
