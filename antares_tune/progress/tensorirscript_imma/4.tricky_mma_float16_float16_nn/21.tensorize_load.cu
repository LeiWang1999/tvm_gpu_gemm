              ...
              for (kk_0: int32, 0, 256) {
                ...
                for (kk_1: int32, 0, 2) {
                  ...
                  for (ax0_1: int32, 0, 4) {
                    for (ax1: int32, 0, 16) {
                      for (ax2: int32, 0, 16) {
                        block([512, 512, 16, 16], "B_shared_warp") as [v0_3, v1_3, v2_2, v3_2] {
                  ...
                  for (ii_2: int32, 0, 8) {
                    for (jj_2: int32, 0, 4) {
                      for (i: int32, 0, 16) {
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([512, 512, tir.reduce_axis(0, 512), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi, vj, vk] {
                              ...
                              bind(vj, j)
                              bind(vk, k)
                              tir.reads([C_warp[vii_1, vjj_1, ((floormod(vi, 8)*4) + floordiv(floormod(vj, 8), 2)), (((floordiv(vj, 8)*4) + (floordiv(vi, 8)*2)) + floormod(vj, 2))], A_shared_warp[vii_1, vkk, ((vi*2) + floordiv(vk, 8)), floormod(vk, 8)], B_shared_warp[vkk, vjj_1, ((vk*2) + floordiv(vj, 8)), floormod(vj, 8)]])
              ...
              for (ax0_2: int32, 0, 8) {
                for (ax1_1: int32, 0, 4) {
                  for (ax2_1: int32, 0, 16) {
                    for (ax3: int32, 0, 16) {
                      block([512, 512, 16, 16], "C_warp") as [v0_4, v1_4, v2_3, v3_3] {
                        bind(v0_4, ((ii_0*8) + ax0_2))
                        bind(v1_4, ((((jj_0_0*256) + (jj_0_1*16)) + (jj_1*4)) + ax1_1))
                        bind(v2_3, ax2_1)
                        bind(v3_3, ax3)
