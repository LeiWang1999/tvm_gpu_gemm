                        ...
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([512, 512, tir.reduce_axis(0, 512), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                              ...
                              bind(vj_1, j)
                              bind(vk, k)
                              tir.reads([C_warp[vii_1, vjj_1, vi_1, vj_1], A_shared_warp[vii_1, vkk, vi_1, vk], B_shared_warp[vkk, vjj_1, vk, vj_1]])
                              tir.writes([C_warp[vii_1, vjj_1, vi_1, vj_1]])
                              C_warp[vii_1, vjj_1, vi_1, vj_1] = (C_warp[vii_1, vjj_1, vi_1, vj_1] + (A_shared_warp[vii_1, vkk, vi_1, vk]*B_shared_warp[vkk, vjj_1, vk, vj_1]))
                          }
                        }
                      }
                    }
