                ...
                for (jj_2_init: int32, 0, 4) {
                  for (i_init: int32, 0, 16) {
                    for (j_init: int32, 0, 16) {
                      block([512, 512, 16, 16], "B_init") as [vii, vjj, vi, vj] {
                  ...
                  for (ii_2: int32, 0, 8) {
                    for (jj_2: int32, 0, 4) {
                      for (i: int32, 0, 16) {
                        for (j: int32, 0, 16) {
                          for (k: int32, 0, 16) {
                            block([512, 512, tir.reduce_axis(0, 512), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                              ...
                              bind(vj_1, j)
                              bind(vk, k)
                              tir.reads([C_warp[vii_1, vjj_1, ((floormod(vi_1, 8)*4) + floordiv(floormod(vj_1, 8), 2)), (((floordiv(vj_1, 8)*4) + (floordiv(vi_1, 8)*2)) + floormod(vj_1, 2))], A_shared_warp[vii_1, vkk, ((vi_1*2) + floordiv(vk, 8)), floormod(vk, 8)], B_shared_warp[vkk, vjj_1, ((vk*2) + floordiv(vj_1, 8)), floormod(vj_1, 8)]])
                  ...
                  for (ax2_2: int32, 0, 16) {
                    for (ax3: int32, 0, 16) {
                      block([512, 512, 16, 16], "C_warp") as [v0_4, v1_4, v2_4, v3_4] {
                        ...
                        bind(v1_4, ((((jj_0_0*256) + (jj_0_1*16)) + (jj_1*4)) + ax1_2))
                        bind(v2_4, ax2_2)
                        bind(v3_4, ax3)
