...
log_path = "progress/amos_with_tensorir_quantize_dequantize/0.wmma_int8_int32_nt"
count = 0
...
block_quantize_A_local = sch.cache_read(block_b, 0, "local")
...
block_quantize_B_local = sch.cache_read(block_b, 1, "local")
...
block_dequantize_c_shared = sch.cache_write(block_b, 0, "shared")
...
sch.reverse_compute_at(block_dequantize_c_shared, j)
# sch.compute_at(block_quantize_A_local, j)
# sch.compute_at(block_quantize_B_local, j)
...
sch.compute_inline(block_quantize_a)
sch.compute_inline(block_quantize_b)
# sch.reverse_compute_inline(block_dequantize_c)
sch.compute_at(block_quantize_A_local, A_shared_vi)
sch.compute_at(block_quantize_B_local, B_shared_vi)
write_sch(sch, log_path,
           "schedule_quantize_dequantize")
