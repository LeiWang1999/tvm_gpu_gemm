...
A_shared_inner, A_shared_tz, A_shared_ty, A_shared_tx, A_shared_vx, A_shared_vi = sch.split(
    block_shared_A_fused_i_j, factors=[None, block_col_warps,block_row_warps, warp_size, 2, vec])
