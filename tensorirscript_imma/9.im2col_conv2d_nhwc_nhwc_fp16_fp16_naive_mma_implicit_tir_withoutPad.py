...
sch.transform_layout(block_conv_weight_shared,
...
sch.tensorize(init_block_b_loops[-2], MMA_fill_16x16_f16_INTRIN)
write_sch(sch, log_path,
          "tensorize_fill")
sch.tensorize(sch.get_loops(block_conv_input_frag)[-2], LDMATRIX_16x16_A_INTRIN)
write_sch(sch, log_path,
          "tensorize_load")
sch.tensorize(sch.get_loops(block_conv_weight_frag)[-2], LDMATRIX_16x16_B_TRANS_INTRIN)
sch.tensorize(kernel_i, MMA_f16f16f16_TRANS_INTRIN)
sch.tensorize(sch.get_loops(block_conv_output_frag)
              [-2], MMA_store_16x16_f16_global_INTRIN)
write_sch(sch, log_path,
           "tensorize")
