...
A_local_ty, A_local_tz, A_local_inner, A_local_tx = sch.split(
    A_local_fused, factors=[block_row_warps, block_col_warps, None, warp_size])
sch.bind(A_local_tx, "threadIdx.x")
sch.bind(A_local_ty, "threadIdx.y")
sch.bind(A_local_tz, "threadIdx.z")
sch.reverse_compute_at(block_conv_input_shared, A_local_tx, preserve_unit_loops=True)
sch.vectorize(sch.get_loops(block_conv_input_shared)[-1])
