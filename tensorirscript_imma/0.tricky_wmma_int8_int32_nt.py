...
class MyModule:
    ...
    def main(a: T.handle, b: T.handle, c: T.handle):
        ...
        B = T.match_buffer(b, [N // wmma_n, K // wmma_k, wmma_n, wmma_k], dtype="int8")
...
write_sch(sch, log_path,
          "tensorize_load")
sch.tensorize(sch.get_loops(block_shared_local_B)[-2], WMMA_LOAD_16x16x16_S8_B_TRANS_INTRIN)
...
cuda_b = tvm.nd.array(np.arange(N * K).reshape((N // wmma_n, K // wmma_k, wmma_n, wmma_k)).astype("int8"), ctx)
