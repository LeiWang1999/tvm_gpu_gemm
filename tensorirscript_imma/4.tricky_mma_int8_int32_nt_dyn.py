...
from intrin.tricky_mma_int8_int32 import (
    ...
    TRICKY_LDMATRIX_16x32_A_DYN_INTRIN,
    TRICKY_LDMATRIX_32x16_B_DYN_INTRIN,
    TRICKY_LDMATRIX_32x16_B_INTRIN,
    TRICKY_LDMATRIX_16x32_B_DYN_TRANS_INTRIN,
...
sch.tensorize(sch.get_loops(block_shared_local_A)
              [-2], TRICKY_LDMATRIX_16x32_A_DYN_INTRIN)
write_sch(sch, log_path,
          "tensorize_load")
...
sch.tensorize(sch.get_loops(block_shared_local_B)
              [-2], TRICKY_LDMATRIX_16x32_B_DYN_TRANS_INTRIN)
...
ctx = tvm.cuda(0)
with tvm.transform.PassContext(config={"tir.ptx_ldg128_sts128": True}):
