...
sch.storage_align(block_conv_weight_shared, buffer_index=0,
                  axis=-2, factor=wmma_k, offset=vec)
...
write_sch(sch, log_path,
          "tensorize_fill")
sch.tensorize(sch.get_loops(block_conv_input_frag)[-2], WMMA_LOAD_16x16x16_F16_A_DYN_INTRIN)
write_sch(sch, log_path,
          "tensorize_load")
sch.tensorize(sch.get_loops(block_conv_weight_frag)[-2], WMMA_LOAD_16x16x16_F16_B_TRANS_DYN_INTRIN)
